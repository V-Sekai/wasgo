...
WasGoId _wasgo_JSONParseResult_wrapper_get_error_string(WasGoId wasgo_id);
...
void _wasgo_JSONParseResult_wrapper_set_error_string(WasGoId wasgo_id, WasGoId p_error_string);
