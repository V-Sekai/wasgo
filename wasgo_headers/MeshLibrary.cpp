...
String MeshLibrary::get_item_name(int p_id){
    ...
    _wasgo_MeshLibrary_wrapper_get_item_name(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_id);
...
Transform MeshLibrary::get_item_navmesh_transform(int p_id){
    ...
    _wasgo_MeshLibrary_wrapper_get_item_navmesh_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void MeshLibrary::set_item_name(int p_id, String p_name){
	...
	_wasgo_MeshLibrary_wrapper_set_item_name(wasgo_id, p_id, wasgo_buffer_name, wasgo_size_name, wasgo_size_name);
}
...
void MeshLibrary::set_item_navmesh_transform(int p_id, Transform p_navmesh){
	...
	_wasgo_MeshLibrary_wrapper_set_item_navmesh_transform(wasgo_id, p_id, wasgo_buffer_navmesh, wasgo_size_navmesh, wasgo_size_navmesh);
}
