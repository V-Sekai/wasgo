...
void ConfigFile::erase_section(String p_section){
    ...
    int wasgo_size_section = 10 + String(p_section).size();
...
void ConfigFile::erase_section_key(String p_section, String p_key){
	...
	_wasgo_ConfigFile_wrapper_erase_section_key(wasgo_id, wasgo_buffer_section, wasgo_size_section, -69, wasgo_buffer_key, wasgo_size_key);
}
...
Variant ConfigFile::get_value(String p_section, String p_key, Variant p_default){
    ...
    Variant wasgo_var_default = p_default;
    uint8_t wasgo_buffer_default[256];
    int wasgo_size_default = 256;
    encode_variant(wasgo_var_default, wasgo_buffer_default, wasgo_size_default);
    

    Variant wasgo_ret;
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_ConfigFile_wrapper_get_value(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_section, wasgo_size_section, wasgo_buffer_key, wasgo_size_key, wasgo_buffer_default, wasgo_size_default);
...
bool ConfigFile::has_section_key(String p_section, String p_key){
	...
	return (bool) _wasgo_ConfigFile_wrapper_has_section_key(wasgo_id, wasgo_buffer_section, wasgo_size_section, -69, wasgo_buffer_key, wasgo_size_key);
}
...
Error ConfigFile::load_encrypted(String p_path, PoolByteArray p_key){
	...
	return Error(_wasgo_ConfigFile_wrapper_load_encrypted(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, p_key._get_wasgo_id()));
}
Error ConfigFile::load_encrypted_pass(String p_path, String p_password){
    ...
    int wasgo_size_password = 10 + String(p_password).size();
	...
	return Error(_wasgo_ConfigFile_wrapper_load_encrypted_pass(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, wasgo_buffer_password, wasgo_size_password));
}
Error ConfigFile::parse(String p_data){

    Variant wasgo_var_data = p_data;
    int wasgo_size_data = 10 + String(p_data).size();
...
Error ConfigFile::save_encrypted(String p_path, PoolByteArray p_key){
	...
	return Error(_wasgo_ConfigFile_wrapper_save_encrypted(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, p_key._get_wasgo_id()));
}
Error ConfigFile::save_encrypted_pass(String p_path, String p_password){
	...
	return Error(_wasgo_ConfigFile_wrapper_save_encrypted_pass(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, wasgo_buffer_password, wasgo_size_password));
}
void ConfigFile::set_value(String p_section, String p_key, Variant p_value){
	...
	_wasgo_ConfigFile_wrapper_set_value(wasgo_id, wasgo_buffer_section, wasgo_size_section, -69, wasgo_buffer_key, wasgo_size_key, wasgo_buffer_value, wasgo_size_value);
}
