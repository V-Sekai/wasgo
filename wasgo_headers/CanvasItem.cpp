...
void CanvasItem::draw_arc(Vector2 p_center, float p_radius, float p_start_angle, float p_end_angle, int p_point_count, Color p_color, float p_width, bool p_antialiased){
	...
	_wasgo_CanvasItem_wrapper_draw_arc(wasgo_id, wasgo_buffer_center, wasgo_size_center, -69, p_radius, p_start_angle, p_end_angle, p_point_count, wasgo_buffer_color, wasgo_size_color, p_width, p_antialiased);
}
float CanvasItem::draw_char(Font p_font, Vector2 p_position, String p_char, String p_next, Color p_modulate){
    ...
    int wasgo_size_char = 10 + String(p_char).size();
	...
	return (float) _wasgo_CanvasItem_wrapper_draw_char(wasgo_id, p_font._get_wasgo_id(), wasgo_buffer_position, wasgo_size_position, wasgo_size_position, wasgo_buffer_char, wasgo_size_char, wasgo_buffer_next, wasgo_size_next, wasgo_buffer_modulate, wasgo_size_modulate);
}
void CanvasItem::draw_circle(Vector2 p_position, float p_radius, Color p_color){
	...
	_wasgo_CanvasItem_wrapper_draw_circle(wasgo_id, wasgo_buffer_position, wasgo_size_position, -69, p_radius, wasgo_buffer_color, wasgo_size_color);
}
void CanvasItem::draw_colored_polygon(PoolVector2Array p_points, Color p_color, PoolVector2Array p_uvs, Texture p_texture, Texture p_normal_map, bool p_antialiased){
	...
	_wasgo_CanvasItem_wrapper_draw_colored_polygon(wasgo_id, p_points._get_wasgo_id(), wasgo_buffer_color, wasgo_size_color, wasgo_size_color, p_uvs._get_wasgo_id(), p_texture._get_wasgo_id(), p_normal_map._get_wasgo_id(), p_antialiased);
}
void CanvasItem::draw_line(Vector2 p_from, Vector2 p_to, Color p_color, float p_width, bool p_antialiased){
	...
	_wasgo_CanvasItem_wrapper_draw_line(wasgo_id, wasgo_buffer_from, wasgo_size_from, -69, wasgo_buffer_to, wasgo_size_to, wasgo_buffer_color, wasgo_size_color, p_width, p_antialiased);
}
void CanvasItem::draw_mesh(Mesh p_mesh, Texture p_texture, Texture p_normal_map, Transform2D p_transform, Color p_modulate){
	...
	_wasgo_CanvasItem_wrapper_draw_mesh(wasgo_id, p_mesh._get_wasgo_id(), p_texture._get_wasgo_id(), -69, p_normal_map._get_wasgo_id(), wasgo_buffer_transform, wasgo_size_transform, wasgo_buffer_modulate, wasgo_size_modulate);
}
void CanvasItem::draw_multiline(PoolVector2Array p_points, Color p_color, float p_width, bool p_antialiased){
	...
	_wasgo_CanvasItem_wrapper_draw_multiline(wasgo_id, p_points._get_wasgo_id(), wasgo_buffer_color, wasgo_size_color, wasgo_size_color, p_width, p_antialiased);
}
void CanvasItem::draw_multiline_colors(PoolVector2Array p_points, PoolColorArray p_colors, float p_width, bool p_antialiased){
	_wasgo_CanvasItem_wrapper_draw_multiline_colors(wasgo_id, p_points._get_wasgo_id(), p_colors._get_wasgo_id(), -69, p_width, p_antialiased);
}
void CanvasItem::draw_multimesh(MultiMesh p_multimesh, Texture p_texture, Texture p_normal_map){
	_wasgo_CanvasItem_wrapper_draw_multimesh(wasgo_id, p_multimesh._get_wasgo_id(), p_texture._get_wasgo_id(), -69, p_normal_map._get_wasgo_id());
}
void CanvasItem::draw_polygon(PoolVector2Array p_points, PoolColorArray p_colors, PoolVector2Array p_uvs, Texture p_texture, Texture p_normal_map, bool p_antialiased){
	_wasgo_CanvasItem_wrapper_draw_polygon(wasgo_id, p_points._get_wasgo_id(), p_colors._get_wasgo_id(), -69, p_uvs._get_wasgo_id(), p_texture._get_wasgo_id(), p_normal_map._get_wasgo_id(), p_antialiased);
}
void CanvasItem::draw_polyline(PoolVector2Array p_points, Color p_color, float p_width, bool p_antialiased){
	...
	_wasgo_CanvasItem_wrapper_draw_polyline(wasgo_id, p_points._get_wasgo_id(), wasgo_buffer_color, wasgo_size_color, wasgo_size_color, p_width, p_antialiased);
}
void CanvasItem::draw_polyline_colors(PoolVector2Array p_points, PoolColorArray p_colors, float p_width, bool p_antialiased){
	_wasgo_CanvasItem_wrapper_draw_polyline_colors(wasgo_id, p_points._get_wasgo_id(), p_colors._get_wasgo_id(), -69, p_width, p_antialiased);
}
void CanvasItem::draw_primitive(PoolVector2Array p_points, PoolColorArray p_colors, PoolVector2Array p_uvs, Texture p_texture, float p_width, Texture p_normal_map){
	_wasgo_CanvasItem_wrapper_draw_primitive(wasgo_id, p_points._get_wasgo_id(), p_colors._get_wasgo_id(), -69, p_uvs._get_wasgo_id(), p_texture._get_wasgo_id(), p_width, p_normal_map._get_wasgo_id());
}
void CanvasItem::draw_rect(Rect2 p_rect, Color p_color, bool p_filled, float p_width, bool p_antialiased){
	...
	_wasgo_CanvasItem_wrapper_draw_rect(wasgo_id, wasgo_buffer_rect, wasgo_size_rect, -69, wasgo_buffer_color, wasgo_size_color, p_filled, p_width, p_antialiased);
}
void CanvasItem::draw_set_transform(Vector2 p_position, float p_rotation, Vector2 p_scale){
	...
	_wasgo_CanvasItem_wrapper_draw_set_transform(wasgo_id, wasgo_buffer_position, wasgo_size_position, -69, p_rotation, wasgo_buffer_scale, wasgo_size_scale);
}
...
void CanvasItem::draw_string(Font p_font, Vector2 p_position, String p_text, Color p_modulate, int p_clip_w){
	...
	_wasgo_CanvasItem_wrapper_draw_string(wasgo_id, p_font._get_wasgo_id(), wasgo_buffer_position, wasgo_size_position, wasgo_size_position, wasgo_buffer_text, wasgo_size_text, wasgo_buffer_modulate, wasgo_size_modulate, p_clip_w);
}
void CanvasItem::draw_style_box(StyleBox p_style_box, Rect2 p_rect){
	...
	_wasgo_CanvasItem_wrapper_draw_style_box(wasgo_id, p_style_box._get_wasgo_id(), wasgo_buffer_rect, wasgo_size_rect, wasgo_size_rect);
}
void CanvasItem::draw_texture(Texture p_texture, Vector2 p_position, Color p_modulate, Texture p_normal_map){
	...
	_wasgo_CanvasItem_wrapper_draw_texture(wasgo_id, p_texture._get_wasgo_id(), wasgo_buffer_position, wasgo_size_position, wasgo_size_position, wasgo_buffer_modulate, wasgo_size_modulate, p_normal_map._get_wasgo_id());
}
void CanvasItem::draw_texture_rect(Texture p_texture, Rect2 p_rect, bool p_tile, Color p_modulate, bool p_transpose, Texture p_normal_map){
	...
	_wasgo_CanvasItem_wrapper_draw_texture_rect(wasgo_id, p_texture._get_wasgo_id(), wasgo_buffer_rect, wasgo_size_rect, wasgo_size_rect, p_tile, wasgo_buffer_modulate, wasgo_size_modulate, p_transpose, p_normal_map._get_wasgo_id());
}
void CanvasItem::draw_texture_rect_region(Texture p_texture, Rect2 p_rect, Rect2 p_src_rect, Color p_modulate, bool p_transpose, Texture p_normal_map, bool p_clip_uv){
	...
	_wasgo_CanvasItem_wrapper_draw_texture_rect_region(wasgo_id, p_texture._get_wasgo_id(), wasgo_buffer_rect, wasgo_size_rect, wasgo_size_rect, wasgo_buffer_src_rect, wasgo_size_src_rect, wasgo_buffer_modulate, wasgo_size_modulate, p_transpose, p_normal_map._get_wasgo_id(), p_clip_uv);
}
...
Vector2 CanvasItem::make_canvas_position_local(Vector2 p_screen_point){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_CanvasItem_wrapper_make_canvas_position_local(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_screen_point, wasgo_size_screen_point);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
