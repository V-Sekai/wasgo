...
void Environment::set_adjustment_color_correction(Texture p_color_correction){
	_wasgo_Environment_wrapper_set_adjustment_color_correction(wasgo_id, ((Variant) p_color_correction).get_wasgo_id());
}
...
void Environment::set_ambient_light_color(Color p_color){
	_wasgo_Environment_wrapper_set_ambient_light_color(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
...
void Environment::set_background(Environment::BGMode p_mode){
	_wasgo_Environment_wrapper_set_background(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void Environment::set_bg_color(Color p_color){
	_wasgo_Environment_wrapper_set_bg_color(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
...
void Environment::set_dof_blur_far_quality(Environment::DOFBlurQuality p_intensity){
	_wasgo_Environment_wrapper_set_dof_blur_far_quality(wasgo_id, ((Variant) p_intensity).get_wasgo_id());
}
...
void Environment::set_dof_blur_near_quality(Environment::DOFBlurQuality p_level){
	_wasgo_Environment_wrapper_set_dof_blur_near_quality(wasgo_id, ((Variant) p_level).get_wasgo_id());
}
...
void Environment::set_fog_color(Color p_color){
	_wasgo_Environment_wrapper_set_fog_color(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
...
void Environment::set_fog_sun_color(Color p_color){
	_wasgo_Environment_wrapper_set_fog_sun_color(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
...
void Environment::set_glow_blend_mode(Environment::GlowBlendMode p_mode){
	_wasgo_Environment_wrapper_set_glow_blend_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
...
void Environment::set_sky(Sky p_sky){
	_wasgo_Environment_wrapper_set_sky(wasgo_id, ((Variant) p_sky).get_wasgo_id());
}
...
void Environment::set_sky_orientation(Basis p_orientation){
	_wasgo_Environment_wrapper_set_sky_orientation(wasgo_id, ((Variant) p_orientation).get_wasgo_id());
}
void Environment::set_sky_rotation(Vector3 p_euler_radians){
	_wasgo_Environment_wrapper_set_sky_rotation(wasgo_id, ((Variant) p_euler_radians).get_wasgo_id());
}
void Environment::set_sky_rotation_degrees(Vector3 p_euler_degrees){
	_wasgo_Environment_wrapper_set_sky_rotation_degrees(wasgo_id, ((Variant) p_euler_degrees).get_wasgo_id());
}
...
void Environment::set_ssao_blur(Environment::SSAOBlur p_mode){
	_wasgo_Environment_wrapper_set_ssao_blur(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void Environment::set_ssao_color(Color p_color){
	_wasgo_Environment_wrapper_set_ssao_color(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
...
void Environment::set_ssao_quality(Environment::SSAOQuality p_quality){
	_wasgo_Environment_wrapper_set_ssao_quality(wasgo_id, ((Variant) p_quality).get_wasgo_id());
}
...
void Environment::set_tonemapper(Environment::ToneMapper p_mode){
	_wasgo_Environment_wrapper_set_tonemapper(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}