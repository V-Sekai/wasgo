...
void LinkButton::set_text(String p_text){
	_wasgo_LinkButton_wrapper_set_text(wasgo_id, ((Variant) text).get_wasgo_id());
}
void LinkButton::set_underline_mode(LinkButton::UnderlineMode p_underline_mode){
	_wasgo_LinkButton_wrapper_set_underline_mode(wasgo_id, ((Variant) underline_mode).get_wasgo_id());
}

LinkButton::LinkButton(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
