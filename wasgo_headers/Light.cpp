...
float Light::get_param(Light::Param p_param){
	return (float) _wasgo_Light_wrapper_get_param(wasgo_id, ((Variant) param).get_wasgo_id()));
}
...
void Light::set_bake_mode(Light::BakeMode p_bake_mode){
	_wasgo_Light_wrapper_set_bake_mode(wasgo_id, ((Variant) bake_mode).get_wasgo_id());
}
void Light::set_color(Color p_color){
	_wasgo_Light_wrapper_set_color(wasgo_id, ((Variant) color).get_wasgo_id());
}
void Light::set_cull_mask(int p_cull_mask){
	_wasgo_Light_wrapper_set_cull_mask(wasgo_id, cull_mask);
}
void Light::set_editor_only(bool p_editor_only){
	_wasgo_Light_wrapper_set_editor_only(wasgo_id, editor_only);
}
void Light::set_negative(bool p_enabled){
	_wasgo_Light_wrapper_set_negative(wasgo_id, enabled);
}
void Light::set_param(Light::Param p_param, float p_value){
	_wasgo_Light_wrapper_set_param(wasgo_id, ((Variant) param).get_wasgo_id(), value);
}
void Light::set_shadow(bool p_enabled){
	_wasgo_Light_wrapper_set_shadow(wasgo_id, enabled);
}
void Light::set_shadow_color(Color p_shadow_color){
	_wasgo_Light_wrapper_set_shadow_color(wasgo_id, ((Variant) shadow_color).get_wasgo_id());
}
void Light::set_shadow_reverse_cull_face(bool p_enable){
	_wasgo_Light_wrapper_set_shadow_reverse_cull_face(wasgo_id, enable);
}