...
WasGo::WasGoId _wasgo_Bone2D_wrapper_get_rest(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Bone2D_wrapper_get_skeleton_rest(WasGoId wasgo_id);
void _wasgo_Bone2D_wrapper_set_default_length(WasGoId wasgo_id, float p_default_length);
void _wasgo_Bone2D_wrapper_set_rest(WasGoId wasgo_id, WasGo::WasGoId p_rest);
}
#endif