...
Transform Skeleton::get_bone_custom_pose(int p_bone_idx){
    ...
    _wasgo_Skeleton_wrapper_get_bone_custom_pose(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_bone_idx);
...
Transform Skeleton::get_bone_global_pose(int p_bone_idx){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_Skeleton_wrapper_get_bone_global_pose(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_bone_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
String Skeleton::get_bone_name(int p_bone_idx){
    ...
    _wasgo_Skeleton_wrapper_get_bone_name(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_bone_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform Skeleton::get_bone_pose(int p_bone_idx){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_Skeleton_wrapper_get_bone_pose(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_bone_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform Skeleton::get_bone_rest(int p_bone_idx){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_Skeleton_wrapper_get_bone_rest(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_bone_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void Skeleton::physical_bones_add_collision_exception(RID p_exception){
    ...
    uint8_t wasgo_buffer_exception[256];
    int wasgo_size_exception = 256;
...
void Skeleton::set_bone_custom_pose(int p_bone_idx, Transform p_custom_pose){
	...
	_wasgo_Skeleton_wrapper_set_bone_custom_pose(wasgo_id, p_bone_idx, wasgo_buffer_custom_pose, wasgo_size_custom_pose, wasgo_size_custom_pose);
}
...
void Skeleton::set_bone_global_pose_override(int p_bone_idx, Transform p_pose, float p_amount, bool p_persistent){
	...
	_wasgo_Skeleton_wrapper_set_bone_global_pose_override(wasgo_id, p_bone_idx, wasgo_buffer_pose, wasgo_size_pose, wasgo_size_pose, p_amount, p_persistent);
}
...
void Skeleton::set_bone_pose(int p_bone_idx, Transform p_pose){
	...
	_wasgo_Skeleton_wrapper_set_bone_pose(wasgo_id, p_bone_idx, wasgo_buffer_pose, wasgo_size_pose, wasgo_size_pose);
}
void Skeleton::set_bone_rest(int p_bone_idx, Transform p_rest){
	...
	_wasgo_Skeleton_wrapper_set_bone_rest(wasgo_id, p_bone_idx, wasgo_buffer_rest, wasgo_size_rest, wasgo_size_rest);
}
