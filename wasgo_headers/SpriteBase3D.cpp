...
bool SpriteBase3D::get_draw_flag(SpriteBase3D::DrawFlags p_flag){
	return (bool) _wasgo_SpriteBase3D_wrapper_get_draw_flag(wasgo_id, ((Variant) flag).get_wasgo_id()));
}
...
void SpriteBase3D::set_alpha_cut_mode(SpriteBase3D::AlphaCutMode p_mode){
	_wasgo_SpriteBase3D_wrapper_set_alpha_cut_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void SpriteBase3D::set_axis(Vector3::Axis p_axis){
	_wasgo_SpriteBase3D_wrapper_set_axis(wasgo_id, ((Variant) axis).get_wasgo_id());
}
void SpriteBase3D::set_billboard_mode(SpatialMaterial::BillboardMode p_mode){
	_wasgo_SpriteBase3D_wrapper_set_billboard_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void SpriteBase3D::set_centered(bool p_centered){
	_wasgo_SpriteBase3D_wrapper_set_centered(wasgo_id, centered);
}
void SpriteBase3D::set_draw_flag(SpriteBase3D::DrawFlags p_flag, bool p_enabled){
	_wasgo_SpriteBase3D_wrapper_set_draw_flag(wasgo_id, ((Variant) flag).get_wasgo_id(), enabled);
}
void SpriteBase3D::set_flip_h(bool p_flip_h){
	_wasgo_SpriteBase3D_wrapper_set_flip_h(wasgo_id, flip_h);
}
void SpriteBase3D::set_flip_v(bool p_flip_v){
	_wasgo_SpriteBase3D_wrapper_set_flip_v(wasgo_id, flip_v);
}
void SpriteBase3D::set_modulate(Color p_modulate){
	_wasgo_SpriteBase3D_wrapper_set_modulate(wasgo_id, ((Variant) modulate).get_wasgo_id());
}
void SpriteBase3D::set_offset(Vector2 p_offset){
	_wasgo_SpriteBase3D_wrapper_set_offset(wasgo_id, ((Variant) offset).get_wasgo_id());
}
void SpriteBase3D::set_opacity(float p_opacity){
	_wasgo_SpriteBase3D_wrapper_set_opacity(wasgo_id, opacity);
}
void SpriteBase3D::set_pixel_size(float p_pixel_size){
	_wasgo_SpriteBase3D_wrapper_set_pixel_size(wasgo_id, pixel_size);
}