...
Vector2 AudioEffectSpectrumAnalyzerInstance::get_magnitude_for_frequency_range(float p_from_hz, float p_to_hz, AudioEffectSpectrumAnalyzerInstance::MagnitudeMode p_mode){
    ...
    _wasgo_AudioEffectSpectrumAnalyzerInstance_wrapper_get_magnitude_for_frequency_range(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_from_hz, p_to_hz, p_mode._get_wasgo_id());
