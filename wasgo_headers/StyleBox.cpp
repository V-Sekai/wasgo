...
void StyleBox::draw(RID p_canvas_item, Rect2 p_rect){
	_wasgo_StyleBox_wrapper_draw(wasgo_id, ((Variant) canvas_item).get_wasgo_id(), ((Variant) rect).get_wasgo_id());
}
...
float StyleBox::get_default_margin(Margin p_margin){
	return (float) _wasgo_StyleBox_wrapper_get_default_margin(wasgo_id, ((Variant) margin).get_wasgo_id()));
}
float StyleBox::get_margin(Margin p_margin){
	return (float) _wasgo_StyleBox_wrapper_get_margin(wasgo_id, ((Variant) margin).get_wasgo_id()));
}
...
void StyleBox::set_default_margin(Margin p_margin, float p_offset){
	_wasgo_StyleBox_wrapper_set_default_margin(wasgo_id, ((Variant) margin).get_wasgo_id(), offset);
}
bool StyleBox::test_mask(Vector2 p_point, Rect2 p_rect){
	return (bool) _wasgo_StyleBox_wrapper_test_mask(wasgo_id, ((Variant) point).get_wasgo_id(), ((Variant) rect).get_wasgo_id()));
}