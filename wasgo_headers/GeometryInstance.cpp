...
bool GeometryInstance::get_flag(GeometryInstance::Flags p_flag){
	return (bool) _wasgo_GeometryInstance_wrapper_get_flag(wasgo_id, ((Variant) p_flag).get_wasgo_id());
}
...
void GeometryInstance::set_cast_shadows_setting(GeometryInstance::ShadowCastingSetting p_shadow_casting_setting){
	_wasgo_GeometryInstance_wrapper_set_cast_shadows_setting(wasgo_id, ((Variant) p_shadow_casting_setting).get_wasgo_id());
}
void GeometryInstance::set_custom_aabb(::AABB p_aabb){
	_wasgo_GeometryInstance_wrapper_set_custom_aabb(wasgo_id, ((Variant) p_aabb).get_wasgo_id());
}
...
void GeometryInstance::set_flag(GeometryInstance::Flags p_flag, bool p_value){
	_wasgo_GeometryInstance_wrapper_set_flag(wasgo_id, ((Variant) p_flag).get_wasgo_id(), p_value);
}
...
void GeometryInstance::set_material_override(Material p_material){
	_wasgo_GeometryInstance_wrapper_set_material_override(wasgo_id, ((Variant) p_material).get_wasgo_id());
}