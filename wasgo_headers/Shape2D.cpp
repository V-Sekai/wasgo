...
bool Shape2D::collide(Transform2D p_local_xform, Shape2D p_with_shape, Transform2D p_shape_xform){
	...
	return (bool) _wasgo_Shape2D_wrapper_collide(wasgo_id, wasgo_buffer_local_xform, wasgo_size_local_xform, -69, p_with_shape._get_wasgo_id(), wasgo_buffer_shape_xform, wasgo_size_shape_xform);
}
Array Shape2D::collide_and_get_contacts(Transform2D p_local_xform, Shape2D p_with_shape, Transform2D p_shape_xform){
	...
	return Array(_wasgo_Shape2D_wrapper_collide_and_get_contacts(wasgo_id, wasgo_buffer_local_xform, wasgo_size_local_xform, -69, p_with_shape._get_wasgo_id(), wasgo_buffer_shape_xform, wasgo_size_shape_xform));
}
bool Shape2D::collide_with_motion(Transform2D p_local_xform, Vector2 p_local_motion, Shape2D p_with_shape, Transform2D p_shape_xform, Vector2 p_shape_motion){
	...
	return (bool) _wasgo_Shape2D_wrapper_collide_with_motion(wasgo_id, wasgo_buffer_local_xform, wasgo_size_local_xform, -69, wasgo_buffer_local_motion, wasgo_size_local_motion, p_with_shape._get_wasgo_id(), wasgo_buffer_shape_xform, wasgo_size_shape_xform, wasgo_buffer_shape_motion, wasgo_size_shape_motion);
}
Array Shape2D::collide_with_motion_and_get_contacts(Transform2D p_local_xform, Vector2 p_local_motion, Shape2D p_with_shape, Transform2D p_shape_xform, Vector2 p_shape_motion){
	...
	return Array(_wasgo_Shape2D_wrapper_collide_with_motion_and_get_contacts(wasgo_id, wasgo_buffer_local_xform, wasgo_size_local_xform, -69, wasgo_buffer_local_motion, wasgo_size_local_motion, p_with_shape._get_wasgo_id(), wasgo_buffer_shape_xform, wasgo_size_shape_xform, wasgo_buffer_shape_motion, wasgo_size_shape_motion));
}
void Shape2D::draw(RID p_canvas_item, Color p_color){
	...
	_wasgo_Shape2D_wrapper_draw(wasgo_id, wasgo_buffer_canvas_item, wasgo_size_canvas_item, -69, wasgo_buffer_color, wasgo_size_color);
}
