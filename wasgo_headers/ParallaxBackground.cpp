...
ParallaxBackground::ParallaxBackground():CanvasLayer(){
}
ParallaxBackground ParallaxBackground::new_instance(){
    return ParallaxBackground(_wasgo_ParallaxBackground_constructor());
}
WasGoID ParallaxBackground::_get_wasgo_id(){
    return wasgo_id;
}
ParallaxBackground::operator bool(){
