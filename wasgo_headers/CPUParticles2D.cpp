...
void CPUParticles2D::convert_from_particles(Node p_particles){
	_wasgo_CPUParticles2D_wrapper_convert_from_particles(wasgo_id, ((Variant) particles).get_wasgo_id());
}
...
float CPUParticles2D::get_param(CPUParticles2D::Parameter p_param){
	return (float) _wasgo_CPUParticles2D_wrapper_get_param(wasgo_id, ((Variant) param).get_wasgo_id()));
}
Curve CPUParticles2D::get_param_curve(CPUParticles2D::Parameter p_param){
	return Curve::from_wasgo_id(_wasgo_CPUParticles2D_wrapper_get_param_curve(wasgo_id, ((Variant) param).get_wasgo_id()));
}
float CPUParticles2D::get_param_randomness(CPUParticles2D::Parameter p_param){
	return (float) _wasgo_CPUParticles2D_wrapper_get_param_randomness(wasgo_id, ((Variant) param).get_wasgo_id()));
}
bool CPUParticles2D::get_particle_flag(CPUParticles2D::Flags p_flag){
	return (bool) _wasgo_CPUParticles2D_wrapper_get_particle_flag(wasgo_id, ((Variant) flag).get_wasgo_id()));
}
...
void CPUParticles2D::set_amount(int p_amount){
	_wasgo_CPUParticles2D_wrapper_set_amount(wasgo_id, amount);
}
void CPUParticles2D::set_color(Color p_color){
	_wasgo_CPUParticles2D_wrapper_set_color(wasgo_id, ((Variant) color).get_wasgo_id());
}
void CPUParticles2D::set_color_ramp(Gradient p_ramp){
	_wasgo_CPUParticles2D_wrapper_set_color_ramp(wasgo_id, ((Variant) ramp).get_wasgo_id());
}
void CPUParticles2D::set_direction(Vector2 p_direction){
	_wasgo_CPUParticles2D_wrapper_set_direction(wasgo_id, ((Variant) direction).get_wasgo_id());
}
void CPUParticles2D::set_draw_order(CPUParticles2D::DrawOrder p_order){
	_wasgo_CPUParticles2D_wrapper_set_draw_order(wasgo_id, ((Variant) order).get_wasgo_id());
}
void CPUParticles2D::set_emission_colors(PoolColorArray p_array){
	_wasgo_CPUParticles2D_wrapper_set_emission_colors(wasgo_id, ((Variant) array).get_wasgo_id());
}
void CPUParticles2D::set_emission_normals(PoolVector2Array p_array){
	_wasgo_CPUParticles2D_wrapper_set_emission_normals(wasgo_id, ((Variant) array).get_wasgo_id());
}
void CPUParticles2D::set_emission_points(PoolVector2Array p_array){
	_wasgo_CPUParticles2D_wrapper_set_emission_points(wasgo_id, ((Variant) array).get_wasgo_id());
}
void CPUParticles2D::set_emission_rect_extents(Vector2 p_extents){
	_wasgo_CPUParticles2D_wrapper_set_emission_rect_extents(wasgo_id, ((Variant) extents).get_wasgo_id());
}
void CPUParticles2D::set_emission_shape(CPUParticles2D::EmissionShape p_shape){
	_wasgo_CPUParticles2D_wrapper_set_emission_shape(wasgo_id, ((Variant) shape).get_wasgo_id());
}
void CPUParticles2D::set_emission_sphere_radius(float p_radius){
	_wasgo_CPUParticles2D_wrapper_set_emission_sphere_radius(wasgo_id, radius);
}
void CPUParticles2D::set_emitting(bool p_emitting){
	_wasgo_CPUParticles2D_wrapper_set_emitting(wasgo_id, emitting);
}
void CPUParticles2D::set_explosiveness_ratio(float p_ratio){
	_wasgo_CPUParticles2D_wrapper_set_explosiveness_ratio(wasgo_id, ratio);
}
void CPUParticles2D::set_fixed_fps(int p_fps){
	_wasgo_CPUParticles2D_wrapper_set_fixed_fps(wasgo_id, fps);
}
void CPUParticles2D::set_fractional_delta(bool p_enable){
	_wasgo_CPUParticles2D_wrapper_set_fractional_delta(wasgo_id, enable);
}
void CPUParticles2D::set_gravity(Vector2 p_accel_vec){
	_wasgo_CPUParticles2D_wrapper_set_gravity(wasgo_id, ((Variant) accel_vec).get_wasgo_id());
}
void CPUParticles2D::set_lifetime(float p_secs){
	_wasgo_CPUParticles2D_wrapper_set_lifetime(wasgo_id, secs);
}
void CPUParticles2D::set_lifetime_randomness(float p_random){
	_wasgo_CPUParticles2D_wrapper_set_lifetime_randomness(wasgo_id, random);
}
void CPUParticles2D::set_normalmap(Texture p_normalmap){
	_wasgo_CPUParticles2D_wrapper_set_normalmap(wasgo_id, ((Variant) normalmap).get_wasgo_id());
}
void CPUParticles2D::set_one_shot(bool p_enable){
	_wasgo_CPUParticles2D_wrapper_set_one_shot(wasgo_id, enable);
}
void CPUParticles2D::set_param(CPUParticles2D::Parameter p_param, float p_value){
	_wasgo_CPUParticles2D_wrapper_set_param(wasgo_id, ((Variant) param).get_wasgo_id(), value);
}
void CPUParticles2D::set_param_curve(CPUParticles2D::Parameter p_param, Curve p_curve){
	_wasgo_CPUParticles2D_wrapper_set_param_curve(wasgo_id, ((Variant) param).get_wasgo_id(), ((Variant) curve).get_wasgo_id());
}
void CPUParticles2D::set_param_randomness(CPUParticles2D::Parameter p_param, float p_randomness){
	_wasgo_CPUParticles2D_wrapper_set_param_randomness(wasgo_id, ((Variant) param).get_wasgo_id(), randomness);
}
void CPUParticles2D::set_particle_flag(CPUParticles2D::Flags p_flag, bool p_enable){
	_wasgo_CPUParticles2D_wrapper_set_particle_flag(wasgo_id, ((Variant) flag).get_wasgo_id(), enable);
}
void CPUParticles2D::set_pre_process_time(float p_secs){
	_wasgo_CPUParticles2D_wrapper_set_pre_process_time(wasgo_id, secs);
}
void CPUParticles2D::set_randomness_ratio(float p_ratio){
	_wasgo_CPUParticles2D_wrapper_set_randomness_ratio(wasgo_id, ratio);
}
void CPUParticles2D::set_speed_scale(float p_scale){
	_wasgo_CPUParticles2D_wrapper_set_speed_scale(wasgo_id, scale);
}
void CPUParticles2D::set_spread(float p_degrees){
	_wasgo_CPUParticles2D_wrapper_set_spread(wasgo_id, degrees);
}
void CPUParticles2D::set_texture(Texture p_texture){
	_wasgo_CPUParticles2D_wrapper_set_texture(wasgo_id, ((Variant) texture).get_wasgo_id());
}
void CPUParticles2D::set_use_local_coordinates(bool p_enable){
	_wasgo_CPUParticles2D_wrapper_set_use_local_coordinates(wasgo_id, enable);
}

CPUParticles2D::CPUParticles2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
