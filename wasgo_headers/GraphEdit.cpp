...
void GraphEdit::add_valid_connection_type(int p_from_type, int p_to_type){
	_wasgo_GraphEdit_wrapper_add_valid_connection_type(wasgo_id, from_type, to_type);
}
void GraphEdit::add_valid_left_disconnect_type(int p_type){
	_wasgo_GraphEdit_wrapper_add_valid_left_disconnect_type(wasgo_id, type);
}
void GraphEdit::add_valid_right_disconnect_type(int p_type){
	_wasgo_GraphEdit_wrapper_add_valid_right_disconnect_type(wasgo_id, type);
}
...
Error GraphEdit::connect_node(String p_from, int p_from_port, String p_to, int p_to_port){
	return Error::from_wasgo_id(_wasgo_GraphEdit_wrapper_connect_node(wasgo_id, ((Variant) from).get_wasgo_id(), from_port, ((Variant) to).get_wasgo_id(), to_port));
}
void GraphEdit::disconnect_node(String p_from, int p_from_port, String p_to, int p_to_port){
	_wasgo_GraphEdit_wrapper_disconnect_node(wasgo_id, ((Variant) from).get_wasgo_id(), from_port, ((Variant) to).get_wasgo_id(), to_port);
}
...
bool GraphEdit::is_node_connected(String p_from, int p_from_port, String p_to, int p_to_port){
	return (bool) _wasgo_GraphEdit_wrapper_is_node_connected(wasgo_id, ((Variant) from).get_wasgo_id(), from_port, ((Variant) to).get_wasgo_id(), to_port));
}
...
bool GraphEdit::is_valid_connection_type(int p_from_type, int p_to_type){
	return (bool) _wasgo_GraphEdit_wrapper_is_valid_connection_type(wasgo_id, from_type, to_type));
}
void GraphEdit::remove_valid_connection_type(int p_from_type, int p_to_type){
	_wasgo_GraphEdit_wrapper_remove_valid_connection_type(wasgo_id, from_type, to_type);
}
void GraphEdit::remove_valid_left_disconnect_type(int p_type){
	_wasgo_GraphEdit_wrapper_remove_valid_left_disconnect_type(wasgo_id, type);
}
void GraphEdit::remove_valid_right_disconnect_type(int p_type){
	_wasgo_GraphEdit_wrapper_remove_valid_right_disconnect_type(wasgo_id, type);
}
void GraphEdit::set_connection_activity(String p_from, int p_from_port, String p_to, int p_to_port, float p_amount){
	_wasgo_GraphEdit_wrapper_set_connection_activity(wasgo_id, ((Variant) from).get_wasgo_id(), from_port, ((Variant) to).get_wasgo_id(), to_port, amount);
}
void GraphEdit::set_right_disconnects(bool p_enable){
	_wasgo_GraphEdit_wrapper_set_right_disconnects(wasgo_id, enable);
}
void GraphEdit::set_scroll_ofs(Vector2 p_ofs){
	_wasgo_GraphEdit_wrapper_set_scroll_ofs(wasgo_id, ((Variant) ofs).get_wasgo_id());
}
void GraphEdit::set_snap(int p_pixels){
	_wasgo_GraphEdit_wrapper_set_snap(wasgo_id, pixels);
}
void GraphEdit::set_use_snap(bool p_enable){
	_wasgo_GraphEdit_wrapper_set_use_snap(wasgo_id, enable);
}
void GraphEdit::set_zoom(float p_p_zoom){
	_wasgo_GraphEdit_wrapper_set_zoom(wasgo_id, p_zoom);
}

GraphEdit::GraphEdit(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
GraphEdit::~GraphEdit(){
}