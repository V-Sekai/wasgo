...
void AudioStreamRandomPitch::set_audio_stream(AudioStream p_stream){
	_wasgo_AudioStreamRandomPitch_wrapper_set_audio_stream(wasgo_id, ((Variant) stream).get_wasgo_id());
}
void AudioStreamRandomPitch::set_random_pitch(float p_scale){
	_wasgo_AudioStreamRandomPitch_wrapper_set_random_pitch(wasgo_id, scale);
}

AudioStreamRandomPitch::AudioStreamRandomPitch(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
