...
void Translation::add_message(String p_src_message, String p_xlated_message){
    ...
    int wasgo_size_src_message = 10 + String(p_src_message).size();
    ...
    int wasgo_size_xlated_message = 10 + String(p_xlated_message).size();
	...
	_wasgo_Translation_wrapper_add_message(wasgo_id, wasgo_buffer_src_message, wasgo_size_src_message, -69, wasgo_buffer_xlated_message, wasgo_size_xlated_message);
}
...
String Translation::get_message(String p_src_message){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_Translation_wrapper_get_message(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_src_message, wasgo_size_src_message);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void Translation::set_locale(String p_locale){
    ...
    int wasgo_size_locale = 10 + String(p_locale).size();
