...
//Wrapper Functions
extern "C"{
void _wasgo_Node2D_wrapper_apply_scale(WasGoId wasgo_id, WasGo::WasGoId p_ratio);
float _wasgo_Node2D_wrapper_get_angle_to(WasGoId wasgo_id, WasGo::WasGoId p_point);
WasGo::WasGoId _wasgo_Node2D_wrapper_get_global_position(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_Node2D_wrapper_get_global_scale(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Node2D_wrapper_get_position(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Node2D_wrapper_get_relative_transform_to_parent(WasGoId wasgo_id, WasGo::WasGoId p_parent);
...
WasGo::WasGoId _wasgo_Node2D_wrapper_get_scale(WasGoId wasgo_id);
int _wasgo_Node2D_wrapper_get_z_index(WasGoId wasgo_id);
void _wasgo_Node2D_wrapper_global_translate(WasGoId wasgo_id, WasGo::WasGoId p_offset);
int _wasgo_Node2D_wrapper_is_z_relative(WasGoId wasgo_id);
void _wasgo_Node2D_wrapper_look_at(WasGoId wasgo_id, WasGo::WasGoId p_point);
...
void _wasgo_Node2D_wrapper_set_global_position(WasGoId wasgo_id, WasGo::WasGoId p_position);
...
void _wasgo_Node2D_wrapper_set_global_scale(WasGoId wasgo_id, WasGo::WasGoId p_scale);
void _wasgo_Node2D_wrapper_set_global_transform(WasGoId wasgo_id, WasGo::WasGoId p_xform);
void _wasgo_Node2D_wrapper_set_position(WasGoId wasgo_id, WasGo::WasGoId p_position);
...
void _wasgo_Node2D_wrapper_set_scale(WasGoId wasgo_id, WasGo::WasGoId p_scale);
void _wasgo_Node2D_wrapper_set_transform(WasGoId wasgo_id, WasGo::WasGoId p_xform);
...
WasGo::WasGoId _wasgo_Node2D_wrapper_to_global(WasGoId wasgo_id, WasGo::WasGoId p_local_point);
WasGo::WasGoId _wasgo_Node2D_wrapper_to_local(WasGoId wasgo_id, WasGo::WasGoId p_global_point);
void _wasgo_Node2D_wrapper_translate(WasGoId wasgo_id, WasGo::WasGoId p_offset);
}
#endif