...
Array SceneState::get_connection_binds(int p_idx){
	return Array::from_wasgo_id(_wasgo_SceneState_wrapper_get_connection_binds(wasgo_id, p_idx));
}
...
String SceneState::get_connection_method(int p_idx){
	return String::from_wasgo_id(_wasgo_SceneState_wrapper_get_connection_method(wasgo_id, p_idx));
}
String SceneState::get_connection_signal(int p_idx){
	return String::from_wasgo_id(_wasgo_SceneState_wrapper_get_connection_signal(wasgo_id, p_idx));
}
NodePath SceneState::get_connection_source(int p_idx){
	return NodePath::from_wasgo_id(_wasgo_SceneState_wrapper_get_connection_source(wasgo_id, p_idx));
}
NodePath SceneState::get_connection_target(int p_idx){
	return NodePath::from_wasgo_id(_wasgo_SceneState_wrapper_get_connection_target(wasgo_id, p_idx));
}
...
PoolStringArray SceneState::get_node_groups(int p_idx){
	return PoolStringArray::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_groups(wasgo_id, p_idx));
}
...
PackedScene SceneState::get_node_instance(int p_idx){
	return PackedScene::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_instance(wasgo_id, p_idx));
}
String SceneState::get_node_instance_placeholder(int p_idx){
	return String::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_instance_placeholder(wasgo_id, p_idx));
}
String SceneState::get_node_name(int p_idx){
	return String::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_name(wasgo_id, p_idx));
}
NodePath SceneState::get_node_owner_path(int p_idx){
	return NodePath::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_owner_path(wasgo_id, p_idx));
}
NodePath SceneState::get_node_path(int p_idx, bool p_for_parent = (bool) false){
	return NodePath::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_path(wasgo_id, p_idx, p_for_parent));
}
...
String SceneState::get_node_property_name(int p_idx, int p_prop_idx){
	return String::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_property_name(wasgo_id, p_idx, p_prop_idx));
}
Variant SceneState::get_node_property_value(int p_idx, int p_prop_idx){
	return Variant::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_property_value(wasgo_id, p_idx, p_prop_idx));
}
String SceneState::get_node_type(int p_idx){
	return String::from_wasgo_id(_wasgo_SceneState_wrapper_get_node_type(wasgo_id, p_idx));
}
