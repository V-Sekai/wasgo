...
void AnimationTree::set_active(bool p_active){
	_wasgo_AnimationTree_wrapper_set_active(wasgo_id, active);
}
void AnimationTree::set_animation_player(NodePath p_root){
	_wasgo_AnimationTree_wrapper_set_animation_player(wasgo_id, ((Variant) root).get_wasgo_id());
}
void AnimationTree::set_process_mode(AnimationTree::AnimationProcessMode p_mode){
	_wasgo_AnimationTree_wrapper_set_process_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void AnimationTree::set_root_motion_track(NodePath p_path){
	_wasgo_AnimationTree_wrapper_set_root_motion_track(wasgo_id, ((Variant) path).get_wasgo_id());
}
void AnimationTree::set_tree_root(AnimationNode p_root){
	_wasgo_AnimationTree_wrapper_set_tree_root(wasgo_id, ((Variant) root).get_wasgo_id());
}

AnimationTree::AnimationTree(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
