...
WasGo::WasGoId _wasgo_Sprite_wrapper_get_frame_coords(WasGoId wasgo_id);
int _wasgo_Sprite_wrapper_get_hframes(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Sprite_wrapper_get_normal_map(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Sprite_wrapper_get_offset(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Sprite_wrapper_get_rect(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Sprite_wrapper_get_region_rect(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Sprite_wrapper_get_texture(WasGoId wasgo_id);
...
int _wasgo_Sprite_wrapper_is_pixel_opaque(WasGoId wasgo_id, WasGo::WasGoId p_pos);
...
void _wasgo_Sprite_wrapper_set_frame_coords(WasGoId wasgo_id, WasGo::WasGoId p_coords);
void _wasgo_Sprite_wrapper_set_hframes(WasGoId wasgo_id, int p_hframes);
void _wasgo_Sprite_wrapper_set_normal_map(WasGoId wasgo_id, WasGo::WasGoId p_normal_map);
void _wasgo_Sprite_wrapper_set_offset(WasGoId wasgo_id, WasGo::WasGoId p_offset);
...
void _wasgo_Sprite_wrapper_set_region_rect(WasGoId wasgo_id, WasGo::WasGoId p_rect);
void _wasgo_Sprite_wrapper_set_texture(WasGoId wasgo_id, WasGo::WasGoId p_texture);
