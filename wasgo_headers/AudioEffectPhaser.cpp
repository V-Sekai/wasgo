...
void AudioEffectPhaser::set_depth(float p_depth){
	_wasgo_AudioEffectPhaser_wrapper_set_depth(wasgo_id, depth);
}
void AudioEffectPhaser::set_feedback(float p_fbk){
	_wasgo_AudioEffectPhaser_wrapper_set_feedback(wasgo_id, fbk);
}
void AudioEffectPhaser::set_range_max_hz(float p_hz){
	_wasgo_AudioEffectPhaser_wrapper_set_range_max_hz(wasgo_id, hz);
}
void AudioEffectPhaser::set_range_min_hz(float p_hz){
	_wasgo_AudioEffectPhaser_wrapper_set_range_min_hz(wasgo_id, hz);
}
void AudioEffectPhaser::set_rate_hz(float p_hz){
	_wasgo_AudioEffectPhaser_wrapper_set_rate_hz(wasgo_id, hz);
}

AudioEffectPhaser::AudioEffectPhaser(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
