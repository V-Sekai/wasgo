...
//Wrapper Functions
extern "C"{
void _wasgo_AnimationNodeStateMachine_wrapper_add_node(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size, int wasgo_throwaway, WasGoID p_node, const uint8_t * p_position, int p_position_wasgo_buffer_size);
void _wasgo_AnimationNodeStateMachine_wrapper_add_transition(WasGoID wasgo_id, const uint8_t * p_from, int p_from_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_to, int p_to_wasgo_buffer_size, WasGoID p_transition);
...
void _wasgo_AnimationNodeStateMachine_wrapper_get_node_name(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, WasGoID p_node);
void _wasgo_AnimationNodeStateMachine_wrapper_get_node_position(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, const uint8_t * p_name, int p_name_wasgo_buffer_size);
...
void _wasgo_AnimationNodeStateMachine_wrapper_get_transition_from(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
void _wasgo_AnimationNodeStateMachine_wrapper_get_transition_to(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
int _wasgo_AnimationNodeStateMachine_wrapper_has_node(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size);
int _wasgo_AnimationNodeStateMachine_wrapper_has_transition(WasGoID wasgo_id, const uint8_t * p_from, int p_from_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_to, int p_to_wasgo_buffer_size);
...
void _wasgo_AnimationNodeStateMachine_wrapper_remove_transition(WasGoID wasgo_id, const uint8_t * p_from, int p_from_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_to, int p_to_wasgo_buffer_size);
void _wasgo_AnimationNodeStateMachine_wrapper_remove_transition_by_index(WasGoID wasgo_id, int p_idx);
void _wasgo_AnimationNodeStateMachine_wrapper_rename_node(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_new_name, int p_new_name_wasgo_buffer_size);
void _wasgo_AnimationNodeStateMachine_wrapper_replace_node(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size, int wasgo_throwaway, WasGoID p_node);
...
void _wasgo_AnimationNodeStateMachine_wrapper_set_node_position(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_position, int p_position_wasgo_buffer_size);
