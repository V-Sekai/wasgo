...
void AnimatedSprite::set_animation(String p_animation){
	_wasgo_AnimatedSprite_wrapper_set_animation(wasgo_id, ((Variant) p_animation).get_wasgo_id());
}
void AnimatedSprite::set_sprite_frames(SpriteFrames p_sprite_frames){
	_wasgo_AnimatedSprite_wrapper_set_sprite_frames(wasgo_id, ((Variant) p_sprite_frames).get_wasgo_id());
}