...
void MultiMeshInstance2D::set_multimesh(MultiMesh p_multimesh){
	_wasgo_MultiMeshInstance2D_wrapper_set_multimesh(wasgo_id, ((Variant) p_multimesh).get_wasgo_id());
}
void MultiMeshInstance2D::set_normal_map(Texture p_normal_map){
	_wasgo_MultiMeshInstance2D_wrapper_set_normal_map(wasgo_id, ((Variant) p_normal_map).get_wasgo_id());
}
void MultiMeshInstance2D::set_texture(Texture p_texture){
	_wasgo_MultiMeshInstance2D_wrapper_set_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}