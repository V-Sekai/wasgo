...
void _wasgo_RayCast2D_wrapper_add_exception_rid(WasGoId wasgo_id, WasGoId p_rid);
...
WasGoId _wasgo_RayCast2D_wrapper_get_cast_to(WasGoId wasgo_id);
...
WasGoId _wasgo_RayCast2D_wrapper_get_collision_normal(WasGoId wasgo_id);
WasGoId _wasgo_RayCast2D_wrapper_get_collision_point(WasGoId wasgo_id);
...
void _wasgo_RayCast2D_wrapper_remove_exception_rid(WasGoId wasgo_id, WasGoId p_rid);
void _wasgo_RayCast2D_wrapper_set_cast_to(WasGoId wasgo_id, WasGoId p_local_point);
