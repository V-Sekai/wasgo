...
WasGo::WasGoId _wasgo_Camera2D_wrapper_get_anchor_mode(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Camera2D_wrapper_get_offset(WasGoId wasgo_id);
int _wasgo_Camera2D_wrapper_is_rotating(WasGoId wasgo_id);
void _wasgo_Camera2D_wrapper_make_current(WasGoId wasgo_id);
void _wasgo_Camera2D_wrapper_set_anchor_mode(WasGoId wasgo_id, WasGo::WasGoId p_anchor_mode);
void _wasgo_Camera2D_wrapper_set_offset(WasGoId wasgo_id, WasGo::WasGoId p_offset);
