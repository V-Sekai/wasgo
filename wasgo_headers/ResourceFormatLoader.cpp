...
void ResourceFormatLoader::get_dependencies(String p_path, String p_add_types){
    ...
    int wasgo_size_add_types = 10 + String(p_add_types).size();
	...
	_wasgo_ResourceFormatLoader_wrapper_get_dependencies(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, wasgo_buffer_add_types, wasgo_size_add_types);
}
...
String ResourceFormatLoader::get_resource_type(String p_path){
    ...
    _wasgo_ResourceFormatLoader_wrapper_get_resource_type(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_path, wasgo_size_path);
...
bool ResourceFormatLoader::handles_type(String p_typename){
    ...
    int wasgo_size_typename = 10 + String(p_typename).size();
...
Variant ResourceFormatLoader::load(String p_path, String p_original_path){
    ...
    int wasgo_size_original_path = 10 + String(p_original_path).size();
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_ResourceFormatLoader_wrapper_load(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_path, wasgo_size_path, wasgo_buffer_original_path, wasgo_size_original_path);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
int ResourceFormatLoader::rename_dependencies(String p_path, String p_renames){
    ...
    int wasgo_size_renames = 10 + String(p_renames).size();
    uint8_t wasgo_buffer_renames[wasgo_size_renames];
    encode_variant(wasgo_var_renames, wasgo_buffer_renames, wasgo_size_renames);
    
	return (int) _wasgo_ResourceFormatLoader_wrapper_rename_dependencies(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, wasgo_buffer_renames, wasgo_size_renames);
}
