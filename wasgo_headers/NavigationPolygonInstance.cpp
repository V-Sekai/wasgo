...
void NavigationPolygonInstance::set_enabled(bool p_enabled){
	_wasgo_NavigationPolygonInstance_wrapper_set_enabled(wasgo_id, enabled);
}
void NavigationPolygonInstance::set_navigation_polygon(NavigationPolygon p_navpoly){
	_wasgo_NavigationPolygonInstance_wrapper_set_navigation_polygon(wasgo_id, ((Variant) navpoly).get_wasgo_id());
}

NavigationPolygonInstance::NavigationPolygonInstance(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
