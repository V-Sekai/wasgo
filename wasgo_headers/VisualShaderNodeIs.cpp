...
void VisualShaderNodeIs::set_function(VisualShaderNodeIs::Function p_func){
	_wasgo_VisualShaderNodeIs_wrapper_set_function(wasgo_id, ((Variant) func).get_wasgo_id());
}

VisualShaderNodeIs::VisualShaderNodeIs(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
