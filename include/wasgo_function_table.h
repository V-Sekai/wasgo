...
{"rand",_wasgo_rand, "()i"},
	...
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_global_rotate, "(i*~if)"),
	...
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_look_at, "(i*~i*~)"),
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_look_at_from_position, "(i*~i*~*~)"),
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_orthonormalize, "(i)"),
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_rotate, "(i*~if)"),
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_rotate_object_local, "(i*~if)"),
	...
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_set_gizmo, "(ii)"),
	...
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_to_global, "(i*~i*~)"),
	EXPORT_WASM_API_WITH_SIG(_wasgo_Spatial_wrapper_to_local, "(i*~i*~)"),
