...
void VisualShaderNodeCompare::set_comparison_type(VisualShaderNodeCompare::ComparisonType p_type){
	_wasgo_VisualShaderNodeCompare_wrapper_set_comparison_type(wasgo_id, ((Variant) type).get_wasgo_id());
}
void VisualShaderNodeCompare::set_condition(VisualShaderNodeCompare::Condition p_condition){
	_wasgo_VisualShaderNodeCompare_wrapper_set_condition(wasgo_id, ((Variant) condition).get_wasgo_id());
}
void VisualShaderNodeCompare::set_function(VisualShaderNodeCompare::Function p_func){
	_wasgo_VisualShaderNodeCompare_wrapper_set_function(wasgo_id, ((Variant) func).get_wasgo_id());
}

VisualShaderNodeCompare::VisualShaderNodeCompare(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
