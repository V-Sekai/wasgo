...
void ConvexPolygonShape2D::set_point_cloud(PoolVector2Array p_point_cloud){
	_wasgo_ConvexPolygonShape2D_wrapper_set_point_cloud(wasgo_id, ((Variant) point_cloud).get_wasgo_id());
}
void ConvexPolygonShape2D::set_points(PoolVector2Array p_points){
	_wasgo_ConvexPolygonShape2D_wrapper_set_points(wasgo_id, ((Variant) points).get_wasgo_id());
}

ConvexPolygonShape2D::ConvexPolygonShape2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
