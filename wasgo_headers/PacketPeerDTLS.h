...
//Wrapper Functions
extern "C"{
WasGoId _wasgo_PacketPeerDTLS_wrapper_connect_to_peer(WasGoId wasgo_id, WasGoId p_packet_peer, bool p_validate_certs, WasGoId p_for_hostname, WasGoId p_valid_certificate);
