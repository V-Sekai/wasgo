...
Vector2 Navigation2D::get_closest_point(Vector2 p_to_point){
    ...
    _wasgo_Navigation2D_wrapper_get_closest_point(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_to_point, wasgo_size_to_point);
...
PoolVector2Array Navigation2D::get_simple_path(Vector2 p_start, Vector2 p_end, bool p_optimize){
	...
	return PoolVector2Array(_wasgo_Navigation2D_wrapper_get_simple_path(wasgo_id, wasgo_buffer_start, wasgo_size_start, -69, wasgo_buffer_end, wasgo_size_end, p_optimize));
}
int Navigation2D::navpoly_add(NavigationPolygon p_mesh, Transform2D p_xform, Object p_owner){
	...
	return (int) _wasgo_Navigation2D_wrapper_navpoly_add(wasgo_id, p_mesh._get_wasgo_id(), wasgo_buffer_xform, wasgo_size_xform, wasgo_size_xform, p_owner._get_wasgo_id());
}
...
void Navigation2D::navpoly_set_transform(int p_id, Transform2D p_xform){
	...
	_wasgo_Navigation2D_wrapper_navpoly_set_transform(wasgo_id, p_id, wasgo_buffer_xform, wasgo_size_xform, wasgo_size_xform);
}
