...
void AtlasTexture::set_atlas(Texture p_atlas){
	_wasgo_AtlasTexture_wrapper_set_atlas(wasgo_id, ((Variant) atlas).get_wasgo_id());
}
void AtlasTexture::set_filter_clip(bool p_enable){
	_wasgo_AtlasTexture_wrapper_set_filter_clip(wasgo_id, enable);
}
void AtlasTexture::set_margin(Rect2 p_margin){
	_wasgo_AtlasTexture_wrapper_set_margin(wasgo_id, ((Variant) margin).get_wasgo_id());
}
void AtlasTexture::set_region(Rect2 p_region){
	_wasgo_AtlasTexture_wrapper_set_region(wasgo_id, ((Variant) region).get_wasgo_id());
}

AtlasTexture::AtlasTexture(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
