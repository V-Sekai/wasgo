...
void Camera2D::set_anchor_mode(Camera2D::AnchorMode p_anchor_mode){
	_wasgo_Camera2D_wrapper_set_anchor_mode(wasgo_id, ((Variant) p_anchor_mode).get_wasgo_id());
}
void Camera2D::set_offset(Vector2 p_offset){
	_wasgo_Camera2D_wrapper_set_offset(wasgo_id, ((Variant) p_offset).get_wasgo_id());
}
