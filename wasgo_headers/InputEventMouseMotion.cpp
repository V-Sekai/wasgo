...
void InputEventMouseMotion::set_pressure(float p_pressure){
	_wasgo_InputEventMouseMotion_wrapper_set_pressure(wasgo_id, pressure);
}
void InputEventMouseMotion::set_relative(Vector2 p_relative){
	_wasgo_InputEventMouseMotion_wrapper_set_relative(wasgo_id, ((Variant) relative).get_wasgo_id());
}
void InputEventMouseMotion::set_speed(Vector2 p_speed){
	_wasgo_InputEventMouseMotion_wrapper_set_speed(wasgo_id, ((Variant) speed).get_wasgo_id());
}
void InputEventMouseMotion::set_tilt(Vector2 p_tilt){
	_wasgo_InputEventMouseMotion_wrapper_set_tilt(wasgo_id, ((Variant) tilt).get_wasgo_id());
}

InputEventMouseMotion::InputEventMouseMotion(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
