...
void Line2D::add_point(Vector2 p_position, int p_at_position = (int) -1){
	_wasgo_Line2D_wrapper_add_point(wasgo_id, ((Variant) p_position).get_wasgo_id(), p_at_position);
}
...
Vector2 Line2D::get_point_position(int p_i){
	return Vector2::from_wasgo_id(_wasgo_Line2D_wrapper_get_point_position(wasgo_id, p_i));
}
...
void Line2D::set_begin_cap_mode(Line2D::LineCapMode p_mode){
	_wasgo_Line2D_wrapper_set_begin_cap_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void Line2D::set_curve(Curve p_curve){
	_wasgo_Line2D_wrapper_set_curve(wasgo_id, ((Variant) p_curve).get_wasgo_id());
}
void Line2D::set_default_color(Color p_color){
	_wasgo_Line2D_wrapper_set_default_color(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
void Line2D::set_end_cap_mode(Line2D::LineCapMode p_mode){
	_wasgo_Line2D_wrapper_set_end_cap_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void Line2D::set_gradient(Gradient p_color){
	_wasgo_Line2D_wrapper_set_gradient(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
void Line2D::set_joint_mode(Line2D::LineJointMode p_mode){
	_wasgo_Line2D_wrapper_set_joint_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void Line2D::set_point_position(int p_i, Vector2 p_position){
	_wasgo_Line2D_wrapper_set_point_position(wasgo_id, p_i, ((Variant) p_position).get_wasgo_id());
}
void Line2D::set_points(PoolVector2Array p_points){
	_wasgo_Line2D_wrapper_set_points(wasgo_id, ((Variant) p_points).get_wasgo_id());
}
...
void Line2D::set_texture(Texture p_texture){
	_wasgo_Line2D_wrapper_set_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
void Line2D::set_texture_mode(Line2D::LineTextureMode p_mode){
	_wasgo_Line2D_wrapper_set_texture_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
