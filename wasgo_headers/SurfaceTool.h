...
void _wasgo_SurfaceTool_wrapper_add_color(WasGoId wasgo_id, WasGoId p_color);
void _wasgo_SurfaceTool_wrapper_add_index(WasGoId wasgo_id, int p_index);
void _wasgo_SurfaceTool_wrapper_add_normal(WasGoId wasgo_id, WasGoId p_normal);
void _wasgo_SurfaceTool_wrapper_add_smooth_group(WasGoId wasgo_id, bool p_smooth);
void _wasgo_SurfaceTool_wrapper_add_tangent(WasGoId wasgo_id, WasGoId p_tangent);
...
void _wasgo_SurfaceTool_wrapper_add_uv(WasGoId wasgo_id, WasGoId p_uv);
void _wasgo_SurfaceTool_wrapper_add_uv2(WasGoId wasgo_id, WasGoId p_uv2);
void _wasgo_SurfaceTool_wrapper_add_vertex(WasGoId wasgo_id, WasGoId p_vertex);
void _wasgo_SurfaceTool_wrapper_add_weights(WasGoId wasgo_id, WasGoId p_weights);
void _wasgo_SurfaceTool_wrapper_append_from(WasGoId wasgo_id, WasGoId p_existing, int p_surface, WasGoId p_transform);
...
void _wasgo_SurfaceTool_wrapper_create_from_blend_shape(WasGoId wasgo_id, WasGoId p_existing, int p_surface, WasGoId p_blend_shape);
