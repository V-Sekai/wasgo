...
//Wrapper Functions
extern "C"{
WasGo::WasGoId _wasgo_Particles2D_wrapper_capture_rect(WasGoId wasgo_id);
int _wasgo_Particles2D_wrapper_get_amount(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Particles2D_wrapper_get_draw_order(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_Particles2D_wrapper_get_normal_map(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_Particles2D_wrapper_get_process_material(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_Particles2D_wrapper_get_texture(WasGoId wasgo_id);
int _wasgo_Particles2D_wrapper_get_use_local_coordinates(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Particles2D_wrapper_get_visibility_rect(WasGoId wasgo_id);
...
void _wasgo_Particles2D_wrapper_set_draw_order(WasGoId wasgo_id, WasGo::WasGoId p_order);
...
void _wasgo_Particles2D_wrapper_set_normal_map(WasGoId wasgo_id, WasGo::WasGoId p_texture);
...
void _wasgo_Particles2D_wrapper_set_process_material(WasGoId wasgo_id, WasGo::WasGoId p_material);
...
void _wasgo_Particles2D_wrapper_set_texture(WasGoId wasgo_id, WasGo::WasGoId p_texture);
void _wasgo_Particles2D_wrapper_set_use_local_coordinates(WasGoId wasgo_id, bool p_enable);
void _wasgo_Particles2D_wrapper_set_visibility_rect(WasGoId wasgo_id, WasGo::WasGoId p_visibility_rect);
}
#endif