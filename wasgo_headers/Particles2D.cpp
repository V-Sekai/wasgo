...
void Particles2D::set_draw_order(Particles2D::DrawOrder p_order){
	_wasgo_Particles2D_wrapper_set_draw_order(wasgo_id, ((Variant) p_order).get_wasgo_id());
}
...
void Particles2D::set_normal_map(Texture p_texture){
	_wasgo_Particles2D_wrapper_set_normal_map(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
...
void Particles2D::set_process_material(Material p_material){
	_wasgo_Particles2D_wrapper_set_process_material(wasgo_id, ((Variant) p_material).get_wasgo_id());
}
...
void Particles2D::set_texture(Texture p_texture){
	_wasgo_Particles2D_wrapper_set_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
...
void Particles2D::set_visibility_rect(Rect2 p_visibility_rect){
	_wasgo_Particles2D_wrapper_set_visibility_rect(wasgo_id, ((Variant) p_visibility_rect).get_wasgo_id());
}