...
Error Directory::change_dir(String p_todir){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_change_dir(wasgo_id, ((Variant) todir).get_wasgo_id()));
}
Error Directory::copy(String p_from, String p_to){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_copy(wasgo_id, ((Variant) from).get_wasgo_id(), ((Variant) to).get_wasgo_id()));
}
...
bool Directory::dir_exists(String p_path){
	return (bool) _wasgo_Directory_wrapper_dir_exists(wasgo_id, ((Variant) path).get_wasgo_id()));
}
bool Directory::file_exists(String p_path){
	return (bool) _wasgo_Directory_wrapper_file_exists(wasgo_id, ((Variant) path).get_wasgo_id()));
}
...
String Directory::get_drive(int p_idx){
	return String::from_wasgo_id(_wasgo_Directory_wrapper_get_drive(wasgo_id, idx));
}
...
Error Directory::list_dir_begin(bool p_skip_navigational = (bool) False, bool p_skip_hidden = (bool) False){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_list_dir_begin(wasgo_id, skip_navigational, skip_hidden));
}
void Directory::list_dir_end(){
	_wasgo_Directory_wrapper_list_dir_end(wasgo_id);
}
Error Directory::make_dir(String p_path){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_make_dir(wasgo_id, ((Variant) path).get_wasgo_id()));
}
Error Directory::make_dir_recursive(String p_path){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_make_dir_recursive(wasgo_id, ((Variant) path).get_wasgo_id()));
}
Error Directory::open(String p_path){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_open(wasgo_id, ((Variant) path).get_wasgo_id()));
}
Error Directory::remove(String p_path){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_remove(wasgo_id, ((Variant) path).get_wasgo_id()));
}
Error Directory::rename(String p_from, String p_to){
	return Error::from_wasgo_id(_wasgo_Directory_wrapper_rename(wasgo_id, ((Variant) from).get_wasgo_id(), ((Variant) to).get_wasgo_id()));
}

Directory::Directory(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Directory::~Directory(){
}