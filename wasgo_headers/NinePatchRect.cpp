...
int NinePatchRect::get_patch_margin(Margin p_margin){
	return (int) _wasgo_NinePatchRect_wrapper_get_patch_margin(wasgo_id, ((Variant) p_margin).get_wasgo_id());
}
...
void NinePatchRect::set_h_axis_stretch_mode(NinePatchRect::AxisStretchMode p_mode){
	_wasgo_NinePatchRect_wrapper_set_h_axis_stretch_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void NinePatchRect::set_patch_margin(Margin p_margin, int p_value){
	_wasgo_NinePatchRect_wrapper_set_patch_margin(wasgo_id, ((Variant) p_margin).get_wasgo_id(), p_value);
}
void NinePatchRect::set_region_rect(Rect2 p_rect){
	_wasgo_NinePatchRect_wrapper_set_region_rect(wasgo_id, ((Variant) p_rect).get_wasgo_id());
}
void NinePatchRect::set_texture(Texture p_texture){
	_wasgo_NinePatchRect_wrapper_set_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
void NinePatchRect::set_v_axis_stretch_mode(NinePatchRect::AxisStretchMode p_mode){
	_wasgo_NinePatchRect_wrapper_set_v_axis_stretch_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}