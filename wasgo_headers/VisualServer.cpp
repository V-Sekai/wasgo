...
void VisualServer::black_bars_set_images(RID p_left, RID p_top, RID p_right, RID p_bottom){
    ...
    uint8_t wasgo_buffer_left[256];
    int wasgo_size_left = 256;
    encode_variant(wasgo_var_left, wasgo_buffer_left, wasgo_size_left);
    

    Variant wasgo_var_top = p_top;
    uint8_t wasgo_buffer_top[256];
    int wasgo_size_top = 256;
    encode_variant(wasgo_var_top, wasgo_buffer_top, wasgo_size_top);
    

    Variant wasgo_var_right = p_right;
    uint8_t wasgo_buffer_right[256];
    int wasgo_size_right = 256;
    encode_variant(wasgo_var_right, wasgo_buffer_right, wasgo_size_right);
    

    Variant wasgo_var_bottom = p_bottom;
    uint8_t wasgo_buffer_bottom[256];
    int wasgo_size_bottom = 256;
    encode_variant(wasgo_var_bottom, wasgo_buffer_bottom, wasgo_size_bottom);
    
	_wasgo_VisualServer_wrapper_black_bars_set_images(wasgo_id, wasgo_buffer_left, wasgo_size_left, -69, wasgo_buffer_top, wasgo_size_top, wasgo_buffer_right, wasgo_size_right, wasgo_buffer_bottom, wasgo_size_bottom);
}
void VisualServer::black_bars_set_margins(int p_left, int p_top, int p_right, int p_bottom){
	_wasgo_VisualServer_wrapper_black_bars_set_margins(wasgo_id, p_left, p_top, -69, p_right, p_bottom);
}
...
void VisualServer::camera_set_cull_mask(RID p_camera, int p_layers){
    ...
    uint8_t wasgo_buffer_camera[256];
    int wasgo_size_camera = 256;
    encode_variant(wasgo_var_camera, wasgo_buffer_camera, wasgo_size_camera);
    
	_wasgo_VisualServer_wrapper_camera_set_cull_mask(wasgo_id, wasgo_buffer_camera, wasgo_size_camera, -69, p_layers);
}
void VisualServer::camera_set_environment(RID p_camera, RID p_env){
    ...
    uint8_t wasgo_buffer_env[256];
    int wasgo_size_env = 256;
    encode_variant(wasgo_var_env, wasgo_buffer_env, wasgo_size_env);
    
	_wasgo_VisualServer_wrapper_camera_set_environment(wasgo_id, wasgo_buffer_camera, wasgo_size_camera, -69, wasgo_buffer_env, wasgo_size_env);
}
void VisualServer::camera_set_frustum(RID p_camera, float p_size, Vector2 p_offset, float p_z_near, float p_z_far){
	...
	_wasgo_VisualServer_wrapper_camera_set_frustum(wasgo_id, wasgo_buffer_camera, wasgo_size_camera, -69, p_size, wasgo_buffer_offset, wasgo_size_offset, p_z_near, p_z_far);
}
void VisualServer::camera_set_orthogonal(RID p_camera, float p_size, float p_z_near, float p_z_far){
	...
	_wasgo_VisualServer_wrapper_camera_set_orthogonal(wasgo_id, wasgo_buffer_camera, wasgo_size_camera, -69, p_size, p_z_near, p_z_far);
}
void VisualServer::camera_set_perspective(RID p_camera, float p_fovy_degrees, float p_z_near, float p_z_far){
	...
	_wasgo_VisualServer_wrapper_camera_set_perspective(wasgo_id, wasgo_buffer_camera, wasgo_size_camera, -69, p_fovy_degrees, p_z_near, p_z_far);
}
void VisualServer::camera_set_transform(RID p_camera, Transform p_transform){
	...
	_wasgo_VisualServer_wrapper_camera_set_transform(wasgo_id, wasgo_buffer_camera, wasgo_size_camera, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::camera_set_use_vertical_aspect(RID p_camera, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_camera_set_use_vertical_aspect(wasgo_id, wasgo_buffer_camera, wasgo_size_camera, -69, p_enable);
}
...
void VisualServer::canvas_item_add_circle(RID p_item, Vector2 p_pos, float p_radius, Color p_color){
    ...
    uint8_t wasgo_buffer_item[256];
    int wasgo_size_item = 256;
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_circle(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_pos, wasgo_size_pos, p_radius, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::canvas_item_add_clip_ignore(RID p_item, bool p_ignore){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_clip_ignore(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_ignore);
}
void VisualServer::canvas_item_add_line(RID p_item, Vector2 p_from, Vector2 p_to, Color p_color, float p_width, bool p_antialiased){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_line(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_from, wasgo_size_from, wasgo_buffer_to, wasgo_size_to, wasgo_buffer_color, wasgo_size_color, p_width, p_antialiased);
}
void VisualServer::canvas_item_add_mesh(RID p_item, RID p_mesh, Transform2D p_transform, Color p_modulate, RID p_texture, RID p_normal_map){
    ...
    uint8_t wasgo_buffer_mesh[256];
    int wasgo_size_mesh = 256;
    ...
    uint8_t wasgo_buffer_texture[256];
    int wasgo_size_texture = 256;
    encode_variant(wasgo_var_texture, wasgo_buffer_texture, wasgo_size_texture);
    

    Variant wasgo_var_normal_map = p_normal_map;
    uint8_t wasgo_buffer_normal_map[256];
    int wasgo_size_normal_map = 256;
    encode_variant(wasgo_var_normal_map, wasgo_buffer_normal_map, wasgo_size_normal_map);
    
	_wasgo_VisualServer_wrapper_canvas_item_add_mesh(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_mesh, wasgo_size_mesh, wasgo_buffer_transform, wasgo_size_transform, wasgo_buffer_modulate, wasgo_size_modulate, wasgo_buffer_texture, wasgo_size_texture, wasgo_buffer_normal_map, wasgo_size_normal_map);
}
void VisualServer::canvas_item_add_multimesh(RID p_item, RID p_mesh, RID p_texture, RID p_normal_map){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_multimesh(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_mesh, wasgo_size_mesh, wasgo_buffer_texture, wasgo_size_texture, wasgo_buffer_normal_map, wasgo_size_normal_map);
}
...
void VisualServer::canvas_item_add_particles(RID p_item, RID p_particles, RID p_texture, RID p_normal_map){
    ...
    uint8_t wasgo_buffer_particles[256];
    int wasgo_size_particles = 256;
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_particles(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_particles, wasgo_size_particles, wasgo_buffer_texture, wasgo_size_texture, wasgo_buffer_normal_map, wasgo_size_normal_map);
}
void VisualServer::canvas_item_add_polygon(RID p_item, PoolVector2Array p_points, PoolColorArray p_colors, PoolVector2Array p_uvs, RID p_texture, RID p_normal_map, bool p_antialiased){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_polygon(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_points._get_wasgo_id(), p_colors._get_wasgo_id(), p_uvs._get_wasgo_id(), wasgo_buffer_texture, wasgo_size_texture, wasgo_buffer_normal_map, wasgo_size_normal_map, p_antialiased);
}
void VisualServer::canvas_item_add_polyline(RID p_item, PoolVector2Array p_points, PoolColorArray p_colors, float p_width, bool p_antialiased){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_polyline(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_points._get_wasgo_id(), p_colors._get_wasgo_id(), p_width, p_antialiased);
}
void VisualServer::canvas_item_add_primitive(RID p_item, PoolVector2Array p_points, PoolColorArray p_colors, PoolVector2Array p_uvs, RID p_texture, float p_width, RID p_normal_map){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_primitive(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_points._get_wasgo_id(), p_colors._get_wasgo_id(), p_uvs._get_wasgo_id(), wasgo_buffer_texture, wasgo_size_texture, p_width, wasgo_buffer_normal_map, wasgo_size_normal_map);
}
void VisualServer::canvas_item_add_rect(RID p_item, Rect2 p_rect, Color p_color){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_rect(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_rect, wasgo_size_rect, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::canvas_item_add_set_transform(RID p_item, Transform2D p_transform){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_set_transform(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::canvas_item_add_texture_rect(RID p_item, Rect2 p_rect, RID p_texture, bool p_tile, Color p_modulate, bool p_transpose, RID p_normal_map){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_texture_rect(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_rect, wasgo_size_rect, wasgo_buffer_texture, wasgo_size_texture, p_tile, wasgo_buffer_modulate, wasgo_size_modulate, p_transpose, wasgo_buffer_normal_map, wasgo_size_normal_map);
}
void VisualServer::canvas_item_add_texture_rect_region(RID p_item, Rect2 p_rect, RID p_texture, Rect2 p_src_rect, Color p_modulate, bool p_transpose, RID p_normal_map, bool p_clip_uv){
	...
	_wasgo_VisualServer_wrapper_canvas_item_add_texture_rect_region(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_rect, wasgo_size_rect, wasgo_buffer_texture, wasgo_size_texture, wasgo_buffer_src_rect, wasgo_size_src_rect, wasgo_buffer_modulate, wasgo_size_modulate, p_transpose, wasgo_buffer_normal_map, wasgo_size_normal_map, p_clip_uv);
}
...
void VisualServer::canvas_item_set_clip(RID p_item, bool p_clip){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_clip(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_clip);
}
void VisualServer::canvas_item_set_copy_to_backbuffer(RID p_item, bool p_enabled, Rect2 p_rect){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_copy_to_backbuffer(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_enabled, wasgo_buffer_rect, wasgo_size_rect);
}
void VisualServer::canvas_item_set_custom_rect(RID p_item, bool p_use_custom_rect, Rect2 p_rect){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_custom_rect(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_use_custom_rect, wasgo_buffer_rect, wasgo_size_rect);
}
void VisualServer::canvas_item_set_distance_field_mode(RID p_item, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_distance_field_mode(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_enabled);
}
void VisualServer::canvas_item_set_draw_behind_parent(RID p_item, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_draw_behind_parent(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_enabled);
}
void VisualServer::canvas_item_set_draw_index(RID p_item, int p_index){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_draw_index(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_index);
}
void VisualServer::canvas_item_set_light_mask(RID p_item, int p_mask){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_light_mask(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_mask);
}
void VisualServer::canvas_item_set_material(RID p_item, RID p_material){
    ...
    uint8_t wasgo_buffer_material[256];
    int wasgo_size_material = 256;
    encode_variant(wasgo_var_material, wasgo_buffer_material, wasgo_size_material);
    
	_wasgo_VisualServer_wrapper_canvas_item_set_material(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_material, wasgo_size_material);
}
void VisualServer::canvas_item_set_modulate(RID p_item, Color p_color){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_modulate(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::canvas_item_set_parent(RID p_item, RID p_parent){
    ...
    uint8_t wasgo_buffer_parent[256];
    int wasgo_size_parent = 256;
    encode_variant(wasgo_var_parent, wasgo_buffer_parent, wasgo_size_parent);
    
	_wasgo_VisualServer_wrapper_canvas_item_set_parent(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_parent, wasgo_size_parent);
}
void VisualServer::canvas_item_set_self_modulate(RID p_item, Color p_color){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_self_modulate(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::canvas_item_set_sort_children_by_y(RID p_item, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_sort_children_by_y(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_enabled);
}
void VisualServer::canvas_item_set_transform(RID p_item, Transform2D p_transform){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_transform(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::canvas_item_set_use_parent_material(RID p_item, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_use_parent_material(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_enabled);
}
void VisualServer::canvas_item_set_visible(RID p_item, bool p_visible){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_visible(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_visible);
}
void VisualServer::canvas_item_set_z_as_relative_to_parent(RID p_item, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_z_as_relative_to_parent(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_enabled);
}
void VisualServer::canvas_item_set_z_index(RID p_item, int p_z_index){
	...
	_wasgo_VisualServer_wrapper_canvas_item_set_z_index(wasgo_id, wasgo_buffer_item, wasgo_size_item, -69, p_z_index);
}
void VisualServer::canvas_light_attach_to_canvas(RID p_light, RID p_canvas){

    Variant wasgo_var_light = p_light;
    uint8_t wasgo_buffer_light[256];
    int wasgo_size_light = 256;
    encode_variant(wasgo_var_light, wasgo_buffer_light, wasgo_size_light);
    

    Variant wasgo_var_canvas = p_canvas;
    uint8_t wasgo_buffer_canvas[256];
    int wasgo_size_canvas = 256;
    encode_variant(wasgo_var_canvas, wasgo_buffer_canvas, wasgo_size_canvas);
    
	_wasgo_VisualServer_wrapper_canvas_light_attach_to_canvas(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_canvas, wasgo_size_canvas);
}
...
void VisualServer::canvas_light_occluder_attach_to_canvas(RID p_occluder, RID p_canvas){
    ...
    uint8_t wasgo_buffer_occluder[256];
    int wasgo_size_occluder = 256;
	...
	_wasgo_VisualServer_wrapper_canvas_light_occluder_attach_to_canvas(wasgo_id, wasgo_buffer_occluder, wasgo_size_occluder, -69, wasgo_buffer_canvas, wasgo_size_canvas);
}
...
void VisualServer::canvas_light_occluder_set_enabled(RID p_occluder, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_light_occluder_set_enabled(wasgo_id, wasgo_buffer_occluder, wasgo_size_occluder, -69, p_enabled);
}
void VisualServer::canvas_light_occluder_set_light_mask(RID p_occluder, int p_mask){
	...
	_wasgo_VisualServer_wrapper_canvas_light_occluder_set_light_mask(wasgo_id, wasgo_buffer_occluder, wasgo_size_occluder, -69, p_mask);
}
void VisualServer::canvas_light_occluder_set_polygon(RID p_occluder, RID p_polygon){
    ...
    uint8_t wasgo_buffer_polygon[256];
    int wasgo_size_polygon = 256;
    encode_variant(wasgo_var_polygon, wasgo_buffer_polygon, wasgo_size_polygon);
    
	_wasgo_VisualServer_wrapper_canvas_light_occluder_set_polygon(wasgo_id, wasgo_buffer_occluder, wasgo_size_occluder, -69, wasgo_buffer_polygon, wasgo_size_polygon);
}
void VisualServer::canvas_light_occluder_set_transform(RID p_occluder, Transform2D p_transform){
	...
	_wasgo_VisualServer_wrapper_canvas_light_occluder_set_transform(wasgo_id, wasgo_buffer_occluder, wasgo_size_occluder, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::canvas_light_set_color(RID p_light, Color p_color){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_color(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::canvas_light_set_enabled(RID p_light, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_enabled(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_enabled);
}
void VisualServer::canvas_light_set_energy(RID p_light, float p_energy){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_energy(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_energy);
}
void VisualServer::canvas_light_set_height(RID p_light, float p_height){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_height(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_height);
}
void VisualServer::canvas_light_set_item_cull_mask(RID p_light, int p_mask){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_item_cull_mask(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_mask);
}
void VisualServer::canvas_light_set_item_shadow_cull_mask(RID p_light, int p_mask){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_item_shadow_cull_mask(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_mask);
}
void VisualServer::canvas_light_set_layer_range(RID p_light, int p_min_layer, int p_max_layer){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_layer_range(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_min_layer, p_max_layer);
}
void VisualServer::canvas_light_set_mode(RID p_light, VisualServer::CanvasLightMode p_mode){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_mode(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_mode._get_wasgo_id());
}
void VisualServer::canvas_light_set_scale(RID p_light, float p_scale){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_scale(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_scale);
}
void VisualServer::canvas_light_set_shadow_buffer_size(RID p_light, int p_size){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_shadow_buffer_size(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_size);
}
void VisualServer::canvas_light_set_shadow_color(RID p_light, Color p_color){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_shadow_color(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::canvas_light_set_shadow_enabled(RID p_light, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_shadow_enabled(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_enabled);
}
void VisualServer::canvas_light_set_shadow_filter(RID p_light, VisualServer::CanvasLightShadowFilter p_filter){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_shadow_filter(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_filter._get_wasgo_id());
}
void VisualServer::canvas_light_set_shadow_gradient_length(RID p_light, float p_length){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_shadow_gradient_length(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_length);
}
void VisualServer::canvas_light_set_shadow_smooth(RID p_light, float p_smooth){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_shadow_smooth(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_smooth);
}
void VisualServer::canvas_light_set_texture(RID p_light, RID p_texture){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_texture(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_texture, wasgo_size_texture);
}
void VisualServer::canvas_light_set_texture_offset(RID p_light, Vector2 p_offset){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_texture_offset(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_offset, wasgo_size_offset);
}
void VisualServer::canvas_light_set_transform(RID p_light, Transform2D p_transform){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_transform(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::canvas_light_set_z_range(RID p_light, int p_min_z, int p_max_z){
	...
	_wasgo_VisualServer_wrapper_canvas_light_set_z_range(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_min_z, p_max_z);
}
...
void VisualServer::canvas_occluder_polygon_set_cull_mode(RID p_occluder_polygon, VisualServer::CanvasOccluderPolygonCullMode p_mode){
    ...
    uint8_t wasgo_buffer_occluder_polygon[256];
    int wasgo_size_occluder_polygon = 256;
    encode_variant(wasgo_var_occluder_polygon, wasgo_buffer_occluder_polygon, wasgo_size_occluder_polygon);
    
	_wasgo_VisualServer_wrapper_canvas_occluder_polygon_set_cull_mode(wasgo_id, wasgo_buffer_occluder_polygon, wasgo_size_occluder_polygon, -69, p_mode._get_wasgo_id());
}
void VisualServer::canvas_occluder_polygon_set_shape(RID p_occluder_polygon, PoolVector2Array p_shape, bool p_closed){
	...
	_wasgo_VisualServer_wrapper_canvas_occluder_polygon_set_shape(wasgo_id, wasgo_buffer_occluder_polygon, wasgo_size_occluder_polygon, -69, p_shape._get_wasgo_id(), p_closed);
}
void VisualServer::canvas_occluder_polygon_set_shape_as_lines(RID p_occluder_polygon, PoolVector2Array p_shape){
	...
	_wasgo_VisualServer_wrapper_canvas_occluder_polygon_set_shape_as_lines(wasgo_id, wasgo_buffer_occluder_polygon, wasgo_size_occluder_polygon, -69, p_shape._get_wasgo_id());
}
void VisualServer::canvas_set_item_mirroring(RID p_canvas, RID p_item, Vector2 p_mirroring){
	...
	_wasgo_VisualServer_wrapper_canvas_set_item_mirroring(wasgo_id, wasgo_buffer_canvas, wasgo_size_canvas, -69, wasgo_buffer_item, wasgo_size_item, wasgo_buffer_mirroring, wasgo_size_mirroring);
}
void VisualServer::canvas_set_modulate(RID p_canvas, Color p_color){
	...
	_wasgo_VisualServer_wrapper_canvas_set_modulate(wasgo_id, wasgo_buffer_canvas, wasgo_size_canvas, -69, wasgo_buffer_color, wasgo_size_color);
}
...
void VisualServer::environment_set_adjustment(RID p_env, bool p_enable, float p_brightness, float p_contrast, float p_saturation, RID p_ramp){
    ...
    uint8_t wasgo_buffer_ramp[256];
    int wasgo_size_ramp = 256;
    encode_variant(wasgo_var_ramp, wasgo_buffer_ramp, wasgo_size_ramp);
    
	_wasgo_VisualServer_wrapper_environment_set_adjustment(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_brightness, p_contrast, p_saturation, wasgo_buffer_ramp, wasgo_size_ramp);
}
void VisualServer::environment_set_ambient_light(RID p_env, Color p_color, float p_energy, float p_sky_contibution){
	...
	_wasgo_VisualServer_wrapper_environment_set_ambient_light(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, wasgo_buffer_color, wasgo_size_color, p_energy, p_sky_contibution);
}
void VisualServer::environment_set_background(RID p_env, VisualServer::EnvironmentBG p_bg){
	...
	_wasgo_VisualServer_wrapper_environment_set_background(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_bg._get_wasgo_id());
}
void VisualServer::environment_set_bg_color(RID p_env, Color p_color){
	...
	_wasgo_VisualServer_wrapper_environment_set_bg_color(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::environment_set_bg_energy(RID p_env, float p_energy){
	...
	_wasgo_VisualServer_wrapper_environment_set_bg_energy(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_energy);
}
void VisualServer::environment_set_canvas_max_layer(RID p_env, int p_max_layer){
	...
	_wasgo_VisualServer_wrapper_environment_set_canvas_max_layer(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_max_layer);
}
void VisualServer::environment_set_dof_blur_far(RID p_env, bool p_enable, float p_distance, float p_transition, float p_far_amount, VisualServer::EnvironmentDOFBlurQuality p_quality){
	...
	_wasgo_VisualServer_wrapper_environment_set_dof_blur_far(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_distance, p_transition, p_far_amount, p_quality._get_wasgo_id());
}
void VisualServer::environment_set_dof_blur_near(RID p_env, bool p_enable, float p_distance, float p_transition, float p_far_amount, VisualServer::EnvironmentDOFBlurQuality p_quality){
	...
	_wasgo_VisualServer_wrapper_environment_set_dof_blur_near(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_distance, p_transition, p_far_amount, p_quality._get_wasgo_id());
}
void VisualServer::environment_set_fog(RID p_env, bool p_enable, Color p_color, Color p_sun_color, float p_sun_amount){
	...
	_wasgo_VisualServer_wrapper_environment_set_fog(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, wasgo_buffer_color, wasgo_size_color, wasgo_buffer_sun_color, wasgo_size_sun_color, p_sun_amount);
}
void VisualServer::environment_set_fog_depth(RID p_env, bool p_enable, float p_depth_begin, float p_depth_end, float p_depth_curve, bool p_transmit, float p_transmit_curve){
	...
	_wasgo_VisualServer_wrapper_environment_set_fog_depth(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_depth_begin, p_depth_end, p_depth_curve, p_transmit, p_transmit_curve);
}
void VisualServer::environment_set_fog_height(RID p_env, bool p_enable, float p_min_height, float p_max_height, float p_height_curve){
	...
	_wasgo_VisualServer_wrapper_environment_set_fog_height(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_min_height, p_max_height, p_height_curve);
}
void VisualServer::environment_set_glow(RID p_env, bool p_enable, int p_level_flags, float p_intensity, float p_strength, float p_bloom_threshold, VisualServer::EnvironmentGlowBlendMode p_blend_mode, float p_hdr_bleed_threshold, float p_hdr_bleed_scale, float p_hdr_luminance_cap, bool p_bicubic_upscale){
	...
	_wasgo_VisualServer_wrapper_environment_set_glow(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_level_flags, p_intensity, p_strength, p_bloom_threshold, p_blend_mode._get_wasgo_id(), p_hdr_bleed_threshold, p_hdr_bleed_scale, p_hdr_luminance_cap, p_bicubic_upscale);
}
void VisualServer::environment_set_sky(RID p_env, RID p_sky){
    ...
    uint8_t wasgo_buffer_sky[256];
    int wasgo_size_sky = 256;
    encode_variant(wasgo_var_sky, wasgo_buffer_sky, wasgo_size_sky);
    
	_wasgo_VisualServer_wrapper_environment_set_sky(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, wasgo_buffer_sky, wasgo_size_sky);
}
void VisualServer::environment_set_sky_custom_fov(RID p_env, float p_scale){
	...
	_wasgo_VisualServer_wrapper_environment_set_sky_custom_fov(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_scale);
}
void VisualServer::environment_set_sky_orientation(RID p_env, Basis p_orientation){
	...
	_wasgo_VisualServer_wrapper_environment_set_sky_orientation(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, wasgo_buffer_orientation, wasgo_size_orientation);
}
void VisualServer::environment_set_ssao(RID p_env, bool p_enable, float p_radius, float p_intensity, float p_radius2, float p_intensity2, float p_bias, float p_light_affect, float p_ao_channel_affect, Color p_color, VisualServer::EnvironmentSSAOQuality p_quality, VisualServer::EnvironmentSSAOBlur p_blur, float p_bilateral_sharpness){
	...
	_wasgo_VisualServer_wrapper_environment_set_ssao(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_radius, p_intensity, p_radius2, p_intensity2, p_bias, p_light_affect, p_ao_channel_affect, wasgo_buffer_color, wasgo_size_color, p_quality._get_wasgo_id(), p_blur._get_wasgo_id(), p_bilateral_sharpness);
}
void VisualServer::environment_set_ssr(RID p_env, bool p_enable, int p_max_steps, float p_fade_in, float p_fade_out, float p_depth_tolerance, bool p_roughness){
	...
	_wasgo_VisualServer_wrapper_environment_set_ssr(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_enable, p_max_steps, p_fade_in, p_fade_out, p_depth_tolerance, p_roughness);
}
void VisualServer::environment_set_tonemap(RID p_env, VisualServer::EnvironmentToneMapper p_tone_mapper, float p_exposure, float p_white, bool p_auto_exposure, float p_min_luminance, float p_max_luminance, float p_auto_exp_speed, float p_auto_exp_grey){
	...
	_wasgo_VisualServer_wrapper_environment_set_tonemap(wasgo_id, wasgo_buffer_env, wasgo_size_env, -69, p_tone_mapper._get_wasgo_id(), p_exposure, p_white, p_auto_exposure, p_min_luminance, p_max_luminance, p_auto_exp_speed, p_auto_exp_grey);
}
...
float VisualServer::gi_probe_get_bias(RID p_probe){
    ...
    uint8_t wasgo_buffer_probe[256];
    int wasgo_size_probe = 256;
...
::AABB VisualServer::gi_probe_get_bounds(RID p_probe){
    ...
    _wasgo_VisualServer_wrapper_gi_probe_get_bounds(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_probe, wasgo_size_probe);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform VisualServer::gi_probe_get_to_cell_xform(RID p_probe){
    ...
    _wasgo_VisualServer_wrapper_gi_probe_get_to_cell_xform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_probe, wasgo_size_probe);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::gi_probe_set_bias(RID p_probe, float p_bias){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_bias(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_bias);
}
void VisualServer::gi_probe_set_bounds(RID p_probe, ::AABB p_bounds){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_bounds(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, wasgo_buffer_bounds, wasgo_size_bounds);
}
void VisualServer::gi_probe_set_cell_size(RID p_probe, float p_range){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_cell_size(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_range);
}
void VisualServer::gi_probe_set_compress(RID p_probe, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_compress(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_enable);
}
void VisualServer::gi_probe_set_dynamic_data(RID p_probe, PoolIntArray p_data){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_dynamic_data(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_data._get_wasgo_id());
}
void VisualServer::gi_probe_set_dynamic_range(RID p_probe, int p_range){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_dynamic_range(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_range);
}
void VisualServer::gi_probe_set_energy(RID p_probe, float p_energy){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_energy(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_energy);
}
void VisualServer::gi_probe_set_interior(RID p_probe, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_interior(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_enable);
}
void VisualServer::gi_probe_set_normal_bias(RID p_probe, float p_bias){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_normal_bias(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_bias);
}
void VisualServer::gi_probe_set_propagation(RID p_probe, float p_propagation){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_propagation(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_propagation);
}
void VisualServer::gi_probe_set_to_cell_xform(RID p_probe, Transform p_xform){
	...
	_wasgo_VisualServer_wrapper_gi_probe_set_to_cell_xform(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, wasgo_buffer_xform, wasgo_size_xform);
}
...
bool VisualServer::has_os_feature(String p_feature){
    ...
    int wasgo_size_feature = 10 + String(p_feature).size();
...
void VisualServer::immediate_begin(RID p_immediate, VisualServer::PrimitiveType p_primitive, RID p_texture){
    ...
    uint8_t wasgo_buffer_immediate[256];
    int wasgo_size_immediate = 256;
	...
	_wasgo_VisualServer_wrapper_immediate_begin(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, p_primitive._get_wasgo_id(), wasgo_buffer_texture, wasgo_size_texture);
}
...
void VisualServer::immediate_color(RID p_immediate, Color p_color){
	...
	_wasgo_VisualServer_wrapper_immediate_color(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_color, wasgo_size_color);
}
...
RID VisualServer::immediate_get_material(RID p_immediate){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_immediate_get_material(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_immediate, wasgo_size_immediate);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::immediate_normal(RID p_immediate, Vector3 p_normal){
	...
	_wasgo_VisualServer_wrapper_immediate_normal(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_normal, wasgo_size_normal);
}
void VisualServer::immediate_set_material(RID p_immediate, RID p_material){
	...
	_wasgo_VisualServer_wrapper_immediate_set_material(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_material, wasgo_size_material);
}
void VisualServer::immediate_tangent(RID p_immediate, Plane p_tangent){
	...
	_wasgo_VisualServer_wrapper_immediate_tangent(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_tangent, wasgo_size_tangent);
}
void VisualServer::immediate_uv(RID p_immediate, Vector2 p_tex_uv){
	...
	_wasgo_VisualServer_wrapper_immediate_uv(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_tex_uv, wasgo_size_tex_uv);
}
void VisualServer::immediate_uv2(RID p_immediate, Vector2 p_tex_uv){
	...
	_wasgo_VisualServer_wrapper_immediate_uv2(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_tex_uv, wasgo_size_tex_uv);
}
void VisualServer::immediate_vertex(RID p_immediate, Vector3 p_vertex){
	...
	_wasgo_VisualServer_wrapper_immediate_vertex(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_vertex, wasgo_size_vertex);
}
void VisualServer::immediate_vertex_2d(RID p_immediate, Vector2 p_vertex){
	...
	_wasgo_VisualServer_wrapper_immediate_vertex_2d(wasgo_id, wasgo_buffer_immediate, wasgo_size_immediate, -69, wasgo_buffer_vertex, wasgo_size_vertex);
}
...
void VisualServer::instance_attach_object_instance_id(RID p_instance, int p_id){
    ...
    uint8_t wasgo_buffer_instance[256];
    int wasgo_size_instance = 256;
    encode_variant(wasgo_var_instance, wasgo_buffer_instance, wasgo_size_instance);
    
	_wasgo_VisualServer_wrapper_instance_attach_object_instance_id(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_id);
}
void VisualServer::instance_attach_skeleton(RID p_instance, RID p_skeleton){
	...
	_wasgo_VisualServer_wrapper_instance_attach_skeleton(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_skeleton, wasgo_size_skeleton);
}
...
RID VisualServer::instance_create2(RID p_base, RID p_scenario){
    ...
    uint8_t wasgo_buffer_base[256];
    int wasgo_size_base = 256;
    encode_variant(wasgo_var_base, wasgo_buffer_base, wasgo_size_base);
    

    Variant wasgo_var_scenario = p_scenario;
    uint8_t wasgo_buffer_scenario[256];
    int wasgo_size_scenario = 256;
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_instance_create2(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_base, wasgo_size_base, wasgo_buffer_scenario, wasgo_size_scenario);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::instance_geometry_set_as_instance_lod(RID p_instance, RID p_as_lod_of_instance){
    ...
    uint8_t wasgo_buffer_as_lod_of_instance[256];
    int wasgo_size_as_lod_of_instance = 256;
    encode_variant(wasgo_var_as_lod_of_instance, wasgo_buffer_as_lod_of_instance, wasgo_size_as_lod_of_instance);
    
	_wasgo_VisualServer_wrapper_instance_geometry_set_as_instance_lod(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_as_lod_of_instance, wasgo_size_as_lod_of_instance);
}
void VisualServer::instance_geometry_set_cast_shadows_setting(RID p_instance, VisualServer::ShadowCastingSetting p_shadow_casting_setting){
	...
	_wasgo_VisualServer_wrapper_instance_geometry_set_cast_shadows_setting(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_shadow_casting_setting._get_wasgo_id());
}
void VisualServer::instance_geometry_set_draw_range(RID p_instance, float p_min, float p_max, float p_min_margin, float p_max_margin){
	...
	_wasgo_VisualServer_wrapper_instance_geometry_set_draw_range(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_min, p_max, p_min_margin, p_max_margin);
}
void VisualServer::instance_geometry_set_flag(RID p_instance, VisualServer::InstanceFlags p_flag, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_instance_geometry_set_flag(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_flag._get_wasgo_id(), p_enabled);
}
void VisualServer::instance_geometry_set_material_override(RID p_instance, RID p_material){
	...
	_wasgo_VisualServer_wrapper_instance_geometry_set_material_override(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_material, wasgo_size_material);
}
void VisualServer::instance_set_base(RID p_instance, RID p_base){
	...
	_wasgo_VisualServer_wrapper_instance_set_base(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_base, wasgo_size_base);
}
void VisualServer::instance_set_blend_shape_weight(RID p_instance, int p_shape, float p_weight){
	...
	_wasgo_VisualServer_wrapper_instance_set_blend_shape_weight(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_shape, p_weight);
}
void VisualServer::instance_set_custom_aabb(RID p_instance, ::AABB p_aabb){
	...
	_wasgo_VisualServer_wrapper_instance_set_custom_aabb(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_aabb, wasgo_size_aabb);
}
void VisualServer::instance_set_exterior(RID p_instance, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_instance_set_exterior(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_enabled);
}
void VisualServer::instance_set_extra_visibility_margin(RID p_instance, float p_margin){
	...
	_wasgo_VisualServer_wrapper_instance_set_extra_visibility_margin(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_margin);
}
void VisualServer::instance_set_layer_mask(RID p_instance, int p_mask){
	...
	_wasgo_VisualServer_wrapper_instance_set_layer_mask(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_mask);
}
void VisualServer::instance_set_scenario(RID p_instance, RID p_scenario){
	...
	_wasgo_VisualServer_wrapper_instance_set_scenario(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_scenario, wasgo_size_scenario);
}
void VisualServer::instance_set_surface_material(RID p_instance, int p_surface, RID p_material){
	...
	_wasgo_VisualServer_wrapper_instance_set_surface_material(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_surface, wasgo_buffer_material, wasgo_size_material);
}
void VisualServer::instance_set_transform(RID p_instance, Transform p_transform){
	...
	_wasgo_VisualServer_wrapper_instance_set_transform(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::instance_set_use_lightmap(RID p_instance, RID p_lightmap_instance, RID p_lightmap){
    ...
    uint8_t wasgo_buffer_lightmap_instance[256];
    int wasgo_size_lightmap_instance = 256;
    ...
    uint8_t wasgo_buffer_lightmap[256];
    int wasgo_size_lightmap = 256;
    encode_variant(wasgo_var_lightmap, wasgo_buffer_lightmap, wasgo_size_lightmap);
    
	_wasgo_VisualServer_wrapper_instance_set_use_lightmap(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, wasgo_buffer_lightmap_instance, wasgo_size_lightmap_instance, wasgo_buffer_lightmap, wasgo_size_lightmap);
}
void VisualServer::instance_set_visible(RID p_instance, bool p_visible){
	...
	_wasgo_VisualServer_wrapper_instance_set_visible(wasgo_id, wasgo_buffer_instance, wasgo_size_instance, -69, p_visible);
}
Array VisualServer::instances_cull_aabb(::AABB p_aabb, RID p_scenario){
	...
	return Array(_wasgo_VisualServer_wrapper_instances_cull_aabb(wasgo_id, wasgo_buffer_aabb, wasgo_size_aabb, -69, wasgo_buffer_scenario, wasgo_size_scenario));
}
Array VisualServer::instances_cull_convex(Array p_convex, RID p_scenario){
	...
	return Array(_wasgo_VisualServer_wrapper_instances_cull_convex(wasgo_id, p_convex._get_wasgo_id(), wasgo_buffer_scenario, wasgo_size_scenario, wasgo_size_scenario));
}
Array VisualServer::instances_cull_ray(Vector3 p_from, Vector3 p_to, RID p_scenario){
	...
	return Array(_wasgo_VisualServer_wrapper_instances_cull_ray(wasgo_id, wasgo_buffer_from, wasgo_size_from, -69, wasgo_buffer_to, wasgo_size_to, wasgo_buffer_scenario, wasgo_size_scenario));
}
...
void VisualServer::light_directional_set_blend_splits(RID p_light, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_light_directional_set_blend_splits(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_enable);
}
void VisualServer::light_directional_set_shadow_depth_range_mode(RID p_light, VisualServer::LightDirectionalShadowDepthRangeMode p_range_mode){
	...
	_wasgo_VisualServer_wrapper_light_directional_set_shadow_depth_range_mode(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_range_mode._get_wasgo_id());
}
void VisualServer::light_directional_set_shadow_mode(RID p_light, VisualServer::LightDirectionalShadowMode p_mode){
	...
	_wasgo_VisualServer_wrapper_light_directional_set_shadow_mode(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_mode._get_wasgo_id());
}
void VisualServer::light_omni_set_shadow_detail(RID p_light, VisualServer::LightOmniShadowDetail p_detail){
	...
	_wasgo_VisualServer_wrapper_light_omni_set_shadow_detail(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_detail._get_wasgo_id());
}
void VisualServer::light_omni_set_shadow_mode(RID p_light, VisualServer::LightOmniShadowMode p_mode){
	...
	_wasgo_VisualServer_wrapper_light_omni_set_shadow_mode(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_mode._get_wasgo_id());
}
void VisualServer::light_set_color(RID p_light, Color p_color){
	...
	_wasgo_VisualServer_wrapper_light_set_color(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::light_set_cull_mask(RID p_light, int p_mask){
	...
	_wasgo_VisualServer_wrapper_light_set_cull_mask(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_mask);
}
void VisualServer::light_set_negative(RID p_light, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_light_set_negative(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_enable);
}
void VisualServer::light_set_param(RID p_light, VisualServer::LightParam p_param, float p_value){
	...
	_wasgo_VisualServer_wrapper_light_set_param(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_param._get_wasgo_id(), p_value);
}
void VisualServer::light_set_projector(RID p_light, RID p_texture){
	...
	_wasgo_VisualServer_wrapper_light_set_projector(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_texture, wasgo_size_texture);
}
void VisualServer::light_set_reverse_cull_face_mode(RID p_light, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_light_set_reverse_cull_face_mode(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_enabled);
}
void VisualServer::light_set_shadow(RID p_light, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_light_set_shadow(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_enabled);
}
void VisualServer::light_set_shadow_color(RID p_light, Color p_color){
	...
	_wasgo_VisualServer_wrapper_light_set_shadow_color(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::light_set_use_gi(RID p_light, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_light_set_use_gi(wasgo_id, wasgo_buffer_light, wasgo_size_light, -69, p_enabled);
}
...
::AABB VisualServer::lightmap_capture_get_bounds(RID p_capture){
    ...
    uint8_t wasgo_buffer_capture[256];
    int wasgo_size_capture = 256;
    ...
    int wasgo_ret_buffer_size = 28;
    uint8_t wasgo_ret_buffer[28];
    _wasgo_VisualServer_wrapper_lightmap_capture_get_bounds(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_capture, wasgo_size_capture);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform VisualServer::lightmap_capture_get_octree_cell_transform(RID p_capture){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_VisualServer_wrapper_lightmap_capture_get_octree_cell_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_capture, wasgo_size_capture);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::lightmap_capture_set_bounds(RID p_capture, ::AABB p_bounds){
	...
	_wasgo_VisualServer_wrapper_lightmap_capture_set_bounds(wasgo_id, wasgo_buffer_capture, wasgo_size_capture, -69, wasgo_buffer_bounds, wasgo_size_bounds);
}
void VisualServer::lightmap_capture_set_energy(RID p_capture, float p_energy){
	...
	_wasgo_VisualServer_wrapper_lightmap_capture_set_energy(wasgo_id, wasgo_buffer_capture, wasgo_size_capture, -69, p_energy);
}
void VisualServer::lightmap_capture_set_octree(RID p_capture, PoolByteArray p_octree){
	...
	_wasgo_VisualServer_wrapper_lightmap_capture_set_octree(wasgo_id, wasgo_buffer_capture, wasgo_size_capture, -69, p_octree._get_wasgo_id());
}
void VisualServer::lightmap_capture_set_octree_cell_subdiv(RID p_capture, int p_subdiv){
	...
	_wasgo_VisualServer_wrapper_lightmap_capture_set_octree_cell_subdiv(wasgo_id, wasgo_buffer_capture, wasgo_size_capture, -69, p_subdiv);
}
void VisualServer::lightmap_capture_set_octree_cell_transform(RID p_capture, Transform p_xform){
	...
	_wasgo_VisualServer_wrapper_lightmap_capture_set_octree_cell_transform(wasgo_id, wasgo_buffer_capture, wasgo_size_capture, -69, wasgo_buffer_xform, wasgo_size_xform);
}
RID VisualServer::make_sphere_mesh(int p_latitudes, int p_longitudes, float p_radius){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_make_sphere_mesh(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_latitudes, p_longitudes, p_radius);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant VisualServer::material_get_param(RID p_material, String p_parameter){
    ...
    int wasgo_size_parameter = 10 + String(p_parameter).size();
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_material_get_param(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_material, wasgo_size_material, wasgo_buffer_parameter, wasgo_size_parameter);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant VisualServer::material_get_param_default(RID p_material, String p_parameter){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_material_get_param_default(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_material, wasgo_size_material, wasgo_buffer_parameter, wasgo_size_parameter);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID VisualServer::material_get_shader(RID p_shader_material){
    ...
    uint8_t wasgo_buffer_shader_material[256];
    int wasgo_size_shader_material = 256;
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_material_get_shader(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_shader_material, wasgo_size_shader_material);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::material_set_line_width(RID p_material, float p_width){
	...
	_wasgo_VisualServer_wrapper_material_set_line_width(wasgo_id, wasgo_buffer_material, wasgo_size_material, -69, p_width);
}
void VisualServer::material_set_next_pass(RID p_material, RID p_next_material){
    ...
    uint8_t wasgo_buffer_next_material[256];
    int wasgo_size_next_material = 256;
    encode_variant(wasgo_var_next_material, wasgo_buffer_next_material, wasgo_size_next_material);
    
	_wasgo_VisualServer_wrapper_material_set_next_pass(wasgo_id, wasgo_buffer_material, wasgo_size_material, -69, wasgo_buffer_next_material, wasgo_size_next_material);
}
void VisualServer::material_set_param(RID p_material, String p_parameter, Variant p_value){
	...
	_wasgo_VisualServer_wrapper_material_set_param(wasgo_id, wasgo_buffer_material, wasgo_size_material, -69, wasgo_buffer_parameter, wasgo_size_parameter, wasgo_buffer_value, wasgo_size_value);
}
void VisualServer::material_set_render_priority(RID p_material, int p_priority){
	...
	_wasgo_VisualServer_wrapper_material_set_render_priority(wasgo_id, wasgo_buffer_material, wasgo_size_material, -69, p_priority);
}
void VisualServer::material_set_shader(RID p_shader_material, RID p_shader){
    ...
    uint8_t wasgo_buffer_shader[256];
    int wasgo_size_shader = 256;
    encode_variant(wasgo_var_shader, wasgo_buffer_shader, wasgo_size_shader);
    
	_wasgo_VisualServer_wrapper_material_set_shader(wasgo_id, wasgo_buffer_shader_material, wasgo_size_shader_material, -69, wasgo_buffer_shader, wasgo_size_shader);
}
void VisualServer::mesh_add_surface_from_arrays(RID p_mesh, VisualServer::PrimitiveType p_primitive, Array p_arrays, Array p_blend_shapes, int p_compress_format){
	...
	_wasgo_VisualServer_wrapper_mesh_add_surface_from_arrays(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_primitive._get_wasgo_id(), p_arrays._get_wasgo_id(), p_blend_shapes._get_wasgo_id(), p_compress_format);
}
...
::AABB VisualServer::mesh_get_custom_aabb(RID p_mesh){
    ...
    int wasgo_ret_buffer_size = 28;
    uint8_t wasgo_ret_buffer[28];
    _wasgo_VisualServer_wrapper_mesh_get_custom_aabb(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_mesh, wasgo_size_mesh);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::mesh_remove_surface(RID p_mesh, int p_index){
	...
	_wasgo_VisualServer_wrapper_mesh_remove_surface(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_index);
}
void VisualServer::mesh_set_blend_shape_count(RID p_mesh, int p_amount){
	...
	_wasgo_VisualServer_wrapper_mesh_set_blend_shape_count(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_amount);
}
void VisualServer::mesh_set_blend_shape_mode(RID p_mesh, VisualServer::BlendShapeMode p_mode){
	...
	_wasgo_VisualServer_wrapper_mesh_set_blend_shape_mode(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_mode._get_wasgo_id());
}
void VisualServer::mesh_set_custom_aabb(RID p_mesh, ::AABB p_aabb){
	...
	_wasgo_VisualServer_wrapper_mesh_set_custom_aabb(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, wasgo_buffer_aabb, wasgo_size_aabb);
}
::AABB VisualServer::mesh_surface_get_aabb(RID p_mesh, int p_surface){
    ...
    int wasgo_ret_buffer_size = 28;
    uint8_t wasgo_ret_buffer[28];
    _wasgo_VisualServer_wrapper_mesh_surface_get_aabb(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_mesh, wasgo_size_mesh, p_surface);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
PoolByteArray VisualServer::mesh_surface_get_array(RID p_mesh, int p_surface){
	...
	return PoolByteArray(_wasgo_VisualServer_wrapper_mesh_surface_get_array(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface));
}
int VisualServer::mesh_surface_get_array_index_len(RID p_mesh, int p_surface){
	...
	return (int) _wasgo_VisualServer_wrapper_mesh_surface_get_array_index_len(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface);
}
int VisualServer::mesh_surface_get_array_len(RID p_mesh, int p_surface){
	...
	return (int) _wasgo_VisualServer_wrapper_mesh_surface_get_array_len(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface);
}
Array VisualServer::mesh_surface_get_arrays(RID p_mesh, int p_surface){
	...
	return Array(_wasgo_VisualServer_wrapper_mesh_surface_get_arrays(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface));
}
Array VisualServer::mesh_surface_get_blend_shape_arrays(RID p_mesh, int p_surface){
	...
	return Array(_wasgo_VisualServer_wrapper_mesh_surface_get_blend_shape_arrays(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface));
}
int VisualServer::mesh_surface_get_format(RID p_mesh, int p_surface){
	...
	return (int) _wasgo_VisualServer_wrapper_mesh_surface_get_format(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface);
}
int VisualServer::mesh_surface_get_format_offset(int p_format, int p_vertex_len, int p_index_len, int p_array_index){
	return (int) _wasgo_VisualServer_wrapper_mesh_surface_get_format_offset(wasgo_id, p_format, p_vertex_len, -69, p_index_len, p_array_index);
}
int VisualServer::mesh_surface_get_format_stride(int p_format, int p_vertex_len, int p_index_len){
	return (int) _wasgo_VisualServer_wrapper_mesh_surface_get_format_stride(wasgo_id, p_format, p_vertex_len, -69, p_index_len);
}
PoolByteArray VisualServer::mesh_surface_get_index_array(RID p_mesh, int p_surface){
	...
	return PoolByteArray(_wasgo_VisualServer_wrapper_mesh_surface_get_index_array(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface));
}
RID VisualServer::mesh_surface_get_material(RID p_mesh, int p_surface){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_mesh_surface_get_material(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_mesh, wasgo_size_mesh, p_surface);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
VisualServer::PrimitiveType VisualServer::mesh_surface_get_primitive_type(RID p_mesh, int p_surface){
	...
	return VisualServer::PrimitiveType(_wasgo_VisualServer_wrapper_mesh_surface_get_primitive_type(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface));
}
Array VisualServer::mesh_surface_get_skeleton_aabb(RID p_mesh, int p_surface){
	...
	return Array(_wasgo_VisualServer_wrapper_mesh_surface_get_skeleton_aabb(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface));
}
void VisualServer::mesh_surface_set_material(RID p_mesh, int p_surface, RID p_material){
	...
	_wasgo_VisualServer_wrapper_mesh_surface_set_material(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface, wasgo_buffer_material, wasgo_size_material);
}
void VisualServer::mesh_surface_update_region(RID p_mesh, int p_surface, int p_offset, PoolByteArray p_data){
	...
	_wasgo_VisualServer_wrapper_mesh_surface_update_region(wasgo_id, wasgo_buffer_mesh, wasgo_size_mesh, -69, p_surface, p_offset, p_data._get_wasgo_id());
}
void VisualServer::multimesh_allocate(RID p_multimesh, int p_instances, VisualServer::MultimeshTransformFormat p_transform_format, VisualServer::MultimeshColorFormat p_color_format, VisualServer::MultimeshCustomDataFormat p_custom_data_format){
    ...
    uint8_t wasgo_buffer_multimesh[256];
    int wasgo_size_multimesh = 256;
    encode_variant(wasgo_var_multimesh, wasgo_buffer_multimesh, wasgo_size_multimesh);
    
	_wasgo_VisualServer_wrapper_multimesh_allocate(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, p_instances, p_transform_format._get_wasgo_id(), p_color_format._get_wasgo_id(), p_custom_data_format._get_wasgo_id());
}
...
::AABB VisualServer::multimesh_get_aabb(RID p_multimesh){
    ...
    int wasgo_ret_buffer_size = 28;
    uint8_t wasgo_ret_buffer[28];
    _wasgo_VisualServer_wrapper_multimesh_get_aabb(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_multimesh, wasgo_size_multimesh);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID VisualServer::multimesh_get_mesh(RID p_multimesh){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_multimesh_get_mesh(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_multimesh, wasgo_size_multimesh);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Color VisualServer::multimesh_instance_get_color(RID p_multimesh, int p_index){
    ...
    _wasgo_VisualServer_wrapper_multimesh_instance_get_color(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_multimesh, wasgo_size_multimesh, p_index);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Color VisualServer::multimesh_instance_get_custom_data(RID p_multimesh, int p_index){
    ...
    int wasgo_ret_buffer_size = 20;
    uint8_t wasgo_ret_buffer[20];
    _wasgo_VisualServer_wrapper_multimesh_instance_get_custom_data(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_multimesh, wasgo_size_multimesh, p_index);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform VisualServer::multimesh_instance_get_transform(RID p_multimesh, int p_index){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_VisualServer_wrapper_multimesh_instance_get_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_multimesh, wasgo_size_multimesh, p_index);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform2D VisualServer::multimesh_instance_get_transform_2d(RID p_multimesh, int p_index){
    ...
    int wasgo_ret_buffer_size = 28;
    uint8_t wasgo_ret_buffer[28];
    _wasgo_VisualServer_wrapper_multimesh_instance_get_transform_2d(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_multimesh, wasgo_size_multimesh, p_index);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::multimesh_instance_set_color(RID p_multimesh, int p_index, Color p_color){
	...
	_wasgo_VisualServer_wrapper_multimesh_instance_set_color(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, p_index, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::multimesh_instance_set_custom_data(RID p_multimesh, int p_index, Color p_custom_data){
	...
	_wasgo_VisualServer_wrapper_multimesh_instance_set_custom_data(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, p_index, wasgo_buffer_custom_data, wasgo_size_custom_data);
}
void VisualServer::multimesh_instance_set_transform(RID p_multimesh, int p_index, Transform p_transform){
	...
	_wasgo_VisualServer_wrapper_multimesh_instance_set_transform(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, p_index, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::multimesh_instance_set_transform_2d(RID p_multimesh, int p_index, Transform2D p_transform){
	...
	_wasgo_VisualServer_wrapper_multimesh_instance_set_transform_2d(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, p_index, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::multimesh_set_as_bulk_array(RID p_multimesh, PoolRealArray p_array){
	...
	_wasgo_VisualServer_wrapper_multimesh_set_as_bulk_array(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, p_array._get_wasgo_id());
}
void VisualServer::multimesh_set_mesh(RID p_multimesh, RID p_mesh){
	...
	_wasgo_VisualServer_wrapper_multimesh_set_mesh(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, wasgo_buffer_mesh, wasgo_size_mesh);
}
void VisualServer::multimesh_set_visible_instances(RID p_multimesh, int p_visible){
	...
	_wasgo_VisualServer_wrapper_multimesh_set_visible_instances(wasgo_id, wasgo_buffer_multimesh, wasgo_size_multimesh, -69, p_visible);
}
...
::AABB VisualServer::particles_get_current_aabb(RID p_particles){
    ...
    int wasgo_ret_buffer_size = 28;
    uint8_t wasgo_ret_buffer[28];
    _wasgo_VisualServer_wrapper_particles_get_current_aabb(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_particles, wasgo_size_particles);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::particles_set_amount(RID p_particles, int p_amount){
	...
	_wasgo_VisualServer_wrapper_particles_set_amount(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_amount);
}
void VisualServer::particles_set_custom_aabb(RID p_particles, ::AABB p_aabb){
	...
	_wasgo_VisualServer_wrapper_particles_set_custom_aabb(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, wasgo_buffer_aabb, wasgo_size_aabb);
}
void VisualServer::particles_set_draw_order(RID p_particles, VisualServer::ParticlesDrawOrder p_order){
	...
	_wasgo_VisualServer_wrapper_particles_set_draw_order(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_order._get_wasgo_id());
}
void VisualServer::particles_set_draw_pass_mesh(RID p_particles, int p_pass, RID p_mesh){
	...
	_wasgo_VisualServer_wrapper_particles_set_draw_pass_mesh(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_pass, wasgo_buffer_mesh, wasgo_size_mesh);
}
void VisualServer::particles_set_draw_passes(RID p_particles, int p_count){
	...
	_wasgo_VisualServer_wrapper_particles_set_draw_passes(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_count);
}
void VisualServer::particles_set_emission_transform(RID p_particles, Transform p_transform){
	...
	_wasgo_VisualServer_wrapper_particles_set_emission_transform(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::particles_set_emitting(RID p_particles, bool p_emitting){
	...
	_wasgo_VisualServer_wrapper_particles_set_emitting(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_emitting);
}
void VisualServer::particles_set_explosiveness_ratio(RID p_particles, float p_ratio){
	...
	_wasgo_VisualServer_wrapper_particles_set_explosiveness_ratio(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_ratio);
}
void VisualServer::particles_set_fixed_fps(RID p_particles, int p_fps){
	...
	_wasgo_VisualServer_wrapper_particles_set_fixed_fps(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_fps);
}
void VisualServer::particles_set_fractional_delta(RID p_particles, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_particles_set_fractional_delta(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_enable);
}
void VisualServer::particles_set_lifetime(RID p_particles, float p_lifetime){
	...
	_wasgo_VisualServer_wrapper_particles_set_lifetime(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_lifetime);
}
void VisualServer::particles_set_one_shot(RID p_particles, bool p_one_shot){
	...
	_wasgo_VisualServer_wrapper_particles_set_one_shot(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_one_shot);
}
void VisualServer::particles_set_pre_process_time(RID p_particles, float p_time){
	...
	_wasgo_VisualServer_wrapper_particles_set_pre_process_time(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_time);
}
void VisualServer::particles_set_process_material(RID p_particles, RID p_material){
	...
	_wasgo_VisualServer_wrapper_particles_set_process_material(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, wasgo_buffer_material, wasgo_size_material);
}
void VisualServer::particles_set_randomness_ratio(RID p_particles, float p_ratio){
	...
	_wasgo_VisualServer_wrapper_particles_set_randomness_ratio(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_ratio);
}
void VisualServer::particles_set_speed_scale(RID p_particles, float p_scale){
	...
	_wasgo_VisualServer_wrapper_particles_set_speed_scale(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_scale);
}
void VisualServer::particles_set_use_local_coordinates(RID p_particles, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_particles_set_use_local_coordinates(wasgo_id, wasgo_buffer_particles, wasgo_size_particles, -69, p_enable);
}
...
void VisualServer::reflection_probe_set_as_interior(RID p_probe, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_as_interior(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_enable);
}
void VisualServer::reflection_probe_set_cull_mask(RID p_probe, int p_layers){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_cull_mask(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_layers);
}
void VisualServer::reflection_probe_set_enable_box_projection(RID p_probe, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_enable_box_projection(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_enable);
}
void VisualServer::reflection_probe_set_enable_shadows(RID p_probe, bool p_enable){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_enable_shadows(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_enable);
}
void VisualServer::reflection_probe_set_extents(RID p_probe, Vector3 p_extents){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_extents(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, wasgo_buffer_extents, wasgo_size_extents);
}
void VisualServer::reflection_probe_set_intensity(RID p_probe, float p_intensity){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_intensity(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_intensity);
}
void VisualServer::reflection_probe_set_interior_ambient(RID p_probe, Color p_color){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_interior_ambient(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, wasgo_buffer_color, wasgo_size_color);
}
void VisualServer::reflection_probe_set_interior_ambient_energy(RID p_probe, float p_energy){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_interior_ambient_energy(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_energy);
}
void VisualServer::reflection_probe_set_interior_ambient_probe_contribution(RID p_probe, float p_contrib){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_interior_ambient_probe_contribution(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_contrib);
}
void VisualServer::reflection_probe_set_max_distance(RID p_probe, float p_distance){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_max_distance(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_distance);
}
void VisualServer::reflection_probe_set_origin_offset(RID p_probe, Vector3 p_offset){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_origin_offset(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, wasgo_buffer_offset, wasgo_size_offset);
}
void VisualServer::reflection_probe_set_update_mode(RID p_probe, VisualServer::ReflectionProbeUpdateMode p_mode){
	...
	_wasgo_VisualServer_wrapper_reflection_probe_set_update_mode(wasgo_id, wasgo_buffer_probe, wasgo_size_probe, -69, p_mode._get_wasgo_id());
}
void VisualServer::request_frame_drawn_callback(Object p_where, String p_method, Variant p_userdata){
	...
	_wasgo_VisualServer_wrapper_request_frame_drawn_callback(wasgo_id, p_where._get_wasgo_id(), wasgo_buffer_method, wasgo_size_method, wasgo_size_method, wasgo_buffer_userdata, wasgo_size_userdata);
}
...
void VisualServer::scenario_set_debug(RID p_scenario, VisualServer::ScenarioDebugMode p_debug_mode){
	...
	_wasgo_VisualServer_wrapper_scenario_set_debug(wasgo_id, wasgo_buffer_scenario, wasgo_size_scenario, -69, p_debug_mode._get_wasgo_id());
}
void VisualServer::scenario_set_environment(RID p_scenario, RID p_environment){
    ...
    uint8_t wasgo_buffer_environment[256];
    int wasgo_size_environment = 256;
    encode_variant(wasgo_var_environment, wasgo_buffer_environment, wasgo_size_environment);
    
	_wasgo_VisualServer_wrapper_scenario_set_environment(wasgo_id, wasgo_buffer_scenario, wasgo_size_scenario, -69, wasgo_buffer_environment, wasgo_size_environment);
}
void VisualServer::scenario_set_fallback_environment(RID p_scenario, RID p_environment){
	...
	_wasgo_VisualServer_wrapper_scenario_set_fallback_environment(wasgo_id, wasgo_buffer_scenario, wasgo_size_scenario, -69, wasgo_buffer_environment, wasgo_size_environment);
}
void VisualServer::scenario_set_reflection_atlas_size(RID p_scenario, int p_size, int p_subdiv){
	...
	_wasgo_VisualServer_wrapper_scenario_set_reflection_atlas_size(wasgo_id, wasgo_buffer_scenario, wasgo_size_scenario, -69, p_size, p_subdiv);
}
void VisualServer::set_boot_image(Image p_image, Color p_color, bool p_scale, bool p_use_filter){
	...
	_wasgo_VisualServer_wrapper_set_boot_image(wasgo_id, p_image._get_wasgo_id(), wasgo_buffer_color, wasgo_size_color, wasgo_size_color, p_scale, p_use_filter);
}
...
String VisualServer::shader_get_code(RID p_shader){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_shader_get_code(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_shader, wasgo_size_shader);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID VisualServer::shader_get_default_texture_param(RID p_shader, String p_name){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_shader_get_default_texture_param(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_shader, wasgo_size_shader, wasgo_buffer_name, wasgo_size_name);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::shader_set_code(RID p_shader, String p_code){
	...
	_wasgo_VisualServer_wrapper_shader_set_code(wasgo_id, wasgo_buffer_shader, wasgo_size_shader, -69, wasgo_buffer_code, wasgo_size_code);
}
void VisualServer::shader_set_default_texture_param(RID p_shader, String p_name, RID p_texture){
	...
	_wasgo_VisualServer_wrapper_shader_set_default_texture_param(wasgo_id, wasgo_buffer_shader, wasgo_size_shader, -69, wasgo_buffer_name, wasgo_size_name, wasgo_buffer_texture, wasgo_size_texture);
}
void VisualServer::skeleton_allocate(RID p_skeleton, int p_bones, bool p_is_2d_skeleton){
	...
	_wasgo_VisualServer_wrapper_skeleton_allocate(wasgo_id, wasgo_buffer_skeleton, wasgo_size_skeleton, -69, p_bones, p_is_2d_skeleton);
}
Transform VisualServer::skeleton_bone_get_transform(RID p_skeleton, int p_bone){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_VisualServer_wrapper_skeleton_bone_get_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_skeleton, wasgo_size_skeleton, p_bone);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform2D VisualServer::skeleton_bone_get_transform_2d(RID p_skeleton, int p_bone){
    ...
    int wasgo_ret_buffer_size = 28;
    uint8_t wasgo_ret_buffer[28];
    _wasgo_VisualServer_wrapper_skeleton_bone_get_transform_2d(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_skeleton, wasgo_size_skeleton, p_bone);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::skeleton_bone_set_transform(RID p_skeleton, int p_bone, Transform p_transform){
	...
	_wasgo_VisualServer_wrapper_skeleton_bone_set_transform(wasgo_id, wasgo_buffer_skeleton, wasgo_size_skeleton, -69, p_bone, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::skeleton_bone_set_transform_2d(RID p_skeleton, int p_bone, Transform2D p_transform){
	...
	_wasgo_VisualServer_wrapper_skeleton_bone_set_transform_2d(wasgo_id, wasgo_buffer_skeleton, wasgo_size_skeleton, -69, p_bone, wasgo_buffer_transform, wasgo_size_transform);
}
...
void VisualServer::sky_set_texture(RID p_sky, RID p_cube_map, int p_radiance_size){
    ...
    uint8_t wasgo_buffer_cube_map[256];
    int wasgo_size_cube_map = 256;
    encode_variant(wasgo_var_cube_map, wasgo_buffer_cube_map, wasgo_size_cube_map);
    
	_wasgo_VisualServer_wrapper_sky_set_texture(wasgo_id, wasgo_buffer_sky, wasgo_size_sky, -69, wasgo_buffer_cube_map, wasgo_size_cube_map, p_radiance_size);
}
...
void VisualServer::texture_allocate(RID p_texture, int p_width, int p_height, int p_depth_3d, Image::Format p_format, VisualServer::TextureType p_type, int p_flags){
	...
	_wasgo_VisualServer_wrapper_texture_allocate(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, p_width, p_height, p_depth_3d, p_format._get_wasgo_id(), p_type._get_wasgo_id(), p_flags);
}
void VisualServer::texture_bind(RID p_texture, int p_number){
	...
	_wasgo_VisualServer_wrapper_texture_bind(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, p_number);
}
...
RID VisualServer::texture_create_from_image(Image p_image, int p_flags){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_texture_create_from_image(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_image._get_wasgo_id(), p_flags);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Image VisualServer::texture_get_data(RID p_texture, int p_cube_side){
	...
	return Image(_wasgo_VisualServer_wrapper_texture_get_data(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, p_cube_side));
}
...
String VisualServer::texture_get_path(RID p_texture){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_texture_get_path(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_texture, wasgo_size_texture);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::texture_set_data(RID p_texture, Image p_image, int p_layer){
	...
	_wasgo_VisualServer_wrapper_texture_set_data(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, p_image._get_wasgo_id(), p_layer);
}
void VisualServer::texture_set_data_partial(RID p_texture, Image p_image, int p_src_x, int p_src_y, int p_src_w, int p_src_h, int p_dst_x, int p_dst_y, int p_dst_mip, int p_layer){
	...
	_wasgo_VisualServer_wrapper_texture_set_data_partial(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, p_image._get_wasgo_id(), p_src_x, p_src_y, p_src_w, p_src_h, p_dst_x, p_dst_y, p_dst_mip, p_layer);
}
void VisualServer::texture_set_flags(RID p_texture, int p_flags){
	...
	_wasgo_VisualServer_wrapper_texture_set_flags(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, p_flags);
}
void VisualServer::texture_set_path(RID p_texture, String p_path){
	...
	_wasgo_VisualServer_wrapper_texture_set_path(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, wasgo_buffer_path, wasgo_size_path);
}
...
void VisualServer::texture_set_size_override(RID p_texture, int p_width, int p_height, int p_depth){
	...
	_wasgo_VisualServer_wrapper_texture_set_size_override(wasgo_id, wasgo_buffer_texture, wasgo_size_texture, -69, p_width, p_height, p_depth);
}
...
void VisualServer::viewport_attach_camera(RID p_viewport, RID p_camera){
    ...
    uint8_t wasgo_buffer_viewport[256];
    int wasgo_size_viewport = 256;
	...
	_wasgo_VisualServer_wrapper_viewport_attach_camera(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_camera, wasgo_size_camera);
}
void VisualServer::viewport_attach_canvas(RID p_viewport, RID p_canvas){
	...
	_wasgo_VisualServer_wrapper_viewport_attach_canvas(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_canvas, wasgo_size_canvas);
}
void VisualServer::viewport_attach_to_screen(RID p_viewport, Rect2 p_rect, int p_screen){
	...
	_wasgo_VisualServer_wrapper_viewport_attach_to_screen(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_rect, wasgo_size_rect, p_screen);
}
...
int VisualServer::viewport_get_render_info(RID p_viewport, VisualServer::ViewportRenderInfo p_info){
	...
	return (int) _wasgo_VisualServer_wrapper_viewport_get_render_info(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_info._get_wasgo_id());
}
RID VisualServer::viewport_get_texture(RID p_viewport){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_VisualServer_wrapper_viewport_get_texture(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_viewport, wasgo_size_viewport);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void VisualServer::viewport_remove_canvas(RID p_viewport, RID p_canvas){
	...
	_wasgo_VisualServer_wrapper_viewport_remove_canvas(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_canvas, wasgo_size_canvas);
}
void VisualServer::viewport_set_active(RID p_viewport, bool p_active){
	...
	_wasgo_VisualServer_wrapper_viewport_set_active(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_active);
}
void VisualServer::viewport_set_canvas_stacking(RID p_viewport, RID p_canvas, int p_layer, int p_sublayer){
	...
	_wasgo_VisualServer_wrapper_viewport_set_canvas_stacking(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_canvas, wasgo_size_canvas, p_layer, p_sublayer);
}
void VisualServer::viewport_set_canvas_transform(RID p_viewport, RID p_canvas, Transform2D p_offset){
	...
	_wasgo_VisualServer_wrapper_viewport_set_canvas_transform(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_canvas, wasgo_size_canvas, wasgo_buffer_offset, wasgo_size_offset);
}
void VisualServer::viewport_set_clear_mode(RID p_viewport, VisualServer::ViewportClearMode p_clear_mode){
	...
	_wasgo_VisualServer_wrapper_viewport_set_clear_mode(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_clear_mode._get_wasgo_id());
}
void VisualServer::viewport_set_debug_draw(RID p_viewport, VisualServer::ViewportDebugDraw p_draw){
	...
	_wasgo_VisualServer_wrapper_viewport_set_debug_draw(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_draw._get_wasgo_id());
}
void VisualServer::viewport_set_disable_3d(RID p_viewport, bool p_disabled){
	...
	_wasgo_VisualServer_wrapper_viewport_set_disable_3d(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_disabled);
}
void VisualServer::viewport_set_disable_environment(RID p_viewport, bool p_disabled){
	...
	_wasgo_VisualServer_wrapper_viewport_set_disable_environment(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_disabled);
}
void VisualServer::viewport_set_global_canvas_transform(RID p_viewport, Transform2D p_transform){
	...
	_wasgo_VisualServer_wrapper_viewport_set_global_canvas_transform(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void VisualServer::viewport_set_hdr(RID p_viewport, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_viewport_set_hdr(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_enabled);
}
void VisualServer::viewport_set_hide_canvas(RID p_viewport, bool p_hidden){
	...
	_wasgo_VisualServer_wrapper_viewport_set_hide_canvas(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_hidden);
}
void VisualServer::viewport_set_hide_scenario(RID p_viewport, bool p_hidden){
	...
	_wasgo_VisualServer_wrapper_viewport_set_hide_scenario(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_hidden);
}
void VisualServer::viewport_set_msaa(RID p_viewport, VisualServer::ViewportMSAA p_msaa){
	...
	_wasgo_VisualServer_wrapper_viewport_set_msaa(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_msaa._get_wasgo_id());
}
void VisualServer::viewport_set_parent_viewport(RID p_viewport, RID p_parent_viewport){
    ...
    uint8_t wasgo_buffer_parent_viewport[256];
    int wasgo_size_parent_viewport = 256;
    encode_variant(wasgo_var_parent_viewport, wasgo_buffer_parent_viewport, wasgo_size_parent_viewport);
    
	_wasgo_VisualServer_wrapper_viewport_set_parent_viewport(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_parent_viewport, wasgo_size_parent_viewport);
}
void VisualServer::viewport_set_render_direct_to_screen(RID p_viewport, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_viewport_set_render_direct_to_screen(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_enabled);
}
void VisualServer::viewport_set_scenario(RID p_viewport, RID p_scenario){
	...
	_wasgo_VisualServer_wrapper_viewport_set_scenario(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, wasgo_buffer_scenario, wasgo_size_scenario);
}
void VisualServer::viewport_set_shadow_atlas_quadrant_subdivision(RID p_viewport, int p_quadrant, int p_subdivision){
	...
	_wasgo_VisualServer_wrapper_viewport_set_shadow_atlas_quadrant_subdivision(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_quadrant, p_subdivision);
}
void VisualServer::viewport_set_shadow_atlas_size(RID p_viewport, int p_size){
	...
	_wasgo_VisualServer_wrapper_viewport_set_shadow_atlas_size(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_size);
}
void VisualServer::viewport_set_size(RID p_viewport, int p_width, int p_height){
	...
	_wasgo_VisualServer_wrapper_viewport_set_size(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_width, p_height);
}
void VisualServer::viewport_set_transparent_background(RID p_viewport, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_viewport_set_transparent_background(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_enabled);
}
void VisualServer::viewport_set_update_mode(RID p_viewport, VisualServer::ViewportUpdateMode p_update_mode){
	...
	_wasgo_VisualServer_wrapper_viewport_set_update_mode(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_update_mode._get_wasgo_id());
}
void VisualServer::viewport_set_usage(RID p_viewport, VisualServer::ViewportUsage p_usage){
	...
	_wasgo_VisualServer_wrapper_viewport_set_usage(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_usage._get_wasgo_id());
}
void VisualServer::viewport_set_use_arvr(RID p_viewport, bool p_use_arvr){
	...
	_wasgo_VisualServer_wrapper_viewport_set_use_arvr(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_use_arvr);
}
void VisualServer::viewport_set_vflip(RID p_viewport, bool p_enabled){
	...
	_wasgo_VisualServer_wrapper_viewport_set_vflip(wasgo_id, wasgo_buffer_viewport, wasgo_size_viewport, -69, p_enabled);
}
