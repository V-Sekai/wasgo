...
void Curve2D::add_point(Vector2 p_position, Vector2 p_in, Vector2 p_out, int p_at_position){
	...
	_wasgo_Curve2D_wrapper_add_point(wasgo_id, wasgo_buffer_position, wasgo_size_position, -69, wasgo_buffer_in, wasgo_size_in, wasgo_buffer_out, wasgo_size_out, p_at_position);
}
...
Vector2 Curve2D::get_closest_point(Vector2 p_to_point){
    ...
    _wasgo_Curve2D_wrapper_get_closest_point(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_to_point, wasgo_size_to_point);
...
Vector2 Curve2D::get_point_in(int p_idx){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Curve2D_wrapper_get_point_in(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Vector2 Curve2D::get_point_out(int p_idx){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Curve2D_wrapper_get_point_out(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Vector2 Curve2D::get_point_position(int p_idx){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Curve2D_wrapper_get_point_position(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Vector2 Curve2D::interpolate(int p_idx, float p_t){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Curve2D_wrapper_interpolate(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_idx, p_t);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Vector2 Curve2D::interpolate_baked(float p_offset, bool p_cubic){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Curve2D_wrapper_interpolate_baked(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_offset, p_cubic);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Vector2 Curve2D::interpolatef(float p_fofs){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Curve2D_wrapper_interpolatef(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_fofs);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void Curve2D::set_point_in(int p_idx, Vector2 p_position){
	...
	_wasgo_Curve2D_wrapper_set_point_in(wasgo_id, p_idx, wasgo_buffer_position, wasgo_size_position, wasgo_size_position);
}
void Curve2D::set_point_out(int p_idx, Vector2 p_position){
	...
	_wasgo_Curve2D_wrapper_set_point_out(wasgo_id, p_idx, wasgo_buffer_position, wasgo_size_position, wasgo_size_position);
}
void Curve2D::set_point_position(int p_idx, Vector2 p_position){
	...
	_wasgo_Curve2D_wrapper_set_point_position(wasgo_id, p_idx, wasgo_buffer_position, wasgo_size_position, wasgo_size_position);
}
