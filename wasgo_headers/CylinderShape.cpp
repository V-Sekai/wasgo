...
void CylinderShape::set_height(float p_height){
	_wasgo_CylinderShape_wrapper_set_height(wasgo_id, height);
}
void CylinderShape::set_radius(float p_radius){
	_wasgo_CylinderShape_wrapper_set_radius(wasgo_id, radius);
}

CylinderShape::CylinderShape(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
