...
void InterpolatedCamera::set_target(Object p_target){
	_wasgo_InterpolatedCamera_wrapper_set_target(wasgo_id, ((Variant) p_target).get_wasgo_id());
}
void InterpolatedCamera::set_target_path(NodePath p_target_path){
	_wasgo_InterpolatedCamera_wrapper_set_target_path(wasgo_id, ((Variant) p_target_path).get_wasgo_id());
}