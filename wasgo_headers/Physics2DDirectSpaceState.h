...
protected:
public:
explicit Physics2DDirectSpaceState(WasGoID p_wasgo_id);
explicit Physics2DDirectSpaceState(Object other);
Physics2DDirectSpaceState();
Physics2DDirectSpaceState new_instance();
...
WasGoID _wasgo_Physics2DDirectSpaceState_wrapper_intersect_point(WasGoID wasgo_id, const uint8_t * p_point, int p_point_wasgo_buffer_size, int wasgo_throwaway, int p_max_results, WasGoID p_exclude, int p_collision_layer, bool p_collide_with_bodies, bool p_collide_with_areas);
WasGoID _wasgo_Physics2DDirectSpaceState_wrapper_intersect_point_on_canvas(WasGoID wasgo_id, const uint8_t * p_point, int p_point_wasgo_buffer_size, int wasgo_throwaway, int p_canvas_instance_id, int p_max_results, WasGoID p_exclude, int p_collision_layer, bool p_collide_with_bodies, bool p_collide_with_areas);
WasGoID _wasgo_Physics2DDirectSpaceState_wrapper_intersect_ray(WasGoID wasgo_id, const uint8_t * p_from, int p_from_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_to, int p_to_wasgo_buffer_size, WasGoID p_exclude, int p_collision_layer, bool p_collide_with_bodies, bool p_collide_with_areas);
