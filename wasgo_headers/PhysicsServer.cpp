...
void PhysicsServer::area_add_shape(RID p_area, RID p_shape, Transform p_transform, bool p_disabled){
    ...
    uint8_t wasgo_buffer_area[256];
    int wasgo_size_area = 256;
	...
	_wasgo_PhysicsServer_wrapper_area_add_shape(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, wasgo_buffer_shape, wasgo_size_shape, wasgo_buffer_transform, wasgo_size_transform, p_disabled);
}
void PhysicsServer::area_attach_object_instance_id(RID p_area, int p_id){
	...
	_wasgo_PhysicsServer_wrapper_area_attach_object_instance_id(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_id);
}
...
Variant PhysicsServer::area_get_param(RID p_area, PhysicsServer::AreaParameter p_param){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_area_get_param(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_area, wasgo_size_area, p_param._get_wasgo_id());
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID PhysicsServer::area_get_shape(RID p_area, int p_shape_idx){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_area_get_shape(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_area, wasgo_size_area, p_shape_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform PhysicsServer::area_get_shape_transform(RID p_area, int p_shape_idx){
    ...
    _wasgo_PhysicsServer_wrapper_area_get_shape_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_area, wasgo_size_area, p_shape_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID PhysicsServer::area_get_space(RID p_area){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_area_get_space(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_area, wasgo_size_area);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform PhysicsServer::area_get_transform(RID p_area){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_PhysicsServer_wrapper_area_get_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_area, wasgo_size_area);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void PhysicsServer::area_remove_shape(RID p_area, int p_shape_idx){
	...
	_wasgo_PhysicsServer_wrapper_area_remove_shape(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_shape_idx);
}
void PhysicsServer::area_set_area_monitor_callback(RID p_area, Object p_receiver, String p_method){
	...
	_wasgo_PhysicsServer_wrapper_area_set_area_monitor_callback(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_receiver._get_wasgo_id(), wasgo_buffer_method, wasgo_size_method);
}
void PhysicsServer::area_set_collision_layer(RID p_area, int p_layer){
	...
	_wasgo_PhysicsServer_wrapper_area_set_collision_layer(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_layer);
}
void PhysicsServer::area_set_collision_mask(RID p_area, int p_mask){
	...
	_wasgo_PhysicsServer_wrapper_area_set_collision_mask(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_mask);
}
void PhysicsServer::area_set_monitor_callback(RID p_area, Object p_receiver, String p_method){
	...
	_wasgo_PhysicsServer_wrapper_area_set_monitor_callback(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_receiver._get_wasgo_id(), wasgo_buffer_method, wasgo_size_method);
}
void PhysicsServer::area_set_monitorable(RID p_area, bool p_monitorable){
	...
	_wasgo_PhysicsServer_wrapper_area_set_monitorable(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_monitorable);
}
void PhysicsServer::area_set_param(RID p_area, PhysicsServer::AreaParameter p_param, Variant p_value){
	...
	_wasgo_PhysicsServer_wrapper_area_set_param(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_param._get_wasgo_id(), wasgo_buffer_value, wasgo_size_value);
}
void PhysicsServer::area_set_ray_pickable(RID p_area, bool p_enable){
	...
	_wasgo_PhysicsServer_wrapper_area_set_ray_pickable(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_enable);
}
void PhysicsServer::area_set_shape(RID p_area, int p_shape_idx, RID p_shape){
	...
	_wasgo_PhysicsServer_wrapper_area_set_shape(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_shape_idx, wasgo_buffer_shape, wasgo_size_shape);
}
void PhysicsServer::area_set_shape_disabled(RID p_area, int p_shape_idx, bool p_disabled){
	...
	_wasgo_PhysicsServer_wrapper_area_set_shape_disabled(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_shape_idx, p_disabled);
}
void PhysicsServer::area_set_shape_transform(RID p_area, int p_shape_idx, Transform p_transform){
	...
	_wasgo_PhysicsServer_wrapper_area_set_shape_transform(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_shape_idx, wasgo_buffer_transform, wasgo_size_transform);
}
void PhysicsServer::area_set_space(RID p_area, RID p_space){
    ...
    uint8_t wasgo_buffer_space[256];
    int wasgo_size_space = 256;
    encode_variant(wasgo_var_space, wasgo_buffer_space, wasgo_size_space);
    
	_wasgo_PhysicsServer_wrapper_area_set_space(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, wasgo_buffer_space, wasgo_size_space);
}
void PhysicsServer::area_set_space_override_mode(RID p_area, PhysicsServer::AreaSpaceOverrideMode p_mode){
	...
	_wasgo_PhysicsServer_wrapper_area_set_space_override_mode(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, p_mode._get_wasgo_id());
}
void PhysicsServer::area_set_transform(RID p_area, Transform p_transform){
	...
	_wasgo_PhysicsServer_wrapper_area_set_transform(wasgo_id, wasgo_buffer_area, wasgo_size_area, -69, wasgo_buffer_transform, wasgo_size_transform);
}
void PhysicsServer::body_add_central_force(RID p_body, Vector3 p_force){
	...
	_wasgo_PhysicsServer_wrapper_body_add_central_force(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_force, wasgo_size_force);
}
void PhysicsServer::body_add_collision_exception(RID p_body, RID p_excepted_body){
    ...
    uint8_t wasgo_buffer_excepted_body[256];
    int wasgo_size_excepted_body = 256;
    encode_variant(wasgo_var_excepted_body, wasgo_buffer_excepted_body, wasgo_size_excepted_body);
    
	_wasgo_PhysicsServer_wrapper_body_add_collision_exception(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_excepted_body, wasgo_size_excepted_body);
}
void PhysicsServer::body_add_force(RID p_body, Vector3 p_force, Vector3 p_position){
	...
	_wasgo_PhysicsServer_wrapper_body_add_force(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_force, wasgo_size_force, wasgo_buffer_position, wasgo_size_position);
}
void PhysicsServer::body_add_shape(RID p_body, RID p_shape, Transform p_transform, bool p_disabled){
	...
	_wasgo_PhysicsServer_wrapper_body_add_shape(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_shape, wasgo_size_shape, wasgo_buffer_transform, wasgo_size_transform, p_disabled);
}
void PhysicsServer::body_add_torque(RID p_body, Vector3 p_torque){
	...
	_wasgo_PhysicsServer_wrapper_body_add_torque(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_torque, wasgo_size_torque);
}
void PhysicsServer::body_apply_central_impulse(RID p_body, Vector3 p_impulse){
	...
	_wasgo_PhysicsServer_wrapper_body_apply_central_impulse(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_impulse, wasgo_size_impulse);
}
void PhysicsServer::body_apply_impulse(RID p_body, Vector3 p_position, Vector3 p_impulse){
	...
	_wasgo_PhysicsServer_wrapper_body_apply_impulse(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_position, wasgo_size_position, wasgo_buffer_impulse, wasgo_size_impulse);
}
void PhysicsServer::body_apply_torque_impulse(RID p_body, Vector3 p_impulse){
	...
	_wasgo_PhysicsServer_wrapper_body_apply_torque_impulse(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_impulse, wasgo_size_impulse);
}
void PhysicsServer::body_attach_object_instance_id(RID p_body, int p_id){
	...
	_wasgo_PhysicsServer_wrapper_body_attach_object_instance_id(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_id);
}
...
RID PhysicsServer::body_create(PhysicsServer::BodyMode p_mode, bool p_init_sleeping){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_body_create(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_mode._get_wasgo_id(), p_init_sleeping);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
float PhysicsServer::body_get_param(RID p_body, PhysicsServer::BodyParameter p_param){
	...
	return (float) _wasgo_PhysicsServer_wrapper_body_get_param(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_param._get_wasgo_id());
}
RID PhysicsServer::body_get_shape(RID p_body, int p_shape_idx){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_body_get_shape(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body, wasgo_size_body, p_shape_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Transform PhysicsServer::body_get_shape_transform(RID p_body, int p_shape_idx){
    ...
    int wasgo_ret_buffer_size = 52;
    uint8_t wasgo_ret_buffer[52];
    _wasgo_PhysicsServer_wrapper_body_get_shape_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body, wasgo_size_body, p_shape_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID PhysicsServer::body_get_space(RID p_body){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_body_get_space(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body, wasgo_size_body);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant PhysicsServer::body_get_state(RID p_body, PhysicsServer::BodyState p_state){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_body_get_state(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body, wasgo_size_body, p_state._get_wasgo_id());
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
bool PhysicsServer::body_is_axis_locked(RID p_body, PhysicsServer::BodyAxis p_axis){
	...
	return (bool) _wasgo_PhysicsServer_wrapper_body_is_axis_locked(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_axis._get_wasgo_id());
}
...
void PhysicsServer::body_remove_collision_exception(RID p_body, RID p_excepted_body){
	...
	_wasgo_PhysicsServer_wrapper_body_remove_collision_exception(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_excepted_body, wasgo_size_excepted_body);
}
void PhysicsServer::body_remove_shape(RID p_body, int p_shape_idx){
	...
	_wasgo_PhysicsServer_wrapper_body_remove_shape(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_shape_idx);
}
void PhysicsServer::body_set_axis_lock(RID p_body, PhysicsServer::BodyAxis p_axis, bool p_lock){
	...
	_wasgo_PhysicsServer_wrapper_body_set_axis_lock(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_axis._get_wasgo_id(), p_lock);
}
void PhysicsServer::body_set_axis_velocity(RID p_body, Vector3 p_axis_velocity){
	...
	_wasgo_PhysicsServer_wrapper_body_set_axis_velocity(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_axis_velocity, wasgo_size_axis_velocity);
}
void PhysicsServer::body_set_collision_layer(RID p_body, int p_layer){
	...
	_wasgo_PhysicsServer_wrapper_body_set_collision_layer(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_layer);
}
void PhysicsServer::body_set_collision_mask(RID p_body, int p_mask){
	...
	_wasgo_PhysicsServer_wrapper_body_set_collision_mask(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_mask);
}
void PhysicsServer::body_set_enable_continuous_collision_detection(RID p_body, bool p_enable){
	...
	_wasgo_PhysicsServer_wrapper_body_set_enable_continuous_collision_detection(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_enable);
}
void PhysicsServer::body_set_force_integration_callback(RID p_body, Object p_receiver, String p_method, Variant p_userdata){
	...
	_wasgo_PhysicsServer_wrapper_body_set_force_integration_callback(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_receiver._get_wasgo_id(), wasgo_buffer_method, wasgo_size_method, wasgo_buffer_userdata, wasgo_size_userdata);
}
void PhysicsServer::body_set_kinematic_safe_margin(RID p_body, float p_margin){
	...
	_wasgo_PhysicsServer_wrapper_body_set_kinematic_safe_margin(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_margin);
}
void PhysicsServer::body_set_max_contacts_reported(RID p_body, int p_amount){
	...
	_wasgo_PhysicsServer_wrapper_body_set_max_contacts_reported(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_amount);
}
void PhysicsServer::body_set_mode(RID p_body, PhysicsServer::BodyMode p_mode){
	...
	_wasgo_PhysicsServer_wrapper_body_set_mode(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_mode._get_wasgo_id());
}
void PhysicsServer::body_set_omit_force_integration(RID p_body, bool p_enable){
	...
	_wasgo_PhysicsServer_wrapper_body_set_omit_force_integration(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_enable);
}
void PhysicsServer::body_set_param(RID p_body, PhysicsServer::BodyParameter p_param, float p_value){
	...
	_wasgo_PhysicsServer_wrapper_body_set_param(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_param._get_wasgo_id(), p_value);
}
void PhysicsServer::body_set_ray_pickable(RID p_body, bool p_enable){
	...
	_wasgo_PhysicsServer_wrapper_body_set_ray_pickable(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_enable);
}
void PhysicsServer::body_set_shape(RID p_body, int p_shape_idx, RID p_shape){
	...
	_wasgo_PhysicsServer_wrapper_body_set_shape(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_shape_idx, wasgo_buffer_shape, wasgo_size_shape);
}
void PhysicsServer::body_set_shape_disabled(RID p_body, int p_shape_idx, bool p_disabled){
	...
	_wasgo_PhysicsServer_wrapper_body_set_shape_disabled(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_shape_idx, p_disabled);
}
void PhysicsServer::body_set_shape_transform(RID p_body, int p_shape_idx, Transform p_transform){
	...
	_wasgo_PhysicsServer_wrapper_body_set_shape_transform(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_shape_idx, wasgo_buffer_transform, wasgo_size_transform);
}
void PhysicsServer::body_set_space(RID p_body, RID p_space){
	...
	_wasgo_PhysicsServer_wrapper_body_set_space(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, wasgo_buffer_space, wasgo_size_space);
}
void PhysicsServer::body_set_state(RID p_body, PhysicsServer::BodyState p_state, Variant p_value){
	...
	_wasgo_PhysicsServer_wrapper_body_set_state(wasgo_id, wasgo_buffer_body, wasgo_size_body, -69, p_state._get_wasgo_id(), wasgo_buffer_value, wasgo_size_value);
}
float PhysicsServer::cone_twist_joint_get_param(RID p_joint, PhysicsServer::ConeTwistJointParam p_param){
    ...
    uint8_t wasgo_buffer_joint[256];
    int wasgo_size_joint = 256;
    encode_variant(wasgo_var_joint, wasgo_buffer_joint, wasgo_size_joint);
    
	return (float) _wasgo_PhysicsServer_wrapper_cone_twist_joint_get_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id());
}
void PhysicsServer::cone_twist_joint_set_param(RID p_joint, PhysicsServer::ConeTwistJointParam p_param, float p_value){
	...
	_wasgo_PhysicsServer_wrapper_cone_twist_joint_set_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id(), p_value);
}
...
bool PhysicsServer::generic_6dof_joint_get_flag(RID p_joint, Vector3::Axis p_axis, PhysicsServer::G6DOFJointAxisFlag p_flag){
	...
	return (bool) _wasgo_PhysicsServer_wrapper_generic_6dof_joint_get_flag(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_axis._get_wasgo_id(), p_flag._get_wasgo_id());
}
float PhysicsServer::generic_6dof_joint_get_param(RID p_joint, Vector3::Axis p_axis, PhysicsServer::G6DOFJointAxisParam p_param){
	...
	return (float) _wasgo_PhysicsServer_wrapper_generic_6dof_joint_get_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_axis._get_wasgo_id(), p_param._get_wasgo_id());
}
void PhysicsServer::generic_6dof_joint_set_flag(RID p_joint, Vector3::Axis p_axis, PhysicsServer::G6DOFJointAxisFlag p_flag, bool p_enable){
	...
	_wasgo_PhysicsServer_wrapper_generic_6dof_joint_set_flag(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_axis._get_wasgo_id(), p_flag._get_wasgo_id(), p_enable);
}
void PhysicsServer::generic_6dof_joint_set_param(RID p_joint, Vector3::Axis p_axis, PhysicsServer::G6DOFJointAxisParam p_param, float p_value){
	...
	_wasgo_PhysicsServer_wrapper_generic_6dof_joint_set_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_axis._get_wasgo_id(), p_param._get_wasgo_id(), p_value);
}
...
bool PhysicsServer::hinge_joint_get_flag(RID p_joint, PhysicsServer::HingeJointFlag p_flag){
	...
	return (bool) _wasgo_PhysicsServer_wrapper_hinge_joint_get_flag(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_flag._get_wasgo_id());
}
float PhysicsServer::hinge_joint_get_param(RID p_joint, PhysicsServer::HingeJointParam p_param){
	...
	return (float) _wasgo_PhysicsServer_wrapper_hinge_joint_get_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id());
}
void PhysicsServer::hinge_joint_set_flag(RID p_joint, PhysicsServer::HingeJointFlag p_flag, bool p_enabled){
	...
	_wasgo_PhysicsServer_wrapper_hinge_joint_set_flag(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_flag._get_wasgo_id(), p_enabled);
}
void PhysicsServer::hinge_joint_set_param(RID p_joint, PhysicsServer::HingeJointParam p_param, float p_value){
	...
	_wasgo_PhysicsServer_wrapper_hinge_joint_set_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id(), p_value);
}
RID PhysicsServer::joint_create_cone_twist(RID p_body_A, Transform p_local_ref_A, RID p_body_B, Transform p_local_ref_B){
    ...
    uint8_t wasgo_buffer_body_A[256];
    int wasgo_size_body_A = 256;
    ...
    uint8_t wasgo_buffer_body_B[256];
    int wasgo_size_body_B = 256;
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_joint_create_cone_twist(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body_A, wasgo_size_body_A, wasgo_buffer_local_ref_A, wasgo_size_local_ref_A, wasgo_buffer_body_B, wasgo_size_body_B, wasgo_buffer_local_ref_B, wasgo_size_local_ref_B);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID PhysicsServer::joint_create_generic_6dof(RID p_body_A, Transform p_local_ref_A, RID p_body_B, Transform p_local_ref_B){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_joint_create_generic_6dof(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body_A, wasgo_size_body_A, wasgo_buffer_local_ref_A, wasgo_size_local_ref_A, wasgo_buffer_body_B, wasgo_size_body_B, wasgo_buffer_local_ref_B, wasgo_size_local_ref_B);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID PhysicsServer::joint_create_hinge(RID p_body_A, Transform p_hinge_A, RID p_body_B, Transform p_hinge_B){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_joint_create_hinge(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body_A, wasgo_size_body_A, wasgo_buffer_hinge_A, wasgo_size_hinge_A, wasgo_buffer_body_B, wasgo_size_body_B, wasgo_buffer_hinge_B, wasgo_size_hinge_B);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID PhysicsServer::joint_create_pin(RID p_body_A, Vector3 p_local_A, RID p_body_B, Vector3 p_local_B){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_joint_create_pin(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body_A, wasgo_size_body_A, wasgo_buffer_local_A, wasgo_size_local_A, wasgo_buffer_body_B, wasgo_size_body_B, wasgo_buffer_local_B, wasgo_size_local_B);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
RID PhysicsServer::joint_create_slider(RID p_body_A, Transform p_local_ref_A, RID p_body_B, Transform p_local_ref_B){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_joint_create_slider(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_body_A, wasgo_size_body_A, wasgo_buffer_local_ref_A, wasgo_size_local_ref_A, wasgo_buffer_body_B, wasgo_size_body_B, wasgo_buffer_local_ref_B, wasgo_size_local_ref_B);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void PhysicsServer::joint_set_solver_priority(RID p_joint, int p_priority){
	...
	_wasgo_PhysicsServer_wrapper_joint_set_solver_priority(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_priority);
}
Vector3 PhysicsServer::pin_joint_get_local_a(RID p_joint){
    ...
    _wasgo_PhysicsServer_wrapper_pin_joint_get_local_a(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_joint, wasgo_size_joint);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Vector3 PhysicsServer::pin_joint_get_local_b(RID p_joint){
    ...
    int wasgo_ret_buffer_size = 16;
    uint8_t wasgo_ret_buffer[16];
    _wasgo_PhysicsServer_wrapper_pin_joint_get_local_b(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_joint, wasgo_size_joint);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
float PhysicsServer::pin_joint_get_param(RID p_joint, PhysicsServer::PinJointParam p_param){
	...
	return (float) _wasgo_PhysicsServer_wrapper_pin_joint_get_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id());
}
void PhysicsServer::pin_joint_set_local_a(RID p_joint, Vector3 p_local_A){
	...
	_wasgo_PhysicsServer_wrapper_pin_joint_set_local_a(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, wasgo_buffer_local_A, wasgo_size_local_A);
}
void PhysicsServer::pin_joint_set_local_b(RID p_joint, Vector3 p_local_B){
	...
	_wasgo_PhysicsServer_wrapper_pin_joint_set_local_b(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, wasgo_buffer_local_B, wasgo_size_local_B);
}
void PhysicsServer::pin_joint_set_param(RID p_joint, PhysicsServer::PinJointParam p_param, float p_value){
	...
	_wasgo_PhysicsServer_wrapper_pin_joint_set_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id(), p_value);
}
...
RID PhysicsServer::shape_create(PhysicsServer::ShapeType p_type){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_shape_create(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_type._get_wasgo_id());
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant PhysicsServer::shape_get_data(RID p_shape){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_PhysicsServer_wrapper_shape_get_data(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_shape, wasgo_size_shape);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void PhysicsServer::shape_set_data(RID p_shape, Variant p_data){
	...
	_wasgo_PhysicsServer_wrapper_shape_set_data(wasgo_id, wasgo_buffer_shape, wasgo_size_shape, -69, wasgo_buffer_data, wasgo_size_data);
}
float PhysicsServer::slider_joint_get_param(RID p_joint, PhysicsServer::SliderJointParam p_param){
	...
	return (float) _wasgo_PhysicsServer_wrapper_slider_joint_get_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id());
}
void PhysicsServer::slider_joint_set_param(RID p_joint, PhysicsServer::SliderJointParam p_param, float p_value){
	...
	_wasgo_PhysicsServer_wrapper_slider_joint_set_param(wasgo_id, wasgo_buffer_joint, wasgo_size_joint, -69, p_param._get_wasgo_id(), p_value);
}
...
float PhysicsServer::space_get_param(RID p_space, PhysicsServer::SpaceParameter p_param){
	...
	return (float) _wasgo_PhysicsServer_wrapper_space_get_param(wasgo_id, wasgo_buffer_space, wasgo_size_space, -69, p_param._get_wasgo_id());
}
...
void PhysicsServer::space_set_active(RID p_space, bool p_active){
	...
	_wasgo_PhysicsServer_wrapper_space_set_active(wasgo_id, wasgo_buffer_space, wasgo_size_space, -69, p_active);
}
void PhysicsServer::space_set_param(RID p_space, PhysicsServer::SpaceParameter p_param, float p_value){
	...
	_wasgo_PhysicsServer_wrapper_space_set_param(wasgo_id, wasgo_buffer_space, wasgo_size_space, -69, p_param._get_wasgo_id(), p_value);
}
