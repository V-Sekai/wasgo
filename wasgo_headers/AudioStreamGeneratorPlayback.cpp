...
bool AudioStreamGeneratorPlayback::push_buffer(PoolVector2Array p_frames){
	return (bool) _wasgo_AudioStreamGeneratorPlayback_wrapper_push_buffer(wasgo_id, ((Variant) p_frames).get_wasgo_id());
}
bool AudioStreamGeneratorPlayback::push_frame(Vector2 p_frame){
	return (bool) _wasgo_AudioStreamGeneratorPlayback_wrapper_push_frame(wasgo_id, ((Variant) p_frame).get_wasgo_id());
}