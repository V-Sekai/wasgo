...
Variant Expression::execute(Array p_inputs, Object p_base_instance, bool p_show_error){
    ...
    _wasgo_Expression_wrapper_execute(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_inputs._get_wasgo_id(), p_base_instance._get_wasgo_id(), p_show_error);
...
Error Expression::parse(String p_expression, PoolStringArray p_input_names){
	...
	return Error(_wasgo_Expression_wrapper_parse(wasgo_id, wasgo_buffer_expression, wasgo_size_expression, -69, p_input_names._get_wasgo_id()));
}
