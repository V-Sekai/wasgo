...
void Node2D::apply_scale(Vector2 p_ratio){
	_wasgo_Node2D_wrapper_apply_scale(wasgo_id, ((Variant) ratio).get_wasgo_id());
}
float Node2D::get_angle_to(Vector2 p_point){
	return (float) _wasgo_Node2D_wrapper_get_angle_to(wasgo_id, ((Variant) point).get_wasgo_id()));
}
...
Transform2D Node2D::get_relative_transform_to_parent(Node p_parent){
	return Transform2D::from_wasgo_id(_wasgo_Node2D_wrapper_get_relative_transform_to_parent(wasgo_id, ((Variant) parent).get_wasgo_id()));
}
...
void Node2D::global_translate(Vector2 p_offset){
	_wasgo_Node2D_wrapper_global_translate(wasgo_id, ((Variant) offset).get_wasgo_id());
}
bool Node2D::is_z_relative(){
	return (bool) _wasgo_Node2D_wrapper_is_z_relative(wasgo_id));
}
void Node2D::look_at(Vector2 p_point){
	_wasgo_Node2D_wrapper_look_at(wasgo_id, ((Variant) point).get_wasgo_id());
}
void Node2D::move_local_x(float p_delta, bool p_scaled = (bool) False){
	_wasgo_Node2D_wrapper_move_local_x(wasgo_id, delta, scaled);
}
void Node2D::move_local_y(float p_delta, bool p_scaled = (bool) False){
	_wasgo_Node2D_wrapper_move_local_y(wasgo_id, delta, scaled);
}
void Node2D::rotate(float p_radians){
	_wasgo_Node2D_wrapper_rotate(wasgo_id, radians);
}
void Node2D::set_global_position(Vector2 p_position){
	_wasgo_Node2D_wrapper_set_global_position(wasgo_id, ((Variant) position).get_wasgo_id());
}
void Node2D::set_global_rotation(float p_radians){
	_wasgo_Node2D_wrapper_set_global_rotation(wasgo_id, radians);
}
void Node2D::set_global_rotation_degrees(float p_degrees){
	_wasgo_Node2D_wrapper_set_global_rotation_degrees(wasgo_id, degrees);
}
void Node2D::set_global_scale(Vector2 p_scale){
	_wasgo_Node2D_wrapper_set_global_scale(wasgo_id, ((Variant) scale).get_wasgo_id());
}
void Node2D::set_global_transform(Transform2D p_xform){
	_wasgo_Node2D_wrapper_set_global_transform(wasgo_id, ((Variant) xform).get_wasgo_id());
}
void Node2D::set_position(Vector2 p_position){
	_wasgo_Node2D_wrapper_set_position(wasgo_id, ((Variant) position).get_wasgo_id());
}
void Node2D::set_rotation(float p_radians){
	_wasgo_Node2D_wrapper_set_rotation(wasgo_id, radians);
}
void Node2D::set_rotation_degrees(float p_degrees){
	_wasgo_Node2D_wrapper_set_rotation_degrees(wasgo_id, degrees);
}
void Node2D::set_scale(Vector2 p_scale){
	_wasgo_Node2D_wrapper_set_scale(wasgo_id, ((Variant) scale).get_wasgo_id());
}
void Node2D::set_transform(Transform2D p_xform){
	_wasgo_Node2D_wrapper_set_transform(wasgo_id, ((Variant) xform).get_wasgo_id());
}
void Node2D::set_z_as_relative(bool p_enable){
	_wasgo_Node2D_wrapper_set_z_as_relative(wasgo_id, enable);
}
void Node2D::set_z_index(int p_z_index){
	_wasgo_Node2D_wrapper_set_z_index(wasgo_id, z_index);
}
Vector2 Node2D::to_global(Vector2 p_local_point){
	return Vector2::from_wasgo_id(_wasgo_Node2D_wrapper_to_global(wasgo_id, ((Variant) local_point).get_wasgo_id()));
}
Vector2 Node2D::to_local(Vector2 p_global_point){
	return Vector2::from_wasgo_id(_wasgo_Node2D_wrapper_to_local(wasgo_id, ((Variant) global_point).get_wasgo_id()));
}
void Node2D::translate(Vector2 p_offset){
	_wasgo_Node2D_wrapper_translate(wasgo_id, ((Variant) offset).get_wasgo_id());
}

Node2D::Node2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Node2D::~Node2D(){
}