...
void Physics2DShapeQueryParameters::set_collide_with_areas(bool p_enable){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_collide_with_areas(wasgo_id, enable);
}
void Physics2DShapeQueryParameters::set_collide_with_bodies(bool p_enable){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_collide_with_bodies(wasgo_id, enable);
}
void Physics2DShapeQueryParameters::set_collision_layer(int p_collision_layer){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_collision_layer(wasgo_id, collision_layer);
}
void Physics2DShapeQueryParameters::set_exclude(Array p_exclude){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_exclude(wasgo_id, ((Variant) exclude).get_wasgo_id());
}
void Physics2DShapeQueryParameters::set_margin(float p_margin){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_margin(wasgo_id, margin);
}
void Physics2DShapeQueryParameters::set_motion(Vector2 p_motion){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_motion(wasgo_id, ((Variant) motion).get_wasgo_id());
}
void Physics2DShapeQueryParameters::set_shape(Resource p_shape){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_shape(wasgo_id, ((Variant) shape).get_wasgo_id());
}
void Physics2DShapeQueryParameters::set_shape_rid(RID p_shape){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_shape_rid(wasgo_id, ((Variant) shape).get_wasgo_id());
}
void Physics2DShapeQueryParameters::set_transform(Transform2D p_transform){
	_wasgo_Physics2DShapeQueryParameters_wrapper_set_transform(wasgo_id, ((Variant) transform).get_wasgo_id());
}

Physics2DShapeQueryParameters::Physics2DShapeQueryParameters(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
