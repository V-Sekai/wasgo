...
void NetworkedMultiplayerPeer::set_refuse_new_connections(bool p_enable){
	_wasgo_NetworkedMultiplayerPeer_wrapper_set_refuse_new_connections(wasgo_id, enable);
}
void NetworkedMultiplayerPeer::set_target_peer(int p_id){
	_wasgo_NetworkedMultiplayerPeer_wrapper_set_target_peer(wasgo_id, id);
}
void NetworkedMultiplayerPeer::set_transfer_mode(NetworkedMultiplayerPeer::TransferMode p_mode){
	_wasgo_NetworkedMultiplayerPeer_wrapper_set_transfer_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}