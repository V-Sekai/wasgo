...
void VisualShaderNodeGroupBase::add_input_port(int p_id, int p_type, String p_name){
	_wasgo_VisualShaderNodeGroupBase_wrapper_add_input_port(wasgo_id, id, type, ((Variant) name).get_wasgo_id());
}
void VisualShaderNodeGroupBase::add_output_port(int p_id, int p_type, String p_name){
	_wasgo_VisualShaderNodeGroupBase_wrapper_add_output_port(wasgo_id, id, type, ((Variant) name).get_wasgo_id());
}
...
bool VisualShaderNodeGroupBase::has_input_port(int p_id){
	return (bool) _wasgo_VisualShaderNodeGroupBase_wrapper_has_input_port(wasgo_id, id));
}
bool VisualShaderNodeGroupBase::has_output_port(int p_id){
	return (bool) _wasgo_VisualShaderNodeGroupBase_wrapper_has_output_port(wasgo_id, id));
}
bool VisualShaderNodeGroupBase::is_valid_port_name(String p_name){
	return (bool) _wasgo_VisualShaderNodeGroupBase_wrapper_is_valid_port_name(wasgo_id, ((Variant) name).get_wasgo_id()));
}
void VisualShaderNodeGroupBase::remove_input_port(int p_id){
	_wasgo_VisualShaderNodeGroupBase_wrapper_remove_input_port(wasgo_id, id);
}
void VisualShaderNodeGroupBase::remove_output_port(int p_id){
	_wasgo_VisualShaderNodeGroupBase_wrapper_remove_output_port(wasgo_id, id);
}
void VisualShaderNodeGroupBase::set_input_port_name(int p_id, String p_name){
	_wasgo_VisualShaderNodeGroupBase_wrapper_set_input_port_name(wasgo_id, id, ((Variant) name).get_wasgo_id());
}
void VisualShaderNodeGroupBase::set_input_port_type(int p_id, int p_type){
	_wasgo_VisualShaderNodeGroupBase_wrapper_set_input_port_type(wasgo_id, id, type);
}
void VisualShaderNodeGroupBase::set_inputs(String p_inputs){
	_wasgo_VisualShaderNodeGroupBase_wrapper_set_inputs(wasgo_id, ((Variant) inputs).get_wasgo_id());
}
void VisualShaderNodeGroupBase::set_output_port_name(int p_id, String p_name){
	_wasgo_VisualShaderNodeGroupBase_wrapper_set_output_port_name(wasgo_id, id, ((Variant) name).get_wasgo_id());
}
void VisualShaderNodeGroupBase::set_output_port_type(int p_id, int p_type){
	_wasgo_VisualShaderNodeGroupBase_wrapper_set_output_port_type(wasgo_id, id, type);
}
void VisualShaderNodeGroupBase::set_outputs(String p_outputs){
	_wasgo_VisualShaderNodeGroupBase_wrapper_set_outputs(wasgo_id, ((Variant) outputs).get_wasgo_id());
}
void VisualShaderNodeGroupBase::set_size(Vector2 p_size){
	_wasgo_VisualShaderNodeGroupBase_wrapper_set_size(wasgo_id, ((Variant) size).get_wasgo_id());
}

VisualShaderNodeGroupBase::VisualShaderNodeGroupBase(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
