...
void RayCast::add_exception(Object p_node){
	_wasgo_RayCast_wrapper_add_exception(wasgo_id, ((Variant) node).get_wasgo_id());
}
void RayCast::add_exception_rid(RID p_rid){
	_wasgo_RayCast_wrapper_add_exception_rid(wasgo_id, ((Variant) rid).get_wasgo_id());
}
...
bool RayCast::get_collision_mask_bit(int p_bit){
	return (bool) _wasgo_RayCast_wrapper_get_collision_mask_bit(wasgo_id, bit));
}
...
void RayCast::remove_exception(Object p_node){
	_wasgo_RayCast_wrapper_remove_exception(wasgo_id, ((Variant) node).get_wasgo_id());
}
void RayCast::remove_exception_rid(RID p_rid){
	_wasgo_RayCast_wrapper_remove_exception_rid(wasgo_id, ((Variant) rid).get_wasgo_id());
}
void RayCast::set_cast_to(Vector3 p_local_point){
	_wasgo_RayCast_wrapper_set_cast_to(wasgo_id, ((Variant) local_point).get_wasgo_id());
}
void RayCast::set_collide_with_areas(bool p_enable){
	_wasgo_RayCast_wrapper_set_collide_with_areas(wasgo_id, enable);
}
void RayCast::set_collide_with_bodies(bool p_enable){
	_wasgo_RayCast_wrapper_set_collide_with_bodies(wasgo_id, enable);
}
void RayCast::set_collision_mask(int p_mask){
	_wasgo_RayCast_wrapper_set_collision_mask(wasgo_id, mask);
}
void RayCast::set_collision_mask_bit(int p_bit, bool p_value){
	_wasgo_RayCast_wrapper_set_collision_mask_bit(wasgo_id, bit, value);
}
void RayCast::set_enabled(bool p_enabled){
	_wasgo_RayCast_wrapper_set_enabled(wasgo_id, enabled);
}
void RayCast::set_exclude_parent_body(bool p_mask){
	_wasgo_RayCast_wrapper_set_exclude_parent_body(wasgo_id, mask);
}

RayCast::RayCast(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
RayCast::~RayCast(){
}