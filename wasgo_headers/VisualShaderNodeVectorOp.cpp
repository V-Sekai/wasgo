...
void VisualShaderNodeVectorOp::set_operator(VisualShaderNodeVectorOp::Operator p_op){
	_wasgo_VisualShaderNodeVectorOp_wrapper_set_operator(wasgo_id, ((Variant) op).get_wasgo_id());
}

VisualShaderNodeVectorOp::VisualShaderNodeVectorOp(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
