...
void ProximityGroup::broadcast(String p_name, Variant p_parameters){
	_wasgo_ProximityGroup_wrapper_broadcast(wasgo_id, ((Variant) p_name).get_wasgo_id(), ((Variant) p_parameters).get_wasgo_id());
}
...
void ProximityGroup::set_dispatch_mode(ProximityGroup::DispatchMode p_mode){
	_wasgo_ProximityGroup_wrapper_set_dispatch_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void ProximityGroup::set_grid_radius(Vector3 p_radius){
	_wasgo_ProximityGroup_wrapper_set_grid_radius(wasgo_id, ((Variant) p_radius).get_wasgo_id());
}
void ProximityGroup::set_group_name(String p_name){
	_wasgo_ProximityGroup_wrapper_set_group_name(wasgo_id, ((Variant) p_name).get_wasgo_id());
}