...
void CapsuleMesh::set_mid_height(float p_mid_height){
	_wasgo_CapsuleMesh_wrapper_set_mid_height(wasgo_id, mid_height);
}
void CapsuleMesh::set_radial_segments(int p_segments){
	_wasgo_CapsuleMesh_wrapper_set_radial_segments(wasgo_id, segments);
}
void CapsuleMesh::set_radius(float p_radius){
	_wasgo_CapsuleMesh_wrapper_set_radius(wasgo_id, radius);
}
void CapsuleMesh::set_rings(int p_rings){
	_wasgo_CapsuleMesh_wrapper_set_rings(wasgo_id, rings);
}

CapsuleMesh::CapsuleMesh(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
