...
void SkeletonIK::set_magnet_position(Vector3 p_local_position){
	_wasgo_SkeletonIK_wrapper_set_magnet_position(wasgo_id, ((Variant) p_local_position).get_wasgo_id());
}
...
void SkeletonIK::set_root_bone(String p_root_bone){
	_wasgo_SkeletonIK_wrapper_set_root_bone(wasgo_id, ((Variant) p_root_bone).get_wasgo_id());
}
void SkeletonIK::set_target_node(NodePath p_node){
	_wasgo_SkeletonIK_wrapper_set_target_node(wasgo_id, ((Variant) p_node).get_wasgo_id());
}
void SkeletonIK::set_target_transform(Transform p_target){
	_wasgo_SkeletonIK_wrapper_set_target_transform(wasgo_id, ((Variant) p_target).get_wasgo_id());
}
void SkeletonIK::set_tip_bone(String p_tip_bone){
	_wasgo_SkeletonIK_wrapper_set_tip_bone(wasgo_id, ((Variant) p_tip_bone).get_wasgo_id());
}
