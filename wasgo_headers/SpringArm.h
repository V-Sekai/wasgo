...
//Wrapper Functions
extern "C"{
void _wasgo_SpringArm_wrapper_add_excluded_object(WasGoId wasgo_id, WasGo::WasGoId p_RID);
...
WasGo::WasGoId _wasgo_SpringArm_wrapper_get_shape(WasGoId wasgo_id);
int _wasgo_SpringArm_wrapper_remove_excluded_object(WasGoId wasgo_id, WasGo::WasGoId p_RID);
...
void _wasgo_SpringArm_wrapper_set_shape(WasGoId wasgo_id, WasGo::WasGoId p_shape);
}
#endif