...
void AudioEffectDistortion::set_drive(float p_drive){
	_wasgo_AudioEffectDistortion_wrapper_set_drive(wasgo_id, drive);
}
void AudioEffectDistortion::set_keep_hf_hz(float p_keep_hf_hz){
	_wasgo_AudioEffectDistortion_wrapper_set_keep_hf_hz(wasgo_id, keep_hf_hz);
}
void AudioEffectDistortion::set_mode(AudioEffectDistortion::Mode p_mode){
	_wasgo_AudioEffectDistortion_wrapper_set_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void AudioEffectDistortion::set_post_gain(float p_post_gain){
	_wasgo_AudioEffectDistortion_wrapper_set_post_gain(wasgo_id, post_gain);
}
void AudioEffectDistortion::set_pre_gain(float p_pre_gain){
	_wasgo_AudioEffectDistortion_wrapper_set_pre_gain(wasgo_id, pre_gain);
}

AudioEffectDistortion::AudioEffectDistortion(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
