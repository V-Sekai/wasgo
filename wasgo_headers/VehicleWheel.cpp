...
void VehicleWheel::set_brake(float p_brake){
	_wasgo_VehicleWheel_wrapper_set_brake(wasgo_id, brake);
}
void VehicleWheel::set_damping_compression(float p_length){
	_wasgo_VehicleWheel_wrapper_set_damping_compression(wasgo_id, length);
}
void VehicleWheel::set_damping_relaxation(float p_length){
	_wasgo_VehicleWheel_wrapper_set_damping_relaxation(wasgo_id, length);
}
void VehicleWheel::set_engine_force(float p_engine_force){
	_wasgo_VehicleWheel_wrapper_set_engine_force(wasgo_id, engine_force);
}
void VehicleWheel::set_friction_slip(float p_length){
	_wasgo_VehicleWheel_wrapper_set_friction_slip(wasgo_id, length);
}
void VehicleWheel::set_radius(float p_length){
	_wasgo_VehicleWheel_wrapper_set_radius(wasgo_id, length);
}
void VehicleWheel::set_roll_influence(float p_roll_influence){
	_wasgo_VehicleWheel_wrapper_set_roll_influence(wasgo_id, roll_influence);
}
void VehicleWheel::set_steering(float p_steering){
	_wasgo_VehicleWheel_wrapper_set_steering(wasgo_id, steering);
}
void VehicleWheel::set_suspension_max_force(float p_length){
	_wasgo_VehicleWheel_wrapper_set_suspension_max_force(wasgo_id, length);
}
void VehicleWheel::set_suspension_rest_length(float p_length){
	_wasgo_VehicleWheel_wrapper_set_suspension_rest_length(wasgo_id, length);
}
void VehicleWheel::set_suspension_stiffness(float p_length){
	_wasgo_VehicleWheel_wrapper_set_suspension_stiffness(wasgo_id, length);
}
void VehicleWheel::set_suspension_travel(float p_length){
	_wasgo_VehicleWheel_wrapper_set_suspension_travel(wasgo_id, length);
}
void VehicleWheel::set_use_as_steering(bool p_enable){
	_wasgo_VehicleWheel_wrapper_set_use_as_steering(wasgo_id, enable);
}
void VehicleWheel::set_use_as_traction(bool p_enable){
	_wasgo_VehicleWheel_wrapper_set_use_as_traction(wasgo_id, enable);
}

VehicleWheel::VehicleWheel(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
