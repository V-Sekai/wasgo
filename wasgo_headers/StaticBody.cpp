...
void StaticBody::set_constant_angular_velocity(Vector3 p_vel){
	_wasgo_StaticBody_wrapper_set_constant_angular_velocity(wasgo_id, ((Variant) p_vel).get_wasgo_id());
}
void StaticBody::set_constant_linear_velocity(Vector3 p_vel){
	_wasgo_StaticBody_wrapper_set_constant_linear_velocity(wasgo_id, ((Variant) p_vel).get_wasgo_id());
}
...
void StaticBody::set_physics_material_override(PhysicsMaterial p_physics_material_override){
	_wasgo_StaticBody_wrapper_set_physics_material_override(wasgo_id, ((Variant) p_physics_material_override).get_wasgo_id());
}