...
void PacketPeerStream::set_input_buffer_max_size(int p_max_size_bytes){
	_wasgo_PacketPeerStream_wrapper_set_input_buffer_max_size(wasgo_id, max_size_bytes);
}
void PacketPeerStream::set_output_buffer_max_size(int p_max_size_bytes){
	_wasgo_PacketPeerStream_wrapper_set_output_buffer_max_size(wasgo_id, max_size_bytes);
}
void PacketPeerStream::set_stream_peer(StreamPeer p_peer){
	_wasgo_PacketPeerStream_wrapper_set_stream_peer(wasgo_id, ((Variant) peer).get_wasgo_id());
}

PacketPeerStream::PacketPeerStream(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
