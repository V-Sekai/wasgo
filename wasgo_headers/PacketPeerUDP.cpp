...
Error PacketPeerUDP::connect_to_host(String p_host, int p_port){
	return Error::from_wasgo_id(_wasgo_PacketPeerUDP_wrapper_connect_to_host(wasgo_id, ((Variant) p_host).get_wasgo_id(), p_port));
}
...
Error PacketPeerUDP::join_multicast_group(String p_multicast_address, String p_interface_name){
	return Error::from_wasgo_id(_wasgo_PacketPeerUDP_wrapper_join_multicast_group(wasgo_id, ((Variant) p_multicast_address).get_wasgo_id(), ((Variant) p_interface_name).get_wasgo_id()));
}
Error PacketPeerUDP::leave_multicast_group(String p_multicast_address, String p_interface_name){
	return Error::from_wasgo_id(_wasgo_PacketPeerUDP_wrapper_leave_multicast_group(wasgo_id, ((Variant) p_multicast_address).get_wasgo_id(), ((Variant) p_interface_name).get_wasgo_id()));
}
Error PacketPeerUDP::listen(int p_port, String p_bind_address = (String) *, int p_recv_buf_size = (int) 65536){
	return Error::from_wasgo_id(_wasgo_PacketPeerUDP_wrapper_listen(wasgo_id, p_port, ((Variant) p_bind_address).get_wasgo_id(), p_recv_buf_size));
}
...
Error PacketPeerUDP::set_dest_address(String p_host, int p_port){
	return Error::from_wasgo_id(_wasgo_PacketPeerUDP_wrapper_set_dest_address(wasgo_id, ((Variant) p_host).get_wasgo_id(), p_port));
}
