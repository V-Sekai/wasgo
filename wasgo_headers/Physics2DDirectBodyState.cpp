...
void Physics2DDirectBodyState::add_central_force(Vector2 p_force){
	_wasgo_Physics2DDirectBodyState_wrapper_add_central_force(wasgo_id, ((Variant) p_force).get_wasgo_id());
}
void Physics2DDirectBodyState::add_force(Vector2 p_offset, Vector2 p_force){
	_wasgo_Physics2DDirectBodyState_wrapper_add_force(wasgo_id, ((Variant) p_offset).get_wasgo_id(), ((Variant) p_force).get_wasgo_id());
}
...
void Physics2DDirectBodyState::apply_central_impulse(Vector2 p_impulse){
	_wasgo_Physics2DDirectBodyState_wrapper_apply_central_impulse(wasgo_id, ((Variant) p_impulse).get_wasgo_id());
}
void Physics2DDirectBodyState::apply_impulse(Vector2 p_offset, Vector2 p_impulse){
	_wasgo_Physics2DDirectBodyState_wrapper_apply_impulse(wasgo_id, ((Variant) p_offset).get_wasgo_id(), ((Variant) p_impulse).get_wasgo_id());
}
...
RID Physics2DDirectBodyState::get_contact_collider(int p_contact_idx){
	return RID::from_wasgo_id(_wasgo_Physics2DDirectBodyState_wrapper_get_contact_collider(wasgo_id, p_contact_idx));
}
...
Object Physics2DDirectBodyState::get_contact_collider_object(int p_contact_idx){
	return Object::from_wasgo_id(_wasgo_Physics2DDirectBodyState_wrapper_get_contact_collider_object(wasgo_id, p_contact_idx));
}
Vector2 Physics2DDirectBodyState::get_contact_collider_position(int p_contact_idx){
	return Vector2::from_wasgo_id(_wasgo_Physics2DDirectBodyState_wrapper_get_contact_collider_position(wasgo_id, p_contact_idx));
}
...
Variant Physics2DDirectBodyState::get_contact_collider_shape_metadata(int p_contact_idx){
	return Variant::from_wasgo_id(_wasgo_Physics2DDirectBodyState_wrapper_get_contact_collider_shape_metadata(wasgo_id, p_contact_idx));
}
Vector2 Physics2DDirectBodyState::get_contact_collider_velocity_at_position(int p_contact_idx){
	return Vector2::from_wasgo_id(_wasgo_Physics2DDirectBodyState_wrapper_get_contact_collider_velocity_at_position(wasgo_id, p_contact_idx));
}
...
Vector2 Physics2DDirectBodyState::get_contact_local_normal(int p_contact_idx){
	return Vector2::from_wasgo_id(_wasgo_Physics2DDirectBodyState_wrapper_get_contact_local_normal(wasgo_id, p_contact_idx));
}
Vector2 Physics2DDirectBodyState::get_contact_local_position(int p_contact_idx){
	return Vector2::from_wasgo_id(_wasgo_Physics2DDirectBodyState_wrapper_get_contact_local_position(wasgo_id, p_contact_idx));
}
...
void Physics2DDirectBodyState::set_linear_velocity(Vector2 p_velocity){
	_wasgo_Physics2DDirectBodyState_wrapper_set_linear_velocity(wasgo_id, ((Variant) p_velocity).get_wasgo_id());
}
...
void Physics2DDirectBodyState::set_transform(Transform2D p_transform){
	_wasgo_Physics2DDirectBodyState_wrapper_set_transform(wasgo_id, ((Variant) p_transform).get_wasgo_id());
}