...
int TileSet::autotile_get_bitmask(int p_id, Vector2 p_coord){
	...
	return (int) _wasgo_TileSet_wrapper_autotile_get_bitmask(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord);
}
...
Vector2 TileSet::autotile_get_icon_coordinate(int p_id){
    ...
    _wasgo_TileSet_wrapper_autotile_get_icon_coordinate(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
...
OccluderPolygon2D TileSet::autotile_get_light_occluder(int p_id, Vector2 p_coord){
	...
	return OccluderPolygon2D(_wasgo_TileSet_wrapper_autotile_get_light_occluder(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord));
}
NavigationPolygon TileSet::autotile_get_navigation_polygon(int p_id, Vector2 p_coord){
	...
	return NavigationPolygon(_wasgo_TileSet_wrapper_autotile_get_navigation_polygon(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord));
}
Vector2 TileSet::autotile_get_size(int p_id){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_TileSet_wrapper_autotile_get_size(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector2) wasgo_ret;
...
int TileSet::autotile_get_subtile_priority(int p_id, Vector2 p_coord){
	...
	return (int) _wasgo_TileSet_wrapper_autotile_get_subtile_priority(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord);
}
int TileSet::autotile_get_z_index(int p_id, Vector2 p_coord){
	...
	return (int) _wasgo_TileSet_wrapper_autotile_get_z_index(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord);
}
void TileSet::autotile_set_bitmask(int p_id, Vector2 p_bitmask, int p_flag){
	...
	_wasgo_TileSet_wrapper_autotile_set_bitmask(wasgo_id, p_id, wasgo_buffer_bitmask, wasgo_size_bitmask, p_flag);
}
...
void TileSet::autotile_set_icon_coordinate(int p_id, Vector2 p_coord){
	...
	_wasgo_TileSet_wrapper_autotile_set_icon_coordinate(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord);
}
void TileSet::autotile_set_light_occluder(int p_id, OccluderPolygon2D p_light_occluder, Vector2 p_coord){
	...
	_wasgo_TileSet_wrapper_autotile_set_light_occluder(wasgo_id, p_id, p_light_occluder._get_wasgo_id(), wasgo_buffer_coord, wasgo_size_coord);
}
void TileSet::autotile_set_navigation_polygon(int p_id, NavigationPolygon p_navigation_polygon, Vector2 p_coord){
	...
	_wasgo_TileSet_wrapper_autotile_set_navigation_polygon(wasgo_id, p_id, p_navigation_polygon._get_wasgo_id(), wasgo_buffer_coord, wasgo_size_coord);
}
void TileSet::autotile_set_size(int p_id, Vector2 p_size){
	...
	_wasgo_TileSet_wrapper_autotile_set_size(wasgo_id, p_id, wasgo_buffer_size, wasgo_size_size);
}
...
void TileSet::autotile_set_subtile_priority(int p_id, Vector2 p_coord, int p_priority){
	...
	_wasgo_TileSet_wrapper_autotile_set_subtile_priority(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord, p_priority);
}
void TileSet::autotile_set_z_index(int p_id, Vector2 p_coord, int p_z_index){
	...
	_wasgo_TileSet_wrapper_autotile_set_z_index(wasgo_id, p_id, wasgo_buffer_coord, wasgo_size_coord, p_z_index);
}
void TileSet::clear(){
...
void TileSet::tile_add_shape(int p_id, Shape2D p_shape, Transform2D p_shape_transform, bool p_one_way = (bool) false, Vector2 p_autotile_coord = Vector2((0, 0))){
	...
	_wasgo_TileSet_wrapper_tile_add_shape(wasgo_id, p_id, p_shape._get_wasgo_id(), wasgo_buffer_shape_transform, wasgo_size_shape_transform, p_one_way, wasgo_buffer_autotile_coord, wasgo_size_autotile_coord);
}
...
Color TileSet::tile_get_modulate(int p_id){
    ...
    _wasgo_TileSet_wrapper_tile_get_modulate(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
...
String TileSet::tile_get_name(int p_id){
    ...
    _wasgo_TileSet_wrapper_tile_get_name(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
...
Vector2 TileSet::tile_get_navigation_polygon_offset(int p_id){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_TileSet_wrapper_tile_get_navigation_polygon_offset(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector2) wasgo_ret;
...
Vector2 TileSet::tile_get_occluder_offset(int p_id){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_TileSet_wrapper_tile_get_occluder_offset(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector2) wasgo_ret;
...
Rect2 TileSet::tile_get_region(int p_id){
    ...
    int wasgo_ret_buffer_size = 20;
    uint8_t wasgo_ret_buffer[20];
    _wasgo_TileSet_wrapper_tile_get_region(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
...
Vector2 TileSet::tile_get_shape_offset(int p_id, int p_shape_id){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_TileSet_wrapper_tile_get_shape_offset(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id, p_shape_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector2) wasgo_ret;
...
Transform2D TileSet::tile_get_shape_transform(int p_id, int p_shape_id){
    ...
    _wasgo_TileSet_wrapper_tile_get_shape_transform(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id, p_shape_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
...
Vector2 TileSet::tile_get_texture_offset(int p_id){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_TileSet_wrapper_tile_get_texture_offset(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector2) wasgo_ret;
...
void TileSet::tile_set_modulate(int p_id, Color p_color){
	...
	_wasgo_TileSet_wrapper_tile_set_modulate(wasgo_id, p_id, wasgo_buffer_color, wasgo_size_color);
}
...
void TileSet::tile_set_navigation_polygon_offset(int p_id, Vector2 p_navigation_polygon_offset){
	...
	_wasgo_TileSet_wrapper_tile_set_navigation_polygon_offset(wasgo_id, p_id, wasgo_buffer_navigation_polygon_offset, wasgo_size_navigation_polygon_offset);
}
...
void TileSet::tile_set_occluder_offset(int p_id, Vector2 p_occluder_offset){
	...
	_wasgo_TileSet_wrapper_tile_set_occluder_offset(wasgo_id, p_id, wasgo_buffer_occluder_offset, wasgo_size_occluder_offset);
}
void TileSet::tile_set_region(int p_id, Rect2 p_region){
	...
	_wasgo_TileSet_wrapper_tile_set_region(wasgo_id, p_id, wasgo_buffer_region, wasgo_size_region);
}
void TileSet::tile_set_shape(int p_id, int p_shape_id, Shape2D p_shape){
	_wasgo_TileSet_wrapper_tile_set_shape(wasgo_id, p_id, p_shape_id, p_shape._get_wasgo_id());
}
void TileSet::tile_set_shape_offset(int p_id, int p_shape_id, Vector2 p_shape_offset){
	...
	_wasgo_TileSet_wrapper_tile_set_shape_offset(wasgo_id, p_id, p_shape_id, wasgo_buffer_shape_offset, wasgo_size_shape_offset);
}
void TileSet::tile_set_shape_one_way(int p_id, int p_shape_id, bool p_one_way){
	_wasgo_TileSet_wrapper_tile_set_shape_one_way(wasgo_id, p_id, p_shape_id, p_one_way);
}
void TileSet::tile_set_shape_one_way_margin(int p_id, int p_shape_id, float p_one_way){
	_wasgo_TileSet_wrapper_tile_set_shape_one_way_margin(wasgo_id, p_id, p_shape_id, p_one_way);
}
void TileSet::tile_set_shape_transform(int p_id, int p_shape_id, Transform2D p_shape_transform){
	...
	_wasgo_TileSet_wrapper_tile_set_shape_transform(wasgo_id, p_id, p_shape_id, wasgo_buffer_shape_transform, wasgo_size_shape_transform);
}
...
void TileSet::tile_set_texture_offset(int p_id, Vector2 p_texture_offset){
	...
	_wasgo_TileSet_wrapper_tile_set_texture_offset(wasgo_id, p_id, wasgo_buffer_texture_offset, wasgo_size_texture_offset);
}
