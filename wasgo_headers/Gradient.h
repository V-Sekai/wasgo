...
//Wrapper Functions
extern "C"{
void _wasgo_Gradient_wrapper_add_point(WasGoId wasgo_id, float p_offset, WasGoId p_color);
WasGoId _wasgo_Gradient_wrapper_get_color(WasGoId wasgo_id, int p_point);
...
WasGoId _wasgo_Gradient_wrapper_interpolate(WasGoId wasgo_id, float p_offset);
void _wasgo_Gradient_wrapper_remove_point(WasGoId wasgo_id, int p_offset);
void _wasgo_Gradient_wrapper_set_color(WasGoId wasgo_id, int p_point, WasGoId p_color);
