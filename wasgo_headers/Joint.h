...
WasGoId _wasgo_Joint_wrapper_get_node_a(WasGoId wasgo_id);
WasGoId _wasgo_Joint_wrapper_get_node_b(WasGoId wasgo_id);
...
void _wasgo_Joint_wrapper_set_node_a(WasGoId wasgo_id, WasGoId p_node);
void _wasgo_Joint_wrapper_set_node_b(WasGoId wasgo_id, WasGoId p_node);
