...
ParallaxLayer::ParallaxLayer():Node2D(){
}
ParallaxLayer ParallaxLayer::new_instance(){
    return ParallaxLayer(_wasgo_ParallaxLayer_constructor());
}
WasGoID ParallaxLayer::_get_wasgo_id(){
    return wasgo_id;
}
ParallaxLayer::operator bool(){
