...
void PhysicsShapeQueryParameters::set_exclude(Array p_exclude){
	_wasgo_PhysicsShapeQueryParameters_wrapper_set_exclude(wasgo_id, ((Variant) p_exclude).get_wasgo_id());
}
...
void PhysicsShapeQueryParameters::set_shape(Resource p_shape){
	_wasgo_PhysicsShapeQueryParameters_wrapper_set_shape(wasgo_id, ((Variant) p_shape).get_wasgo_id());
}
void PhysicsShapeQueryParameters::set_shape_rid(RID p_shape){
	_wasgo_PhysicsShapeQueryParameters_wrapper_set_shape_rid(wasgo_id, ((Variant) p_shape).get_wasgo_id());
}
void PhysicsShapeQueryParameters::set_transform(Transform p_transform){
	_wasgo_PhysicsShapeQueryParameters_wrapper_set_transform(wasgo_id, ((Variant) p_transform).get_wasgo_id());
}