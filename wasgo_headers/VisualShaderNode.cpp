...
Variant VisualShaderNode::get_input_port_default_value(int p_port){
	return Variant::from_wasgo_id(_wasgo_VisualShaderNode_wrapper_get_input_port_default_value(wasgo_id, p_port));
}
...
void VisualShaderNode::set_default_input_values(Array p_values){
	_wasgo_VisualShaderNode_wrapper_set_default_input_values(wasgo_id, ((Variant) p_values).get_wasgo_id());
}
void VisualShaderNode::set_input_port_default_value(int p_port, Variant p_value){
	_wasgo_VisualShaderNode_wrapper_set_input_port_default_value(wasgo_id, p_port, ((Variant) p_value).get_wasgo_id());
}
