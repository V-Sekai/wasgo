...
Variant PacketPeer::get_var(bool p_allow_objects = (bool) false){
	return Variant::from_wasgo_id(_wasgo_PacketPeer_wrapper_get_var(wasgo_id, p_allow_objects));
}
...
Error PacketPeer::put_packet(PoolByteArray p_buffer){
	return Error::from_wasgo_id(_wasgo_PacketPeer_wrapper_put_packet(wasgo_id, ((Variant) p_buffer).get_wasgo_id()));
}
Error PacketPeer::put_var(Variant p_var, bool p_full_objects = (bool) false){
	return Error::from_wasgo_id(_wasgo_PacketPeer_wrapper_put_var(wasgo_id, ((Variant) p_var).get_wasgo_id(), p_full_objects));
}
