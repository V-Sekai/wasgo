...
void ConfigFile::erase_section(String p_section){
    ...
    uint8_t wasgo_buffer_section[256];
    int wasgo_size_section = 256;
...
Error ConfigFile::load_encrypted_pass(String p_path, String p_password){
    ...
    uint8_t wasgo_buffer_password[256];
    int wasgo_size_password = 256;
...
ConfigFile::~ConfigFile(){
    _wasgo_ConfigFile_destructor(wasgo_id);
}