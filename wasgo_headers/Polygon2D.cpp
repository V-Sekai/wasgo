...
void Polygon2D::add_bone(NodePath p_path, PoolRealArray p_weights){
	_wasgo_Polygon2D_wrapper_add_bone(wasgo_id, ((Variant) path).get_wasgo_id(), ((Variant) weights).get_wasgo_id());
}
void Polygon2D::clear_bones(){
	_wasgo_Polygon2D_wrapper_clear_bones(wasgo_id);
}
void Polygon2D::erase_bone(int p_index){
	_wasgo_Polygon2D_wrapper_erase_bone(wasgo_id, index);
}
...
NodePath Polygon2D::get_bone_path(int p_index){
	return NodePath::from_wasgo_id(_wasgo_Polygon2D_wrapper_get_bone_path(wasgo_id, index));
}
PoolRealArray Polygon2D::get_bone_weights(int p_index){
	return PoolRealArray::from_wasgo_id(_wasgo_Polygon2D_wrapper_get_bone_weights(wasgo_id, index));
}
...
void Polygon2D::set_antialiased(bool p_antialiased){
	_wasgo_Polygon2D_wrapper_set_antialiased(wasgo_id, antialiased);
}
void Polygon2D::set_bone_path(int p_index, NodePath p_path){
	_wasgo_Polygon2D_wrapper_set_bone_path(wasgo_id, index, ((Variant) path).get_wasgo_id());
}
void Polygon2D::set_bone_weights(int p_index, PoolRealArray p_weights){
	_wasgo_Polygon2D_wrapper_set_bone_weights(wasgo_id, index, ((Variant) weights).get_wasgo_id());
}
void Polygon2D::set_color(Color p_color){
	_wasgo_Polygon2D_wrapper_set_color(wasgo_id, ((Variant) color).get_wasgo_id());
}
void Polygon2D::set_internal_vertex_count(int p_internal_vertex_count){
	_wasgo_Polygon2D_wrapper_set_internal_vertex_count(wasgo_id, internal_vertex_count);
}
void Polygon2D::set_invert(bool p_invert){
	_wasgo_Polygon2D_wrapper_set_invert(wasgo_id, invert);
}
void Polygon2D::set_invert_border(float p_invert_border){
	_wasgo_Polygon2D_wrapper_set_invert_border(wasgo_id, invert_border);
}
void Polygon2D::set_offset(Vector2 p_offset){
	_wasgo_Polygon2D_wrapper_set_offset(wasgo_id, ((Variant) offset).get_wasgo_id());
}
void Polygon2D::set_polygon(PoolVector2Array p_polygon){
	_wasgo_Polygon2D_wrapper_set_polygon(wasgo_id, ((Variant) polygon).get_wasgo_id());
}
void Polygon2D::set_polygons(Array p_polygons){
	_wasgo_Polygon2D_wrapper_set_polygons(wasgo_id, ((Variant) polygons).get_wasgo_id());
}
void Polygon2D::set_skeleton(NodePath p_skeleton){
	_wasgo_Polygon2D_wrapper_set_skeleton(wasgo_id, ((Variant) skeleton).get_wasgo_id());
}
void Polygon2D::set_texture(Texture p_texture){
	_wasgo_Polygon2D_wrapper_set_texture(wasgo_id, ((Variant) texture).get_wasgo_id());
}
void Polygon2D::set_texture_offset(Vector2 p_texture_offset){
	_wasgo_Polygon2D_wrapper_set_texture_offset(wasgo_id, ((Variant) texture_offset).get_wasgo_id());
}
void Polygon2D::set_texture_rotation(float p_texture_rotation){
	_wasgo_Polygon2D_wrapper_set_texture_rotation(wasgo_id, texture_rotation);
}
void Polygon2D::set_texture_rotation_degrees(float p_texture_rotation){
	_wasgo_Polygon2D_wrapper_set_texture_rotation_degrees(wasgo_id, texture_rotation);
}
void Polygon2D::set_texture_scale(Vector2 p_texture_scale){
	_wasgo_Polygon2D_wrapper_set_texture_scale(wasgo_id, ((Variant) texture_scale).get_wasgo_id());
}
void Polygon2D::set_uv(PoolVector2Array p_uv){
	_wasgo_Polygon2D_wrapper_set_uv(wasgo_id, ((Variant) uv).get_wasgo_id());
}
void Polygon2D::set_vertex_colors(PoolColorArray p_vertex_colors){
	_wasgo_Polygon2D_wrapper_set_vertex_colors(wasgo_id, ((Variant) vertex_colors).get_wasgo_id());
}

Polygon2D::Polygon2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Polygon2D::~Polygon2D(){
}