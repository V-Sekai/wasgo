...
String Node::get_filename(){
    ...
    Variant wasgo_ret;
    int wasgo_buffer_size = 128;
    uint8_t wasgo_ret_buffer[128];
...
String Node::get_name(){
    ...
    int wasgo_buffer_size = 128;
	uint8_t wasgo_ret_buffer[128];
	_wasgo_Node_wrapper_get_name(wasgo_id, wasgo_ret_buffer, wasgo_buffer_size);
	decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_buffer_size);
    return wasgo_ret;
}
...
Node Node::get_node(NodePath p_path){
    ...
    uint8_t wasgo_buffer_path[128];
    int wasgo_size_path = 128;
...
void Node::set_filename(String p_filename){
    ...
    uint8_t wasgo_buffer_filename[128];
    int wasgo_size_filename = 128;
...
void Node::set_name(String p_name){
    ...
    uint8_t wasgo_buffer_name[128];
    int wasgo_size_name = 128;
...
Node::Node(Object obj) : Object(obj._get_wasgo_id()) {
}
