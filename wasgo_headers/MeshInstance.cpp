...
Material MeshInstance::get_active_material(int p_surface){
	return Material::from_wasgo_id(_wasgo_MeshInstance_wrapper_get_active_material(wasgo_id, surface));
}
...
Material MeshInstance::get_surface_material(int p_surface){
	return Material::from_wasgo_id(_wasgo_MeshInstance_wrapper_get_surface_material(wasgo_id, surface));
}
...
void MeshInstance::set_mesh(Mesh p_mesh){
	_wasgo_MeshInstance_wrapper_set_mesh(wasgo_id, ((Variant) mesh).get_wasgo_id());
}
void MeshInstance::set_skeleton_path(NodePath p_skeleton_path){
	_wasgo_MeshInstance_wrapper_set_skeleton_path(wasgo_id, ((Variant) skeleton_path).get_wasgo_id());
}
void MeshInstance::set_skin(Skin p_skin){
	_wasgo_MeshInstance_wrapper_set_skin(wasgo_id, ((Variant) skin).get_wasgo_id());
}
void MeshInstance::set_software_skinning_transform_normals(bool p_enabled){
	_wasgo_MeshInstance_wrapper_set_software_skinning_transform_normals(wasgo_id, enabled);
}
void MeshInstance::set_surface_material(int p_surface, Material p_material){
	_wasgo_MeshInstance_wrapper_set_surface_material(wasgo_id, surface, ((Variant) material).get_wasgo_id());
}

MeshInstance::MeshInstance(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
