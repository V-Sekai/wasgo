...
//Wrapper Functions
extern "C"{
void _wasgo_BitMap_wrapper_create(WasGoId wasgo_id, WasGoId p_size);
void _wasgo_BitMap_wrapper_create_from_image_alpha(WasGoId wasgo_id, WasGoId p_image, float p_threshold);
int _wasgo_BitMap_wrapper_get_bit(WasGoId wasgo_id, WasGoId p_position);
WasGoId _wasgo_BitMap_wrapper_get_size(WasGoId wasgo_id);
int _wasgo_BitMap_wrapper_get_true_bit_count(WasGoId wasgo_id);
void _wasgo_BitMap_wrapper_set_bit(WasGoId wasgo_id, WasGoId p_position, bool p_bit);
void _wasgo_BitMap_wrapper_set_bit_rect(WasGoId wasgo_id, WasGoId p_rect, bool p_bit);
}
#endif