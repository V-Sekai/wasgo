...
void AnimationNodeStateMachineTransition::set_advance_condition(String p_name){
	_wasgo_AnimationNodeStateMachineTransition_wrapper_set_advance_condition(wasgo_id, ((Variant) name).get_wasgo_id());
}
void AnimationNodeStateMachineTransition::set_auto_advance(bool p_auto_advance){
	_wasgo_AnimationNodeStateMachineTransition_wrapper_set_auto_advance(wasgo_id, auto_advance);
}
void AnimationNodeStateMachineTransition::set_disabled(bool p_disabled){
	_wasgo_AnimationNodeStateMachineTransition_wrapper_set_disabled(wasgo_id, disabled);
}
void AnimationNodeStateMachineTransition::set_priority(int p_priority){
	_wasgo_AnimationNodeStateMachineTransition_wrapper_set_priority(wasgo_id, priority);
}
void AnimationNodeStateMachineTransition::set_switch_mode(AnimationNodeStateMachineTransition::SwitchMode p_mode){
	_wasgo_AnimationNodeStateMachineTransition_wrapper_set_switch_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void AnimationNodeStateMachineTransition::set_xfade_time(float p_secs){
	_wasgo_AnimationNodeStateMachineTransition_wrapper_set_xfade_time(wasgo_id, secs);
}

AnimationNodeStateMachineTransition::AnimationNodeStateMachineTransition(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
