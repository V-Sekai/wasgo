...
//Wrapper Functions
extern "C"{
void _wasgo_BitmapFont_wrapper_add_char(WasGoId wasgo_id, int p_character, int p_texture, WasGoId p_rect, WasGoId p_align, float p_advance);
...
WasGoId _wasgo_BitmapFont_wrapper_create_from_fnt(WasGoId wasgo_id, WasGoId p_path);
