...
void WorldEnvironment::set_environment(Environment p_env){
	_wasgo_WorldEnvironment_wrapper_set_environment(wasgo_id, ((Variant) env).get_wasgo_id());
}

WorldEnvironment::WorldEnvironment(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
