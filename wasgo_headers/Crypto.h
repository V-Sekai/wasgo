...
WasGoId _wasgo_Crypto_wrapper_generate_self_signed_certificate(WasGoId wasgo_id, WasGoId p_key, WasGoId p_issuer_name, WasGoId p_not_before, WasGoId p_not_after);
}
#endif