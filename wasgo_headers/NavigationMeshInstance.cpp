...
void NavigationMeshInstance::set_enabled(bool p_enabled){
	_wasgo_NavigationMeshInstance_wrapper_set_enabled(wasgo_id, enabled);
}
void NavigationMeshInstance::set_navigation_mesh(NavigationMesh p_navmesh){
	_wasgo_NavigationMeshInstance_wrapper_set_navigation_mesh(wasgo_id, ((Variant) navmesh).get_wasgo_id());
}

NavigationMeshInstance::NavigationMeshInstance(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
