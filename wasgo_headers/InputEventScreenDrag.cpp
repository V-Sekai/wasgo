...
void InputEventScreenDrag::set_index(int p_index){
	_wasgo_InputEventScreenDrag_wrapper_set_index(wasgo_id, index);
}
void InputEventScreenDrag::set_position(Vector2 p_position){
	_wasgo_InputEventScreenDrag_wrapper_set_position(wasgo_id, ((Variant) position).get_wasgo_id());
}
void InputEventScreenDrag::set_relative(Vector2 p_relative){
	_wasgo_InputEventScreenDrag_wrapper_set_relative(wasgo_id, ((Variant) relative).get_wasgo_id());
}
void InputEventScreenDrag::set_speed(Vector2 p_speed){
	_wasgo_InputEventScreenDrag_wrapper_set_speed(wasgo_id, ((Variant) speed).get_wasgo_id());
}

InputEventScreenDrag::InputEventScreenDrag(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
