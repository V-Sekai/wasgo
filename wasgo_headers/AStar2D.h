...
//Wrapper Functions
extern "C"{
void _wasgo_AStar2D_wrapper_add_point(WasGoID wasgo_id, int p_id, const uint8_t * p_position, int wasgo_throwaway, int p_position_wasgo_buffer_size, float p_weight_scale);
...
void _wasgo_AStar2D_wrapper_connect_points(WasGoID wasgo_id, int p_id, int p_to_id, int wasgo_throwaway, bool p_bidirectional);
...
int _wasgo_AStar2D_wrapper_get_closest_point(WasGoID wasgo_id, const uint8_t * p_to_position, int p_to_position_wasgo_buffer_size, int wasgo_throwaway, bool p_include_disabled);
void _wasgo_AStar2D_wrapper_get_closest_position_in_segment(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, const uint8_t * p_to_position, int p_to_position_wasgo_buffer_size);
...
void _wasgo_AStar2D_wrapper_get_point_position(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_id);
...
void _wasgo_AStar2D_wrapper_set_point_position(WasGoID wasgo_id, int p_id, const uint8_t * p_position, int wasgo_throwaway, int p_position_wasgo_buffer_size);
