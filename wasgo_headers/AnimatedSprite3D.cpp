...
void AnimatedSprite3D::set_animation(String p_animation){
	_wasgo_AnimatedSprite3D_wrapper_set_animation(wasgo_id, ((Variant) animation).get_wasgo_id());
}
void AnimatedSprite3D::set_sprite_frames(SpriteFrames p_sprite_frames){
	_wasgo_AnimatedSprite3D_wrapper_set_sprite_frames(wasgo_id, ((Variant) sprite_frames).get_wasgo_id());
}

AnimatedSprite3D::AnimatedSprite3D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
