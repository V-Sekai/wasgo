...
void PhysicsDirectBodyState::add_central_force(Vector3 p_force){
	_wasgo_PhysicsDirectBodyState_wrapper_add_central_force(wasgo_id, ((Variant) force).get_wasgo_id());
}
void PhysicsDirectBodyState::add_force(Vector3 p_force, Vector3 p_position){
	_wasgo_PhysicsDirectBodyState_wrapper_add_force(wasgo_id, ((Variant) force).get_wasgo_id(), ((Variant) position).get_wasgo_id());
}
void PhysicsDirectBodyState::add_torque(Vector3 p_torque){
	_wasgo_PhysicsDirectBodyState_wrapper_add_torque(wasgo_id, ((Variant) torque).get_wasgo_id());
}
void PhysicsDirectBodyState::apply_central_impulse(Vector3 p_j){
	_wasgo_PhysicsDirectBodyState_wrapper_apply_central_impulse(wasgo_id, ((Variant) j).get_wasgo_id());
}
void PhysicsDirectBodyState::apply_impulse(Vector3 p_position, Vector3 p_j){
	_wasgo_PhysicsDirectBodyState_wrapper_apply_impulse(wasgo_id, ((Variant) position).get_wasgo_id(), ((Variant) j).get_wasgo_id());
}
void PhysicsDirectBodyState::apply_torque_impulse(Vector3 p_j){
	_wasgo_PhysicsDirectBodyState_wrapper_apply_torque_impulse(wasgo_id, ((Variant) j).get_wasgo_id());
}
...
RID PhysicsDirectBodyState::get_contact_collider(int p_contact_idx){
	return RID::from_wasgo_id(_wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider(wasgo_id, contact_idx));
}
int PhysicsDirectBodyState::get_contact_collider_id(int p_contact_idx){
	return (int) _wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider_id(wasgo_id, contact_idx));
}
Object PhysicsDirectBodyState::get_contact_collider_object(int p_contact_idx){
	return Object::from_wasgo_id(_wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider_object(wasgo_id, contact_idx));
}
Vector3 PhysicsDirectBodyState::get_contact_collider_position(int p_contact_idx){
	return Vector3::from_wasgo_id(_wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider_position(wasgo_id, contact_idx));
}
int PhysicsDirectBodyState::get_contact_collider_shape(int p_contact_idx){
	return (int) _wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider_shape(wasgo_id, contact_idx));
}
Vector3 PhysicsDirectBodyState::get_contact_collider_velocity_at_position(int p_contact_idx){
	return Vector3::from_wasgo_id(_wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider_velocity_at_position(wasgo_id, contact_idx));
}
...
float PhysicsDirectBodyState::get_contact_impulse(int p_contact_idx){
	return (float) _wasgo_PhysicsDirectBodyState_wrapper_get_contact_impulse(wasgo_id, contact_idx));
}
Vector3 PhysicsDirectBodyState::get_contact_local_normal(int p_contact_idx){
	return Vector3::from_wasgo_id(_wasgo_PhysicsDirectBodyState_wrapper_get_contact_local_normal(wasgo_id, contact_idx));
}
Vector3 PhysicsDirectBodyState::get_contact_local_position(int p_contact_idx){
	return Vector3::from_wasgo_id(_wasgo_PhysicsDirectBodyState_wrapper_get_contact_local_position(wasgo_id, contact_idx));
}
int PhysicsDirectBodyState::get_contact_local_shape(int p_contact_idx){
	return (int) _wasgo_PhysicsDirectBodyState_wrapper_get_contact_local_shape(wasgo_id, contact_idx));
}
...
void PhysicsDirectBodyState::set_angular_velocity(Vector3 p_velocity){
	_wasgo_PhysicsDirectBodyState_wrapper_set_angular_velocity(wasgo_id, ((Variant) velocity).get_wasgo_id());
}
void PhysicsDirectBodyState::set_linear_velocity(Vector3 p_velocity){
	_wasgo_PhysicsDirectBodyState_wrapper_set_linear_velocity(wasgo_id, ((Variant) velocity).get_wasgo_id());
}
void PhysicsDirectBodyState::set_sleep_state(bool p_enabled){
	_wasgo_PhysicsDirectBodyState_wrapper_set_sleep_state(wasgo_id, enabled);
}
void PhysicsDirectBodyState::set_transform(Transform p_transform){
	_wasgo_PhysicsDirectBodyState_wrapper_set_transform(wasgo_id, ((Variant) transform).get_wasgo_id());
}