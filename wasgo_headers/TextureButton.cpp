...
void TextureButton::set_click_mask(BitMap p_mask){
	_wasgo_TextureButton_wrapper_set_click_mask(wasgo_id, ((Variant) p_mask).get_wasgo_id());
}
void TextureButton::set_disabled_texture(Texture p_texture){
	_wasgo_TextureButton_wrapper_set_disabled_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
...
void TextureButton::set_focused_texture(Texture p_texture){
	_wasgo_TextureButton_wrapper_set_focused_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
void TextureButton::set_hover_texture(Texture p_texture){
	_wasgo_TextureButton_wrapper_set_hover_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
void TextureButton::set_normal_texture(Texture p_texture){
	_wasgo_TextureButton_wrapper_set_normal_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
void TextureButton::set_pressed_texture(Texture p_texture){
	_wasgo_TextureButton_wrapper_set_pressed_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
void TextureButton::set_stretch_mode(TextureButton::StretchMode p_p_mode){
	_wasgo_TextureButton_wrapper_set_stretch_mode(wasgo_id, ((Variant) p_p_mode).get_wasgo_id());
}