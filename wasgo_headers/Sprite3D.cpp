...
void Sprite3D::set_frame(int p_frame){
	_wasgo_Sprite3D_wrapper_set_frame(wasgo_id, frame);
}
void Sprite3D::set_frame_coords(Vector2 p_coords){
	_wasgo_Sprite3D_wrapper_set_frame_coords(wasgo_id, ((Variant) coords).get_wasgo_id());
}
void Sprite3D::set_hframes(int p_hframes){
	_wasgo_Sprite3D_wrapper_set_hframes(wasgo_id, hframes);
}
void Sprite3D::set_region(bool p_enabled){
	_wasgo_Sprite3D_wrapper_set_region(wasgo_id, enabled);
}
void Sprite3D::set_region_rect(Rect2 p_rect){
	_wasgo_Sprite3D_wrapper_set_region_rect(wasgo_id, ((Variant) rect).get_wasgo_id());
}
void Sprite3D::set_texture(Texture p_texture){
	_wasgo_Sprite3D_wrapper_set_texture(wasgo_id, ((Variant) texture).get_wasgo_id());
}
void Sprite3D::set_vframes(int p_vframes){
	_wasgo_Sprite3D_wrapper_set_vframes(wasgo_id, vframes);
}

Sprite3D::Sprite3D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Sprite3D::~Sprite3D(){
}