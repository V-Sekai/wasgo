...
void CollisionPolygon::set_depth(float p_depth){
	_wasgo_CollisionPolygon_wrapper_set_depth(wasgo_id, depth);
}
void CollisionPolygon::set_disabled(bool p_disabled){
	_wasgo_CollisionPolygon_wrapper_set_disabled(wasgo_id, disabled);
}
void CollisionPolygon::set_polygon(PoolVector2Array p_polygon){
	_wasgo_CollisionPolygon_wrapper_set_polygon(wasgo_id, ((Variant) polygon).get_wasgo_id());
}

CollisionPolygon::CollisionPolygon(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
