...
void Curve3D::add_point(Vector3 p_position, Vector3 p_in = (Vector3) (0, 0, 0), Vector3 p_out = (Vector3) (0, 0, 0), int p_at_position = (int) -1){
	_wasgo_Curve3D_wrapper_add_point(wasgo_id, ((Variant) position).get_wasgo_id(), ((Variant) in).get_wasgo_id(), ((Variant) out).get_wasgo_id(), at_position);
}
...
float Curve3D::get_closest_offset(Vector3 p_to_point){
	return (float) _wasgo_Curve3D_wrapper_get_closest_offset(wasgo_id, ((Variant) to_point).get_wasgo_id()));
}
Vector3 Curve3D::get_closest_point(Vector3 p_to_point){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_get_closest_point(wasgo_id, ((Variant) to_point).get_wasgo_id()));
}
...
Vector3 Curve3D::get_point_in(int p_idx){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_get_point_in(wasgo_id, idx));
}
Vector3 Curve3D::get_point_out(int p_idx){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_get_point_out(wasgo_id, idx));
}
Vector3 Curve3D::get_point_position(int p_idx){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_get_point_position(wasgo_id, idx));
}
float Curve3D::get_point_tilt(int p_idx){
	return (float) _wasgo_Curve3D_wrapper_get_point_tilt(wasgo_id, idx));
}
Vector3 Curve3D::interpolate(int p_idx, float p_t){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_interpolate(wasgo_id, idx, t));
}
Vector3 Curve3D::interpolate_baked(float p_offset, bool p_cubic = (bool) False){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_interpolate_baked(wasgo_id, offset, cubic));
}
Vector3 Curve3D::interpolate_baked_up_vector(float p_offset, bool p_apply_tilt = (bool) False){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_interpolate_baked_up_vector(wasgo_id, offset, apply_tilt));
}
Vector3 Curve3D::interpolatef(float p_fofs){
	return Vector3::from_wasgo_id(_wasgo_Curve3D_wrapper_interpolatef(wasgo_id, fofs));
}
...
void Curve3D::remove_point(int p_idx){
	_wasgo_Curve3D_wrapper_remove_point(wasgo_id, idx);
}
void Curve3D::set_bake_interval(float p_distance){
	_wasgo_Curve3D_wrapper_set_bake_interval(wasgo_id, distance);
}
void Curve3D::set_point_in(int p_idx, Vector3 p_position){
	_wasgo_Curve3D_wrapper_set_point_in(wasgo_id, idx, ((Variant) position).get_wasgo_id());
}
void Curve3D::set_point_out(int p_idx, Vector3 p_position){
	_wasgo_Curve3D_wrapper_set_point_out(wasgo_id, idx, ((Variant) position).get_wasgo_id());
}
void Curve3D::set_point_position(int p_idx, Vector3 p_position){
	_wasgo_Curve3D_wrapper_set_point_position(wasgo_id, idx, ((Variant) position).get_wasgo_id());
}
void Curve3D::set_point_tilt(int p_idx, float p_tilt){
	_wasgo_Curve3D_wrapper_set_point_tilt(wasgo_id, idx, tilt);
}
void Curve3D::set_up_vector_enabled(bool p_enable){
	_wasgo_Curve3D_wrapper_set_up_vector_enabled(wasgo_id, enable);
}
PoolVector3Array Curve3D::tessellate(int p_max_stages = (int) 5, float p_tolerance_degrees = (float) 4){
	return PoolVector3Array::from_wasgo_id(_wasgo_Curve3D_wrapper_tessellate(wasgo_id, max_stages, tolerance_degrees));
}

Curve3D::Curve3D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Curve3D::~Curve3D(){
}