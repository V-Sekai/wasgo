...
void MeshInstance2D::set_mesh(Mesh p_mesh){
	_wasgo_MeshInstance2D_wrapper_set_mesh(wasgo_id, ((Variant) p_mesh).get_wasgo_id());
}
void MeshInstance2D::set_normal_map(Texture p_normal_map){
	_wasgo_MeshInstance2D_wrapper_set_normal_map(wasgo_id, ((Variant) p_normal_map).get_wasgo_id());
}
void MeshInstance2D::set_texture(Texture p_texture){
	_wasgo_MeshInstance2D_wrapper_set_texture(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}