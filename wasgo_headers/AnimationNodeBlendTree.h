...
//Wrapper Functions
extern "C"{
void _wasgo_AnimationNodeBlendTree_wrapper_add_node(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size, int wasgo_throwaway, WasGoID p_node, const uint8_t * p_position, int p_position_wasgo_buffer_size);
void _wasgo_AnimationNodeBlendTree_wrapper_connect_node(WasGoID wasgo_id, const uint8_t * p_input_node, int p_input_node_wasgo_buffer_size, int wasgo_throwaway, int p_input_index, const uint8_t * p_output_node, int p_output_node_wasgo_buffer_size);
void _wasgo_AnimationNodeBlendTree_wrapper_disconnect_node(WasGoID wasgo_id, const uint8_t * p_input_node, int p_input_node_wasgo_buffer_size, int wasgo_throwaway, int p_input_index);
...
void _wasgo_AnimationNodeBlendTree_wrapper_get_node_position(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, const uint8_t * p_name, int p_name_wasgo_buffer_size);
...
void _wasgo_AnimationNodeBlendTree_wrapper_rename_node(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_new_name, int p_new_name_wasgo_buffer_size);
...
void _wasgo_AnimationNodeBlendTree_wrapper_set_node_position(WasGoID wasgo_id, const uint8_t * p_name, int p_name_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_position, int p_position_wasgo_buffer_size);
