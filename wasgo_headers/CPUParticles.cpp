...
void CPUParticles::convert_from_particles(Node p_particles){
	_wasgo_CPUParticles_wrapper_convert_from_particles(wasgo_id, ((Variant) p_particles).get_wasgo_id());
}
...
float CPUParticles::get_param(CPUParticles::Parameter p_param){
	return (float) _wasgo_CPUParticles_wrapper_get_param(wasgo_id, ((Variant) p_param).get_wasgo_id());
}
Curve CPUParticles::get_param_curve(CPUParticles::Parameter p_param){
	return Curve::from_wasgo_id(_wasgo_CPUParticles_wrapper_get_param_curve(wasgo_id, ((Variant) p_param).get_wasgo_id()));
}
float CPUParticles::get_param_randomness(CPUParticles::Parameter p_param){
	return (float) _wasgo_CPUParticles_wrapper_get_param_randomness(wasgo_id, ((Variant) p_param).get_wasgo_id());
}
bool CPUParticles::get_particle_flag(CPUParticles::Flags p_flag){
	return (bool) _wasgo_CPUParticles_wrapper_get_particle_flag(wasgo_id, ((Variant) p_flag).get_wasgo_id());
}
...
void CPUParticles::set_color(Color p_color){
	_wasgo_CPUParticles_wrapper_set_color(wasgo_id, ((Variant) p_color).get_wasgo_id());
}
void CPUParticles::set_color_ramp(Gradient p_ramp){
	_wasgo_CPUParticles_wrapper_set_color_ramp(wasgo_id, ((Variant) p_ramp).get_wasgo_id());
}
void CPUParticles::set_direction(Vector3 p_direction){
	_wasgo_CPUParticles_wrapper_set_direction(wasgo_id, ((Variant) p_direction).get_wasgo_id());
}
void CPUParticles::set_draw_order(CPUParticles::DrawOrder p_order){
	_wasgo_CPUParticles_wrapper_set_draw_order(wasgo_id, ((Variant) p_order).get_wasgo_id());
}
void CPUParticles::set_emission_box_extents(Vector3 p_extents){
	_wasgo_CPUParticles_wrapper_set_emission_box_extents(wasgo_id, ((Variant) p_extents).get_wasgo_id());
}
void CPUParticles::set_emission_colors(PoolColorArray p_array){
	_wasgo_CPUParticles_wrapper_set_emission_colors(wasgo_id, ((Variant) p_array).get_wasgo_id());
}
void CPUParticles::set_emission_normals(PoolVector3Array p_array){
	_wasgo_CPUParticles_wrapper_set_emission_normals(wasgo_id, ((Variant) p_array).get_wasgo_id());
}
void CPUParticles::set_emission_points(PoolVector3Array p_array){
	_wasgo_CPUParticles_wrapper_set_emission_points(wasgo_id, ((Variant) p_array).get_wasgo_id());
}
void CPUParticles::set_emission_shape(CPUParticles::EmissionShape p_shape){
	_wasgo_CPUParticles_wrapper_set_emission_shape(wasgo_id, ((Variant) p_shape).get_wasgo_id());
}
...
void CPUParticles::set_gravity(Vector3 p_accel_vec){
	_wasgo_CPUParticles_wrapper_set_gravity(wasgo_id, ((Variant) p_accel_vec).get_wasgo_id());
}
...
void CPUParticles::set_mesh(Mesh p_mesh){
	_wasgo_CPUParticles_wrapper_set_mesh(wasgo_id, ((Variant) p_mesh).get_wasgo_id());
}
...
void CPUParticles::set_param(CPUParticles::Parameter p_param, float p_value){
	_wasgo_CPUParticles_wrapper_set_param(wasgo_id, ((Variant) p_param).get_wasgo_id(), p_value);
}
void CPUParticles::set_param_curve(CPUParticles::Parameter p_param, Curve p_curve){
	_wasgo_CPUParticles_wrapper_set_param_curve(wasgo_id, ((Variant) p_param).get_wasgo_id(), ((Variant) p_curve).get_wasgo_id());
}
void CPUParticles::set_param_randomness(CPUParticles::Parameter p_param, float p_randomness){
	_wasgo_CPUParticles_wrapper_set_param_randomness(wasgo_id, ((Variant) p_param).get_wasgo_id(), p_randomness);
}
void CPUParticles::set_particle_flag(CPUParticles::Flags p_flag, bool p_enable){
	_wasgo_CPUParticles_wrapper_set_particle_flag(wasgo_id, ((Variant) p_flag).get_wasgo_id(), p_enable);
}
