...
WasGoId _wasgo_KinematicBody_wrapper_get_floor_normal(WasGoId wasgo_id);
WasGoId _wasgo_KinematicBody_wrapper_get_floor_velocity(WasGoId wasgo_id);
...
WasGoId _wasgo_KinematicBody_wrapper_move_and_collide(WasGoId wasgo_id, WasGoId p_rel_vec, bool p_infinite_inertia, bool p_exclude_raycast_shapes, bool p_test_only);
WasGoId _wasgo_KinematicBody_wrapper_move_and_slide(WasGoId wasgo_id, WasGoId p_linear_velocity, WasGoId p_up_direction, bool p_stop_on_slope, int p_max_slides, float p_floor_max_angle, bool p_infinite_inertia);
WasGoId _wasgo_KinematicBody_wrapper_move_and_slide_with_snap(WasGoId wasgo_id, WasGoId p_linear_velocity, WasGoId p_snap, WasGoId p_up_direction, bool p_stop_on_slope, int p_max_slides, float p_floor_max_angle, bool p_infinite_inertia);
...
int _wasgo_KinematicBody_wrapper_test_move(WasGoId wasgo_id, WasGoId p_from, WasGoId p_rel_vec, bool p_infinite_inertia);
}
#endif