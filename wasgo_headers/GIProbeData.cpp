...
void GIProbeData::set_bounds(::AABB p_bounds){
	_wasgo_GIProbeData_wrapper_set_bounds(wasgo_id, ((Variant) p_bounds).get_wasgo_id());
}
...
void GIProbeData::set_dynamic_data(PoolIntArray p_dynamic_data){
	_wasgo_GIProbeData_wrapper_set_dynamic_data(wasgo_id, ((Variant) p_dynamic_data).get_wasgo_id());
}
...
void GIProbeData::set_to_cell_xform(Transform p_to_cell_xform){
	_wasgo_GIProbeData_wrapper_set_to_cell_xform(wasgo_id, ((Variant) p_to_cell_xform).get_wasgo_id());
}