...
int TextureProgress::get_stretch_margin(Margin p_margin){
	return (int) _wasgo_TextureProgress_wrapper_get_stretch_margin(wasgo_id, ((Variant) margin).get_wasgo_id()));
}
...
void TextureProgress::set_fill_degrees(float p_mode){
	_wasgo_TextureProgress_wrapper_set_fill_degrees(wasgo_id, mode);
}
void TextureProgress::set_fill_mode(int p_mode){
	_wasgo_TextureProgress_wrapper_set_fill_mode(wasgo_id, mode);
}
void TextureProgress::set_nine_patch_stretch(bool p_stretch){
	_wasgo_TextureProgress_wrapper_set_nine_patch_stretch(wasgo_id, stretch);
}
void TextureProgress::set_over_texture(Texture p_tex){
	_wasgo_TextureProgress_wrapper_set_over_texture(wasgo_id, ((Variant) tex).get_wasgo_id());
}
void TextureProgress::set_progress_texture(Texture p_tex){
	_wasgo_TextureProgress_wrapper_set_progress_texture(wasgo_id, ((Variant) tex).get_wasgo_id());
}
void TextureProgress::set_radial_center_offset(Vector2 p_mode){
	_wasgo_TextureProgress_wrapper_set_radial_center_offset(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void TextureProgress::set_radial_initial_angle(float p_mode){
	_wasgo_TextureProgress_wrapper_set_radial_initial_angle(wasgo_id, mode);
}
void TextureProgress::set_stretch_margin(Margin p_margin, int p_value){
	_wasgo_TextureProgress_wrapper_set_stretch_margin(wasgo_id, ((Variant) margin).get_wasgo_id(), value);
}
void TextureProgress::set_tint_over(Color p_tint){
	_wasgo_TextureProgress_wrapper_set_tint_over(wasgo_id, ((Variant) tint).get_wasgo_id());
}
void TextureProgress::set_tint_progress(Color p_tint){
	_wasgo_TextureProgress_wrapper_set_tint_progress(wasgo_id, ((Variant) tint).get_wasgo_id());
}
void TextureProgress::set_tint_under(Color p_tint){
	_wasgo_TextureProgress_wrapper_set_tint_under(wasgo_id, ((Variant) tint).get_wasgo_id());
}
void TextureProgress::set_under_texture(Texture p_tex){
	_wasgo_TextureProgress_wrapper_set_under_texture(wasgo_id, ((Variant) tex).get_wasgo_id());
}

TextureProgress::TextureProgress(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
