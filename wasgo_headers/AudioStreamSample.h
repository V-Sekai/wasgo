...
//Wrapper Functions
extern "C"{
WasGo::WasGoId _wasgo_AudioStreamSample_wrapper_get_data(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_AudioStreamSample_wrapper_get_format(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_AudioStreamSample_wrapper_get_loop_mode(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_AudioStreamSample_wrapper_save_to_wav(WasGoId wasgo_id, WasGo::WasGoId p_path);
void _wasgo_AudioStreamSample_wrapper_set_data(WasGoId wasgo_id, WasGo::WasGoId p_data);
void _wasgo_AudioStreamSample_wrapper_set_format(WasGoId wasgo_id, WasGo::WasGoId p_format);
...
void _wasgo_AudioStreamSample_wrapper_set_loop_mode(WasGoId wasgo_id, WasGo::WasGoId p_loop_mode);
