...
Object Physics2DShapeQueryResult::get_result_object(int p_idx){
	return Object::from_wasgo_id(_wasgo_Physics2DShapeQueryResult_wrapper_get_result_object(wasgo_id, idx));
}
int Physics2DShapeQueryResult::get_result_object_id(int p_idx){
	return (int) _wasgo_Physics2DShapeQueryResult_wrapper_get_result_object_id(wasgo_id, idx));
}
int Physics2DShapeQueryResult::get_result_object_shape(int p_idx){
	return (int) _wasgo_Physics2DShapeQueryResult_wrapper_get_result_object_shape(wasgo_id, idx));
}
RID Physics2DShapeQueryResult::get_result_rid(int p_idx){
	return RID::from_wasgo_id(_wasgo_Physics2DShapeQueryResult_wrapper_get_result_rid(wasgo_id, idx));
}