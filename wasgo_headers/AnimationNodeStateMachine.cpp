...
void AnimationNodeStateMachine::add_node(String p_name, AnimationNode p_node, Vector2 p_position = Vector2((0, 0))){
	...
	_wasgo_AnimationNodeStateMachine_wrapper_add_node(wasgo_id, wasgo_buffer_name, wasgo_size_name, p_node._get_wasgo_id(), wasgo_buffer_position, wasgo_size_position);
}
...
String AnimationNodeStateMachine::get_node_name(AnimationNode p_node){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_AnimationNodeStateMachine_wrapper_get_node_name(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_node._get_wasgo_id());
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (String) wasgo_ret;
...
Vector2 AnimationNodeStateMachine::get_node_position(String p_name){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_AnimationNodeStateMachine_wrapper_get_node_position(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, wasgo_buffer_name, wasgo_size_name);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector2) wasgo_ret;
...
String AnimationNodeStateMachine::get_transition_from(int p_idx){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_AnimationNodeStateMachine_wrapper_get_transition_from(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (String) wasgo_ret;
...
String AnimationNodeStateMachine::get_transition_to(int p_idx){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_AnimationNodeStateMachine_wrapper_get_transition_to(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (String) wasgo_ret;
...
void AnimationNodeStateMachine::set_node_position(String p_name, Vector2 p_position){
	...
	_wasgo_AnimationNodeStateMachine_wrapper_set_node_position(wasgo_id, wasgo_buffer_name, wasgo_size_name, wasgo_buffer_position, wasgo_size_position);
}
