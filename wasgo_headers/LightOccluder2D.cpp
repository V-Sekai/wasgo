...
void LightOccluder2D::set_occluder_light_mask(int p_mask){
	_wasgo_LightOccluder2D_wrapper_set_occluder_light_mask(wasgo_id, mask);
}
void LightOccluder2D::set_occluder_polygon(OccluderPolygon2D p_polygon){
	_wasgo_LightOccluder2D_wrapper_set_occluder_polygon(wasgo_id, ((Variant) polygon).get_wasgo_id());
}

LightOccluder2D::LightOccluder2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
