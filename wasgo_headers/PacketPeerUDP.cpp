...
Error PacketPeerUDP::connect_to_host(String p_host, int p_port){
	...
	return Error(_wasgo_PacketPeerUDP_wrapper_connect_to_host(wasgo_id, wasgo_buffer_host, wasgo_size_host, -69, p_port));
}
...
Error PacketPeerUDP::join_multicast_group(String p_multicast_address, String p_interface_name){
    ...
    int wasgo_size_multicast_address = 10 + String(p_multicast_address).size();
    ...
    int wasgo_size_interface_name = 10 + String(p_interface_name).size();
	...
	return Error(_wasgo_PacketPeerUDP_wrapper_join_multicast_group(wasgo_id, wasgo_buffer_multicast_address, wasgo_size_multicast_address, -69, wasgo_buffer_interface_name, wasgo_size_interface_name));
}
Error PacketPeerUDP::leave_multicast_group(String p_multicast_address, String p_interface_name){
	...
	return Error(_wasgo_PacketPeerUDP_wrapper_leave_multicast_group(wasgo_id, wasgo_buffer_multicast_address, wasgo_size_multicast_address, -69, wasgo_buffer_interface_name, wasgo_size_interface_name));
}
Error PacketPeerUDP::listen(int p_port, String p_bind_address, int p_recv_buf_size){
	...
	return Error(_wasgo_PacketPeerUDP_wrapper_listen(wasgo_id, p_port, wasgo_buffer_bind_address, wasgo_size_bind_address, wasgo_size_bind_address, p_recv_buf_size));
}
...
Error PacketPeerUDP::set_dest_address(String p_host, int p_port){
	...
	return Error(_wasgo_PacketPeerUDP_wrapper_set_dest_address(wasgo_id, wasgo_buffer_host, wasgo_size_host, -69, p_port));
}
