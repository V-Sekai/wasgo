...
void AnimationNodeStateMachinePlayback::start(String p_node){
	_wasgo_AnimationNodeStateMachinePlayback_wrapper_start(wasgo_id, ((Variant) node).get_wasgo_id());
}
...
void AnimationNodeStateMachinePlayback::travel(String p_to_node){
	_wasgo_AnimationNodeStateMachinePlayback_wrapper_travel(wasgo_id, ((Variant) to_node).get_wasgo_id());
}

AnimationNodeStateMachinePlayback::AnimationNodeStateMachinePlayback(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
