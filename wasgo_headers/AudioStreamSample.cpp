...
Error AudioStreamSample::save_to_wav(String p_path){
	return Error::from_wasgo_id(_wasgo_AudioStreamSample_wrapper_save_to_wav(wasgo_id, ((Variant) path).get_wasgo_id()));
}
void AudioStreamSample::set_data(PoolByteArray p_data){
	_wasgo_AudioStreamSample_wrapper_set_data(wasgo_id, ((Variant) data).get_wasgo_id());
}
void AudioStreamSample::set_format(AudioStreamSample::Format p_format){
	_wasgo_AudioStreamSample_wrapper_set_format(wasgo_id, ((Variant) format).get_wasgo_id());
}
void AudioStreamSample::set_loop_begin(int p_loop_begin){
	_wasgo_AudioStreamSample_wrapper_set_loop_begin(wasgo_id, loop_begin);
}
void AudioStreamSample::set_loop_end(int p_loop_end){
	_wasgo_AudioStreamSample_wrapper_set_loop_end(wasgo_id, loop_end);
}
void AudioStreamSample::set_loop_mode(AudioStreamSample::LoopMode p_loop_mode){
	_wasgo_AudioStreamSample_wrapper_set_loop_mode(wasgo_id, ((Variant) loop_mode).get_wasgo_id());
}
void AudioStreamSample::set_mix_rate(int p_mix_rate){
	_wasgo_AudioStreamSample_wrapper_set_mix_rate(wasgo_id, mix_rate);
}
void AudioStreamSample::set_stereo(bool p_stereo){
	_wasgo_AudioStreamSample_wrapper_set_stereo(wasgo_id, stereo);
}

AudioStreamSample::AudioStreamSample(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
