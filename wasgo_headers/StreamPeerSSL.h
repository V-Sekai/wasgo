...
WasGoId _wasgo_StreamPeerSSL_wrapper_connect_to_stream(WasGoId wasgo_id, WasGoId p_stream, bool p_validate_certs, WasGoId p_for_hostname, WasGoId p_valid_certificate);
