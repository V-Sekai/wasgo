...
void Button::set_button_icon(Texture p_texture){
	_wasgo_Button_wrapper_set_button_icon(wasgo_id, ((Variant) p_texture).get_wasgo_id());
}
...
void Button::set_text(String p_text){
	_wasgo_Button_wrapper_set_text(wasgo_id, ((Variant) p_text).get_wasgo_id());
}
void Button::set_text_align(Button::TextAlign p_align){
	_wasgo_Button_wrapper_set_text_align(wasgo_id, ((Variant) p_align).get_wasgo_id());
}