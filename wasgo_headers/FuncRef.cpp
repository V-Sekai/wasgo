...
Variant FuncRef::call_func(){
    ...
    _wasgo_FuncRef_wrapper_call_func(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size);
...
Variant FuncRef::call_funcv(Array p_arg_array){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_FuncRef_wrapper_call_funcv(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_arg_array._get_wasgo_id());
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
