...
BakedLightmap::BakeError BakedLightmap::bake(Node p_from_node = (Node) "", bool p_create_visual_debug = (bool) false){
	return BakedLightmap::BakeError::from_wasgo_id(_wasgo_BakedLightmap_wrapper_bake(wasgo_id, ((Variant) p_from_node).get_wasgo_id(), p_create_visual_debug));
}
...
void BakedLightmap::set_bake_mode(BakedLightmap::BakeMode p_bake_mode){
	_wasgo_BakedLightmap_wrapper_set_bake_mode(wasgo_id, ((Variant) p_bake_mode).get_wasgo_id());
}
void BakedLightmap::set_bake_quality(BakedLightmap::BakeQuality p_bake_quality){
	_wasgo_BakedLightmap_wrapper_set_bake_quality(wasgo_id, ((Variant) p_bake_quality).get_wasgo_id());
}
...
void BakedLightmap::set_extents(Vector3 p_extents){
	_wasgo_BakedLightmap_wrapper_set_extents(wasgo_id, ((Variant) p_extents).get_wasgo_id());
}
...
void BakedLightmap::set_image_path(String p_image_path){
	_wasgo_BakedLightmap_wrapper_set_image_path(wasgo_id, ((Variant) p_image_path).get_wasgo_id());
}
void BakedLightmap::set_light_data(BakedLightmapData p_data){
	_wasgo_BakedLightmap_wrapper_set_light_data(wasgo_id, ((Variant) p_data).get_wasgo_id());
}
