...
//Wrapper Functions
extern "C"{
void _wasgo_Font_wrapper_draw(WasGoId wasgo_id, WasGo::WasGoId p_canvas_item, WasGo::WasGoId p_position, WasGo::WasGoId p_string, WasGo::WasGoId p_modulate, int p_clip_w, WasGo::WasGoId p_outline_modulate);
float _wasgo_Font_wrapper_draw_char(WasGoId wasgo_id, WasGo::WasGoId p_canvas_item, WasGo::WasGoId p_position, int p_char, int p_next, WasGo::WasGoId p_modulate, bool p_outline);
float _wasgo_Font_wrapper_get_ascent(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Font_wrapper_get_char_size(WasGoId wasgo_id, int p_char, int p_next);
float _wasgo_Font_wrapper_get_descent(WasGoId wasgo_id);
float _wasgo_Font_wrapper_get_height(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Font_wrapper_get_string_size(WasGoId wasgo_id, WasGo::WasGoId p_string);
WasGo::WasGoId _wasgo_Font_wrapper_get_wordwrap_string_size(WasGoId wasgo_id, WasGo::WasGoId p_string, float p_width);
