...
void Image::blend_rect(Image p_src, Rect2 p_src_rect, Vector2 p_dst){
	_wasgo_Image_wrapper_blend_rect(wasgo_id, ((Variant) src).get_wasgo_id(), ((Variant) src_rect).get_wasgo_id(), ((Variant) dst).get_wasgo_id());
}
void Image::blend_rect_mask(Image p_src, Image p_mask, Rect2 p_src_rect, Vector2 p_dst){
	_wasgo_Image_wrapper_blend_rect_mask(wasgo_id, ((Variant) src).get_wasgo_id(), ((Variant) mask).get_wasgo_id(), ((Variant) src_rect).get_wasgo_id(), ((Variant) dst).get_wasgo_id());
}
void Image::blit_rect(Image p_src, Rect2 p_src_rect, Vector2 p_dst){
	_wasgo_Image_wrapper_blit_rect(wasgo_id, ((Variant) src).get_wasgo_id(), ((Variant) src_rect).get_wasgo_id(), ((Variant) dst).get_wasgo_id());
}
void Image::blit_rect_mask(Image p_src, Image p_mask, Rect2 p_src_rect, Vector2 p_dst){
	_wasgo_Image_wrapper_blit_rect_mask(wasgo_id, ((Variant) src).get_wasgo_id(), ((Variant) mask).get_wasgo_id(), ((Variant) src_rect).get_wasgo_id(), ((Variant) dst).get_wasgo_id());
}
void Image::bumpmap_to_normalmap(float p_bump_scale = (float) 1){
	_wasgo_Image_wrapper_bumpmap_to_normalmap(wasgo_id, bump_scale);
}
...
Error Image::compress(Image::CompressMode p_mode, Image::CompressSource p_source, float p_lossy_quality){
	return Error::from_wasgo_id(_wasgo_Image_wrapper_compress(wasgo_id, ((Variant) mode).get_wasgo_id(), ((Variant) source).get_wasgo_id(), lossy_quality));
}
void Image::convert(Image::Format p_format){
	_wasgo_Image_wrapper_convert(wasgo_id, ((Variant) format).get_wasgo_id());
}
void Image::copy_from(Image p_src){
	_wasgo_Image_wrapper_copy_from(wasgo_id, ((Variant) src).get_wasgo_id());
}
void Image::create(int p_width, int p_height, bool p_use_mipmaps, Image::Format p_format){
	_wasgo_Image_wrapper_create(wasgo_id, width, height, use_mipmaps, ((Variant) format).get_wasgo_id());
}
void Image::create_from_data(int p_width, int p_height, bool p_use_mipmaps, Image::Format p_format, PoolByteArray p_data){
	_wasgo_Image_wrapper_create_from_data(wasgo_id, width, height, use_mipmaps, ((Variant) format).get_wasgo_id(), ((Variant) data).get_wasgo_id());
}
void Image::crop(int p_width, int p_height){
	_wasgo_Image_wrapper_crop(wasgo_id, width, height);
}
...
void Image::fill(Color p_color){
	_wasgo_Image_wrapper_fill(wasgo_id, ((Variant) color).get_wasgo_id());
}
...
Error Image::generate_mipmaps(bool p_renormalize = (bool) False){
	return Error::from_wasgo_id(_wasgo_Image_wrapper_generate_mipmaps(wasgo_id, renormalize));
}
...
int Image::get_mipmap_offset(int p_mipmap){
	return (int) _wasgo_Image_wrapper_get_mipmap_offset(wasgo_id, mipmap));
}
Image Image::get_rect(Rect2 p_rect){
	return Image::from_wasgo_id(_wasgo_Image_wrapper_get_rect(wasgo_id, ((Variant) rect).get_wasgo_id()));
}
...
Error Image::load(String p_path){
	return Error::from_wasgo_id(_wasgo_Image_wrapper_load(wasgo_id, ((Variant) path).get_wasgo_id()));
}
...
void Image::resize(int p_width, int p_height, Image::Interpolation p_interpolation = (Image::Interpolation) 1){
	_wasgo_Image_wrapper_resize(wasgo_id, width, height, ((Variant) interpolation).get_wasgo_id());
}
void Image::resize_to_po2(bool p_square = (bool) False){
	_wasgo_Image_wrapper_resize_to_po2(wasgo_id, square);
}
...
Error Image::save_exr(String p_path, bool p_grayscale = (bool) False){
	return Error::from_wasgo_id(_wasgo_Image_wrapper_save_exr(wasgo_id, ((Variant) path).get_wasgo_id(), grayscale));
}
Error Image::save_png(String p_path){
	return Error::from_wasgo_id(_wasgo_Image_wrapper_save_png(wasgo_id, ((Variant) path).get_wasgo_id()));
}
...
Image::Image(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Image::~Image(){
}