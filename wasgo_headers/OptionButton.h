...
//Wrapper Functions
extern "C"{
void _wasgo_OptionButton_wrapper_add_icon_item(WasGoID wasgo_id, WasGoID p_texture, const uint8_t * p_label, int wasgo_throwaway, int p_label_wasgo_buffer_size, int p_id);
void _wasgo_OptionButton_wrapper_add_item(WasGoID wasgo_id, const uint8_t * p_label, int p_label_wasgo_buffer_size, int wasgo_throwaway, int p_id);
...
void _wasgo_OptionButton_wrapper_get_item_metadata(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
void _wasgo_OptionButton_wrapper_get_item_text(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
...
void _wasgo_OptionButton_wrapper_get_selected_metadata(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size);
...
void _wasgo_OptionButton_wrapper_set_item_metadata(WasGoID wasgo_id, int p_idx, const uint8_t * p_metadata, int wasgo_throwaway, int p_metadata_wasgo_buffer_size);
void _wasgo_OptionButton_wrapper_set_item_text(WasGoID wasgo_id, int p_idx, const uint8_t * p_text, int wasgo_throwaway, int p_text_wasgo_buffer_size);
