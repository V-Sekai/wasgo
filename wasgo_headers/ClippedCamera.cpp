...
void ClippedCamera::add_exception(Object p_node){
	_wasgo_ClippedCamera_wrapper_add_exception(wasgo_id, ((Variant) p_node).get_wasgo_id());
}
void ClippedCamera::add_exception_rid(RID p_rid){
	_wasgo_ClippedCamera_wrapper_add_exception_rid(wasgo_id, ((Variant) p_rid).get_wasgo_id());
}
...
void ClippedCamera::remove_exception(Object p_node){
	_wasgo_ClippedCamera_wrapper_remove_exception(wasgo_id, ((Variant) p_node).get_wasgo_id());
}
void ClippedCamera::remove_exception_rid(RID p_rid){
	_wasgo_ClippedCamera_wrapper_remove_exception_rid(wasgo_id, ((Variant) p_rid).get_wasgo_id());
}
...
void ClippedCamera::set_process_mode(ClippedCamera::ProcessMode p_process_mode){
	_wasgo_ClippedCamera_wrapper_set_process_mode(wasgo_id, ((Variant) p_process_mode).get_wasgo_id());
}