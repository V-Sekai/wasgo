...
WasGoId _wasgo_BakedLightmap_wrapper_get_extents(WasGoId wasgo_id);
WasGoId _wasgo_BakedLightmap_wrapper_get_image_path(WasGoId wasgo_id);
...
void _wasgo_BakedLightmap_wrapper_set_extents(WasGoId wasgo_id, WasGoId p_extents);
void _wasgo_BakedLightmap_wrapper_set_hdr(WasGoId wasgo_id, bool p_hdr);
void _wasgo_BakedLightmap_wrapper_set_image_path(WasGoId wasgo_id, WasGoId p_image_path);
