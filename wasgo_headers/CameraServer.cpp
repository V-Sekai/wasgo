...
void CameraServer::add_feed(CameraFeed p_feed){
	_wasgo_CameraServer_wrapper_add_feed(wasgo_id, ((Variant) feed).get_wasgo_id());
}
...
CameraFeed CameraServer::get_feed(int p_index){
	return CameraFeed::from_wasgo_id(_wasgo_CameraServer_wrapper_get_feed(wasgo_id, index));
}
...
void CameraServer::remove_feed(CameraFeed p_feed){
	_wasgo_CameraServer_wrapper_remove_feed(wasgo_id, ((Variant) feed).get_wasgo_id());
}

CameraServer::CameraServer(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
