...
void VisualShaderNodeVec3Constant::set_constant(Vector3 p_value){
	_wasgo_VisualShaderNodeVec3Constant_wrapper_set_constant(wasgo_id, ((Variant) value).get_wasgo_id());
}

VisualShaderNodeVec3Constant::VisualShaderNodeVec3Constant(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
