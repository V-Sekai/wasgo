...
void TreeItem::add_button(int p_column, Texture p_button, int p_button_idx, bool p_disabled, String p_tooltip){
	...
	_wasgo_TreeItem_wrapper_add_button(wasgo_id, p_column, p_button._get_wasgo_id(), -69, p_button_idx, p_disabled, wasgo_buffer_tooltip, wasgo_size_tooltip);
}
Variant TreeItem::call_recursive(String p_method){
    ...
    _wasgo_TreeItem_wrapper_call_recursive(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_method, wasgo_size_method);
...
String TreeItem::get_button_tooltip(int p_column, int p_button_idx){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_TreeItem_wrapper_get_button_tooltip(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column, p_button_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Color TreeItem::get_custom_bg_color(int p_column){
    ...
    _wasgo_TreeItem_wrapper_get_custom_bg_color(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Color TreeItem::get_custom_color(int p_column){
    ...
    int wasgo_ret_buffer_size = 20;
    uint8_t wasgo_ret_buffer[20];
    _wasgo_TreeItem_wrapper_get_custom_color(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Color TreeItem::get_icon_modulate(int p_column){
    ...
    int wasgo_ret_buffer_size = 20;
    uint8_t wasgo_ret_buffer[20];
    _wasgo_TreeItem_wrapper_get_icon_modulate(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Rect2 TreeItem::get_icon_region(int p_column){
    ...
    int wasgo_ret_buffer_size = 20;
    uint8_t wasgo_ret_buffer[20];
    _wasgo_TreeItem_wrapper_get_icon_region(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant TreeItem::get_metadata(int p_column){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_TreeItem_wrapper_get_metadata(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
String TreeItem::get_suffix(int p_column){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_TreeItem_wrapper_get_suffix(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
String TreeItem::get_text(int p_column){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_TreeItem_wrapper_get_text(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
String TreeItem::get_tooltip(int p_column){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_TreeItem_wrapper_get_tooltip(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_column);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void TreeItem::set_button(int p_column, int p_button_idx, Texture p_button){
	_wasgo_TreeItem_wrapper_set_button(wasgo_id, p_column, p_button_idx, -69, p_button._get_wasgo_id());
}
void TreeItem::set_button_disabled(int p_column, int p_button_idx, bool p_disabled){
	_wasgo_TreeItem_wrapper_set_button_disabled(wasgo_id, p_column, p_button_idx, -69, p_disabled);
}
...
void TreeItem::set_custom_bg_color(int p_column, Color p_color, bool p_just_outline){
	...
	_wasgo_TreeItem_wrapper_set_custom_bg_color(wasgo_id, p_column, wasgo_buffer_color, wasgo_size_color, wasgo_size_color, p_just_outline);
}
void TreeItem::set_custom_color(int p_column, Color p_color){
	...
	_wasgo_TreeItem_wrapper_set_custom_color(wasgo_id, p_column, wasgo_buffer_color, wasgo_size_color, wasgo_size_color);
}
void TreeItem::set_custom_draw(int p_column, Object p_object, String p_callback){
	...
	_wasgo_TreeItem_wrapper_set_custom_draw(wasgo_id, p_column, p_object._get_wasgo_id(), -69, wasgo_buffer_callback, wasgo_size_callback);
}
...
void TreeItem::set_icon_modulate(int p_column, Color p_modulate){
	...
	_wasgo_TreeItem_wrapper_set_icon_modulate(wasgo_id, p_column, wasgo_buffer_modulate, wasgo_size_modulate, wasgo_size_modulate);
}
void TreeItem::set_icon_region(int p_column, Rect2 p_region){
	...
	_wasgo_TreeItem_wrapper_set_icon_region(wasgo_id, p_column, wasgo_buffer_region, wasgo_size_region, wasgo_size_region);
}
void TreeItem::set_metadata(int p_column, Variant p_meta){
	...
	_wasgo_TreeItem_wrapper_set_metadata(wasgo_id, p_column, wasgo_buffer_meta, wasgo_size_meta, wasgo_size_meta);
}
...
void TreeItem::set_range_config(int p_column, float p_min, float p_max, float p_step, bool p_expr){
	_wasgo_TreeItem_wrapper_set_range_config(wasgo_id, p_column, p_min, -69, p_max, p_step, p_expr);
}
...
void TreeItem::set_suffix(int p_column, String p_text){
	...
	_wasgo_TreeItem_wrapper_set_suffix(wasgo_id, p_column, wasgo_buffer_text, wasgo_size_text, wasgo_size_text);
}
void TreeItem::set_text(int p_column, String p_text){
	...
	_wasgo_TreeItem_wrapper_set_text(wasgo_id, p_column, wasgo_buffer_text, wasgo_size_text, wasgo_size_text);
}
...
void TreeItem::set_tooltip(int p_column, String p_tooltip){
	...
	_wasgo_TreeItem_wrapper_set_tooltip(wasgo_id, p_column, wasgo_buffer_tooltip, wasgo_size_tooltip, wasgo_size_tooltip);
}
