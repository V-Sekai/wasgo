...
void VisualShaderNodeScalarFunc::set_function(VisualShaderNodeScalarFunc::Function p_func){
	_wasgo_VisualShaderNodeScalarFunc_wrapper_set_function(wasgo_id, ((Variant) func).get_wasgo_id());
}

VisualShaderNodeScalarFunc::VisualShaderNodeScalarFunc(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
