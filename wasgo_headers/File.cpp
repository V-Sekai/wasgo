...
bool File::file_exists(String p_path){
	return (bool) _wasgo_File_wrapper_file_exists(wasgo_id, ((Variant) p_path).get_wasgo_id());
}
int File::get_16(){
...
PoolByteArray File::get_buffer(int p_len){
	return PoolByteArray::from_wasgo_id(_wasgo_File_wrapper_get_buffer(wasgo_id, p_len));
}
PoolStringArray File::get_csv_line(String p_delim = String(,)){
	return PoolStringArray::from_wasgo_id(_wasgo_File_wrapper_get_csv_line(wasgo_id, ((Variant) p_delim).get_wasgo_id()));
}
...
String File::get_md5(String p_path){
	return String::from_wasgo_id(_wasgo_File_wrapper_get_md5(wasgo_id, ((Variant) p_path).get_wasgo_id()));
}
int File::get_modified_time(String p_file){
	return (int) _wasgo_File_wrapper_get_modified_time(wasgo_id, ((Variant) p_file).get_wasgo_id());
}
...
String File::get_sha256(String p_path){
	return String::from_wasgo_id(_wasgo_File_wrapper_get_sha256(wasgo_id, ((Variant) p_path).get_wasgo_id()));
}
Variant File::get_var(bool p_allow_objects = (bool) false){
	return Variant::from_wasgo_id(_wasgo_File_wrapper_get_var(wasgo_id, p_allow_objects));
}
bool File::is_open(){
	return (bool) _wasgo_File_wrapper_is_open(wasgo_id);
}
Error File::open(String p_path, File::ModeFlags p_flags){
	return Error::from_wasgo_id(_wasgo_File_wrapper_open(wasgo_id, ((Variant) p_path).get_wasgo_id(), ((Variant) p_flags).get_wasgo_id()));
}
Error File::open_compressed(String p_path, File::ModeFlags p_mode_flags, File::CompressionMode p_compression_mode = (File::CompressionMode) 0){
	return Error::from_wasgo_id(_wasgo_File_wrapper_open_compressed(wasgo_id, ((Variant) p_path).get_wasgo_id(), ((Variant) p_mode_flags).get_wasgo_id(), ((Variant) p_compression_mode).get_wasgo_id()));
}
Error File::open_encrypted(String p_path, File::ModeFlags p_mode_flags, PoolByteArray p_key){
	return Error::from_wasgo_id(_wasgo_File_wrapper_open_encrypted(wasgo_id, ((Variant) p_path).get_wasgo_id(), ((Variant) p_mode_flags).get_wasgo_id(), ((Variant) p_key).get_wasgo_id()));
}
Error File::open_encrypted_with_pass(String p_path, File::ModeFlags p_mode_flags, String p_pass){
	return Error::from_wasgo_id(_wasgo_File_wrapper_open_encrypted_with_pass(wasgo_id, ((Variant) p_path).get_wasgo_id(), ((Variant) p_mode_flags).get_wasgo_id(), ((Variant) p_pass).get_wasgo_id()));
}
...
void File::store_buffer(PoolByteArray p_buffer){
	_wasgo_File_wrapper_store_buffer(wasgo_id, ((Variant) p_buffer).get_wasgo_id());
}
void File::store_csv_line(PoolStringArray p_values, String p_delim = String(,)){
	_wasgo_File_wrapper_store_csv_line(wasgo_id, ((Variant) p_values).get_wasgo_id(), ((Variant) p_delim).get_wasgo_id());
}
...
void File::store_line(String p_line){
	_wasgo_File_wrapper_store_line(wasgo_id, ((Variant) p_line).get_wasgo_id());
}
void File::store_pascal_string(String p_string){
	_wasgo_File_wrapper_store_pascal_string(wasgo_id, ((Variant) p_string).get_wasgo_id());
}
void File::store_real(float p_value){
	_wasgo_File_wrapper_store_real(wasgo_id, p_value);
}
void File::store_string(String p_string){
	_wasgo_File_wrapper_store_string(wasgo_id, ((Variant) p_string).get_wasgo_id());
}
void File::store_var(Variant p_value, bool p_full_objects = (bool) false){
	_wasgo_File_wrapper_store_var(wasgo_id, ((Variant) p_value).get_wasgo_id(), p_full_objects);
}