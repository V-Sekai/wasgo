...
void DirectionalLight::set_shadow_depth_range(DirectionalLight::ShadowDepthRange p_mode){
	_wasgo_DirectionalLight_wrapper_set_shadow_depth_range(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void DirectionalLight::set_shadow_mode(DirectionalLight::ShadowMode p_mode){
	_wasgo_DirectionalLight_wrapper_set_shadow_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}