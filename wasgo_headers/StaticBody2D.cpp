...
void StaticBody2D::set_bounce(float p_bounce){
	_wasgo_StaticBody2D_wrapper_set_bounce(wasgo_id, bounce);
}
void StaticBody2D::set_constant_angular_velocity(float p_vel){
	_wasgo_StaticBody2D_wrapper_set_constant_angular_velocity(wasgo_id, vel);
}
void StaticBody2D::set_constant_linear_velocity(Vector2 p_vel){
	_wasgo_StaticBody2D_wrapper_set_constant_linear_velocity(wasgo_id, ((Variant) vel).get_wasgo_id());
}
void StaticBody2D::set_friction(float p_friction){
	_wasgo_StaticBody2D_wrapper_set_friction(wasgo_id, friction);
}
void StaticBody2D::set_physics_material_override(PhysicsMaterial p_physics_material_override){
	_wasgo_StaticBody2D_wrapper_set_physics_material_override(wasgo_id, ((Variant) physics_material_override).get_wasgo_id());
}

StaticBody2D::StaticBody2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
