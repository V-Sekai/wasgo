...
bool SpatialMaterial::get_feature(SpatialMaterial::Feature p_feature){
	return (bool) _wasgo_SpatialMaterial_wrapper_get_feature(wasgo_id, ((Variant) feature).get_wasgo_id()));
}
bool SpatialMaterial::get_flag(SpatialMaterial::Flags p_flag){
	return (bool) _wasgo_SpatialMaterial_wrapper_get_flag(wasgo_id, ((Variant) flag).get_wasgo_id()));
}
...
Texture SpatialMaterial::get_texture(SpatialMaterial::TextureParam p_param){
	return Texture::from_wasgo_id(_wasgo_SpatialMaterial_wrapper_get_texture(wasgo_id, ((Variant) param).get_wasgo_id()));
}
...
void SpatialMaterial::set_albedo(Color p_albedo){
	_wasgo_SpatialMaterial_wrapper_set_albedo(wasgo_id, ((Variant) albedo).get_wasgo_id());
}
void SpatialMaterial::set_alpha_scissor_threshold(float p_threshold){
	_wasgo_SpatialMaterial_wrapper_set_alpha_scissor_threshold(wasgo_id, threshold);
}
void SpatialMaterial::set_anisotropy(float p_anisotropy){
	_wasgo_SpatialMaterial_wrapper_set_anisotropy(wasgo_id, anisotropy);
}
void SpatialMaterial::set_ao_light_affect(float p_amount){
	_wasgo_SpatialMaterial_wrapper_set_ao_light_affect(wasgo_id, amount);
}
void SpatialMaterial::set_ao_texture_channel(SpatialMaterial::TextureChannel p_channel){
	_wasgo_SpatialMaterial_wrapper_set_ao_texture_channel(wasgo_id, ((Variant) channel).get_wasgo_id());
}
void SpatialMaterial::set_billboard_mode(SpatialMaterial::BillboardMode p_mode){
	_wasgo_SpatialMaterial_wrapper_set_billboard_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void SpatialMaterial::set_blend_mode(SpatialMaterial::BlendMode p_blend_mode){
	_wasgo_SpatialMaterial_wrapper_set_blend_mode(wasgo_id, ((Variant) blend_mode).get_wasgo_id());
}
void SpatialMaterial::set_clearcoat(float p_clearcoat){
	_wasgo_SpatialMaterial_wrapper_set_clearcoat(wasgo_id, clearcoat);
}
void SpatialMaterial::set_clearcoat_gloss(float p_clearcoat_gloss){
	_wasgo_SpatialMaterial_wrapper_set_clearcoat_gloss(wasgo_id, clearcoat_gloss);
}
void SpatialMaterial::set_cull_mode(SpatialMaterial::CullMode p_cull_mode){
	_wasgo_SpatialMaterial_wrapper_set_cull_mode(wasgo_id, ((Variant) cull_mode).get_wasgo_id());
}
void SpatialMaterial::set_depth_deep_parallax(bool p_enable){
	_wasgo_SpatialMaterial_wrapper_set_depth_deep_parallax(wasgo_id, enable);
}
void SpatialMaterial::set_depth_deep_parallax_flip_binormal(bool p_flip){
	_wasgo_SpatialMaterial_wrapper_set_depth_deep_parallax_flip_binormal(wasgo_id, flip);
}
void SpatialMaterial::set_depth_deep_parallax_flip_tangent(bool p_flip){
	_wasgo_SpatialMaterial_wrapper_set_depth_deep_parallax_flip_tangent(wasgo_id, flip);
}
void SpatialMaterial::set_depth_deep_parallax_max_layers(int p_layer){
	_wasgo_SpatialMaterial_wrapper_set_depth_deep_parallax_max_layers(wasgo_id, layer);
}
void SpatialMaterial::set_depth_deep_parallax_min_layers(int p_layer){
	_wasgo_SpatialMaterial_wrapper_set_depth_deep_parallax_min_layers(wasgo_id, layer);
}
void SpatialMaterial::set_depth_draw_mode(SpatialMaterial::DepthDrawMode p_depth_draw_mode){
	_wasgo_SpatialMaterial_wrapper_set_depth_draw_mode(wasgo_id, ((Variant) depth_draw_mode).get_wasgo_id());
}
void SpatialMaterial::set_depth_scale(float p_depth_scale){
	_wasgo_SpatialMaterial_wrapper_set_depth_scale(wasgo_id, depth_scale);
}
void SpatialMaterial::set_detail_blend_mode(SpatialMaterial::BlendMode p_detail_blend_mode){
	_wasgo_SpatialMaterial_wrapper_set_detail_blend_mode(wasgo_id, ((Variant) detail_blend_mode).get_wasgo_id());
}
void SpatialMaterial::set_detail_uv(SpatialMaterial::DetailUV p_detail_uv){
	_wasgo_SpatialMaterial_wrapper_set_detail_uv(wasgo_id, ((Variant) detail_uv).get_wasgo_id());
}
void SpatialMaterial::set_diffuse_mode(SpatialMaterial::DiffuseMode p_diffuse_mode){
	_wasgo_SpatialMaterial_wrapper_set_diffuse_mode(wasgo_id, ((Variant) diffuse_mode).get_wasgo_id());
}
void SpatialMaterial::set_distance_fade(SpatialMaterial::DistanceFadeMode p_mode){
	_wasgo_SpatialMaterial_wrapper_set_distance_fade(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void SpatialMaterial::set_distance_fade_max_distance(float p_distance){
	_wasgo_SpatialMaterial_wrapper_set_distance_fade_max_distance(wasgo_id, distance);
}
void SpatialMaterial::set_distance_fade_min_distance(float p_distance){
	_wasgo_SpatialMaterial_wrapper_set_distance_fade_min_distance(wasgo_id, distance);
}
void SpatialMaterial::set_emission(Color p_emission){
	_wasgo_SpatialMaterial_wrapper_set_emission(wasgo_id, ((Variant) emission).get_wasgo_id());
}
void SpatialMaterial::set_emission_energy(float p_emission_energy){
	_wasgo_SpatialMaterial_wrapper_set_emission_energy(wasgo_id, emission_energy);
}
void SpatialMaterial::set_emission_operator(SpatialMaterial::EmissionOperator p_operator){
	_wasgo_SpatialMaterial_wrapper_set_emission_operator(wasgo_id, ((Variant) operator).get_wasgo_id());
}
void SpatialMaterial::set_feature(SpatialMaterial::Feature p_feature, bool p_enable){
	_wasgo_SpatialMaterial_wrapper_set_feature(wasgo_id, ((Variant) feature).get_wasgo_id(), enable);
}
void SpatialMaterial::set_flag(SpatialMaterial::Flags p_flag, bool p_enable){
	_wasgo_SpatialMaterial_wrapper_set_flag(wasgo_id, ((Variant) flag).get_wasgo_id(), enable);
}
void SpatialMaterial::set_grow(float p_amount){
	_wasgo_SpatialMaterial_wrapper_set_grow(wasgo_id, amount);
}
void SpatialMaterial::set_grow_enabled(bool p_enable){
	_wasgo_SpatialMaterial_wrapper_set_grow_enabled(wasgo_id, enable);
}
void SpatialMaterial::set_line_width(float p_line_width){
	_wasgo_SpatialMaterial_wrapper_set_line_width(wasgo_id, line_width);
}
void SpatialMaterial::set_metallic(float p_metallic){
	_wasgo_SpatialMaterial_wrapper_set_metallic(wasgo_id, metallic);
}
void SpatialMaterial::set_metallic_texture_channel(SpatialMaterial::TextureChannel p_channel){
	_wasgo_SpatialMaterial_wrapper_set_metallic_texture_channel(wasgo_id, ((Variant) channel).get_wasgo_id());
}
void SpatialMaterial::set_normal_scale(float p_normal_scale){
	_wasgo_SpatialMaterial_wrapper_set_normal_scale(wasgo_id, normal_scale);
}
void SpatialMaterial::set_particles_anim_h_frames(int p_frames){
	_wasgo_SpatialMaterial_wrapper_set_particles_anim_h_frames(wasgo_id, frames);
}
void SpatialMaterial::set_particles_anim_loop(bool p_loop){
	_wasgo_SpatialMaterial_wrapper_set_particles_anim_loop(wasgo_id, loop);
}
void SpatialMaterial::set_particles_anim_v_frames(int p_frames){
	_wasgo_SpatialMaterial_wrapper_set_particles_anim_v_frames(wasgo_id, frames);
}
void SpatialMaterial::set_point_size(float p_point_size){
	_wasgo_SpatialMaterial_wrapper_set_point_size(wasgo_id, point_size);
}
void SpatialMaterial::set_proximity_fade(bool p_enabled){
	_wasgo_SpatialMaterial_wrapper_set_proximity_fade(wasgo_id, enabled);
}
void SpatialMaterial::set_proximity_fade_distance(float p_distance){
	_wasgo_SpatialMaterial_wrapper_set_proximity_fade_distance(wasgo_id, distance);
}
void SpatialMaterial::set_refraction(float p_refraction){
	_wasgo_SpatialMaterial_wrapper_set_refraction(wasgo_id, refraction);
}
void SpatialMaterial::set_refraction_texture_channel(SpatialMaterial::TextureChannel p_channel){
	_wasgo_SpatialMaterial_wrapper_set_refraction_texture_channel(wasgo_id, ((Variant) channel).get_wasgo_id());
}
void SpatialMaterial::set_rim(float p_rim){
	_wasgo_SpatialMaterial_wrapper_set_rim(wasgo_id, rim);
}
void SpatialMaterial::set_rim_tint(float p_rim_tint){
	_wasgo_SpatialMaterial_wrapper_set_rim_tint(wasgo_id, rim_tint);
}
void SpatialMaterial::set_roughness(float p_roughness){
	_wasgo_SpatialMaterial_wrapper_set_roughness(wasgo_id, roughness);
}
void SpatialMaterial::set_roughness_texture_channel(SpatialMaterial::TextureChannel p_channel){
	_wasgo_SpatialMaterial_wrapper_set_roughness_texture_channel(wasgo_id, ((Variant) channel).get_wasgo_id());
}
void SpatialMaterial::set_specular(float p_specular){
	_wasgo_SpatialMaterial_wrapper_set_specular(wasgo_id, specular);
}
void SpatialMaterial::set_specular_mode(SpatialMaterial::SpecularMode p_specular_mode){
	_wasgo_SpatialMaterial_wrapper_set_specular_mode(wasgo_id, ((Variant) specular_mode).get_wasgo_id());
}
void SpatialMaterial::set_subsurface_scattering_strength(float p_strength){
	_wasgo_SpatialMaterial_wrapper_set_subsurface_scattering_strength(wasgo_id, strength);
}
void SpatialMaterial::set_texture(SpatialMaterial::TextureParam p_param, Texture p_texture){
	_wasgo_SpatialMaterial_wrapper_set_texture(wasgo_id, ((Variant) param).get_wasgo_id(), ((Variant) texture).get_wasgo_id());
}
void SpatialMaterial::set_transmission(Color p_transmission){
	_wasgo_SpatialMaterial_wrapper_set_transmission(wasgo_id, ((Variant) transmission).get_wasgo_id());
}
void SpatialMaterial::set_uv1_offset(Vector3 p_offset){
	_wasgo_SpatialMaterial_wrapper_set_uv1_offset(wasgo_id, ((Variant) offset).get_wasgo_id());
}
void SpatialMaterial::set_uv1_scale(Vector3 p_scale){
	_wasgo_SpatialMaterial_wrapper_set_uv1_scale(wasgo_id, ((Variant) scale).get_wasgo_id());
}
void SpatialMaterial::set_uv1_triplanar_blend_sharpness(float p_sharpness){
	_wasgo_SpatialMaterial_wrapper_set_uv1_triplanar_blend_sharpness(wasgo_id, sharpness);
}
void SpatialMaterial::set_uv2_offset(Vector3 p_offset){
	_wasgo_SpatialMaterial_wrapper_set_uv2_offset(wasgo_id, ((Variant) offset).get_wasgo_id());
}
void SpatialMaterial::set_uv2_scale(Vector3 p_scale){
	_wasgo_SpatialMaterial_wrapper_set_uv2_scale(wasgo_id, ((Variant) scale).get_wasgo_id());
}
void SpatialMaterial::set_uv2_triplanar_blend_sharpness(float p_sharpness){
	_wasgo_SpatialMaterial_wrapper_set_uv2_triplanar_blend_sharpness(wasgo_id, sharpness);
}

SpatialMaterial::SpatialMaterial(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
