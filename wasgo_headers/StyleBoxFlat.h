...
WasGoId _wasgo_StyleBoxFlat_wrapper_get_bg_color(WasGoId wasgo_id);
int _wasgo_StyleBoxFlat_wrapper_get_border_blend(WasGoId wasgo_id);
WasGoId _wasgo_StyleBoxFlat_wrapper_get_border_color(WasGoId wasgo_id);
...
WasGoId _wasgo_StyleBoxFlat_wrapper_get_shadow_color(WasGoId wasgo_id);
WasGoId _wasgo_StyleBoxFlat_wrapper_get_shadow_offset(WasGoId wasgo_id);
...
void _wasgo_StyleBoxFlat_wrapper_set_bg_color(WasGoId wasgo_id, WasGoId p_color);
void _wasgo_StyleBoxFlat_wrapper_set_border_blend(WasGoId wasgo_id, bool p_blend);
void _wasgo_StyleBoxFlat_wrapper_set_border_color(WasGoId wasgo_id, WasGoId p_color);
...
void _wasgo_StyleBoxFlat_wrapper_set_shadow_color(WasGoId wasgo_id, WasGoId p_color);
void _wasgo_StyleBoxFlat_wrapper_set_shadow_offset(WasGoId wasgo_id, WasGoId p_offset);
