...
//Wrapper Functions
extern "C"{
WasGo::WasGoId _wasgo_CanvasLayer_wrapper_get_canvas(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_CanvasLayer_wrapper_get_custom_viewport(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_CanvasLayer_wrapper_get_offset(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_CanvasLayer_wrapper_get_scale(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_CanvasLayer_wrapper_get_transform(WasGoId wasgo_id);
int _wasgo_CanvasLayer_wrapper_is_following_viewport(WasGoId wasgo_id);
void _wasgo_CanvasLayer_wrapper_set_custom_viewport(WasGoId wasgo_id, WasGo::WasGoId p_viewport);
...
void _wasgo_CanvasLayer_wrapper_set_offset(WasGoId wasgo_id, WasGo::WasGoId p_offset);
...
void _wasgo_CanvasLayer_wrapper_set_scale(WasGoId wasgo_id, WasGo::WasGoId p_scale);
void _wasgo_CanvasLayer_wrapper_set_transform(WasGoId wasgo_id, WasGo::WasGoId p_transform);
}
#endif