...
Object PhysicsShapeQueryResult::get_result_object(int p_idx){
	return Object::from_wasgo_id(_wasgo_PhysicsShapeQueryResult_wrapper_get_result_object(wasgo_id, p_idx));
}
...
RID PhysicsShapeQueryResult::get_result_rid(int p_idx){
	return RID::from_wasgo_id(_wasgo_PhysicsShapeQueryResult_wrapper_get_result_rid(wasgo_id, p_idx));
}