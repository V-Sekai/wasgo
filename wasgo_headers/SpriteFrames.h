...
void _wasgo_SpriteFrames_wrapper_add_frame(WasGoID wasgo_id, const uint8_t * p_anim, int p_anim_wasgo_buffer_size, int wasgo_throwaway, WasGoID p_frame, int p_at_position);
...
WasGoID _wasgo_SpriteFrames_wrapper_get_frame(WasGoID wasgo_id, const uint8_t * p_anim, int p_anim_wasgo_buffer_size, int wasgo_throwaway, int p_idx);
...
void _wasgo_SpriteFrames_wrapper_remove_frame(WasGoID wasgo_id, const uint8_t * p_anim, int p_anim_wasgo_buffer_size, int wasgo_throwaway, int p_idx);
void _wasgo_SpriteFrames_wrapper_rename_animation(WasGoID wasgo_id, const uint8_t * p_anim, int p_anim_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_newname, int p_newname_wasgo_buffer_size);
void _wasgo_SpriteFrames_wrapper_set_animation_loop(WasGoID wasgo_id, const uint8_t * p_anim, int p_anim_wasgo_buffer_size, int wasgo_throwaway, bool p_loop);
void _wasgo_SpriteFrames_wrapper_set_animation_speed(WasGoID wasgo_id, const uint8_t * p_anim, int p_anim_wasgo_buffer_size, int wasgo_throwaway, float p_speed);
void _wasgo_SpriteFrames_wrapper_set_frame(WasGoID wasgo_id, const uint8_t * p_anim, int p_anim_wasgo_buffer_size, int wasgo_throwaway, int p_idx, WasGoID p_txt);
