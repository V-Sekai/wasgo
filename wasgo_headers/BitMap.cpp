...
void BitMap::create(Vector2 p_size){
	_wasgo_BitMap_wrapper_create(wasgo_id, ((Variant) p_size).get_wasgo_id());
}
void BitMap::create_from_image_alpha(Image p_image, float p_threshold = (float) 0.1){
	_wasgo_BitMap_wrapper_create_from_image_alpha(wasgo_id, ((Variant) p_image).get_wasgo_id(), p_threshold);
}
bool BitMap::get_bit(Vector2 p_position){
	return (bool) _wasgo_BitMap_wrapper_get_bit(wasgo_id, ((Variant) p_position).get_wasgo_id());
}
...
void BitMap::set_bit(Vector2 p_position, bool p_bit){
	_wasgo_BitMap_wrapper_set_bit(wasgo_id, ((Variant) p_position).get_wasgo_id(), p_bit);
}
void BitMap::set_bit_rect(Rect2 p_rect, bool p_bit){
	_wasgo_BitMap_wrapper_set_bit_rect(wasgo_id, ((Variant) p_rect).get_wasgo_id(), p_bit);
}