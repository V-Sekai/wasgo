...
void AStar2D::add_point(int p_id, Vector2 p_position, float p_weight_scale){
	...
	_wasgo_AStar2D_wrapper_add_point(wasgo_id, p_id, wasgo_buffer_position, wasgo_size_position, wasgo_size_position, p_weight_scale);
}
...
void AStar2D::connect_points(int p_id, int p_to_id, bool p_bidirectional){
	_wasgo_AStar2D_wrapper_connect_points(wasgo_id, p_id, p_to_id, -69, p_bidirectional);
}
...
int AStar2D::get_closest_point(Vector2 p_to_position, bool p_include_disabled){
	...
	return (int) _wasgo_AStar2D_wrapper_get_closest_point(wasgo_id, wasgo_buffer_to_position, wasgo_size_to_position, -69, p_include_disabled);
}
Vector2 AStar2D::get_closest_position_in_segment(Vector2 p_to_position){
    ...
    _wasgo_AStar2D_wrapper_get_closest_position_in_segment(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_to_position, wasgo_size_to_position);
...
Vector2 AStar2D::get_point_position(int p_id){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_AStar2D_wrapper_get_point_position(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_id);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void AStar2D::set_point_position(int p_id, Vector2 p_position){
	...
	_wasgo_AStar2D_wrapper_set_point_position(wasgo_id, p_id, wasgo_buffer_position, wasgo_size_position, wasgo_size_position);
}
