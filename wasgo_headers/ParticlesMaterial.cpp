...
bool ParticlesMaterial::get_flag(ParticlesMaterial::Flags p_flag){
	return (bool) _wasgo_ParticlesMaterial_wrapper_get_flag(wasgo_id, ((Variant) flag).get_wasgo_id()));
}
...
float ParticlesMaterial::get_param(ParticlesMaterial::Parameter p_param){
	return (float) _wasgo_ParticlesMaterial_wrapper_get_param(wasgo_id, ((Variant) param).get_wasgo_id()));
}
float ParticlesMaterial::get_param_randomness(ParticlesMaterial::Parameter p_param){
	return (float) _wasgo_ParticlesMaterial_wrapper_get_param_randomness(wasgo_id, ((Variant) param).get_wasgo_id()));
}
Texture ParticlesMaterial::get_param_texture(ParticlesMaterial::Parameter p_param){
	return Texture::from_wasgo_id(_wasgo_ParticlesMaterial_wrapper_get_param_texture(wasgo_id, ((Variant) param).get_wasgo_id()));
}
...
void ParticlesMaterial::set_color(Color p_color){
	_wasgo_ParticlesMaterial_wrapper_set_color(wasgo_id, ((Variant) color).get_wasgo_id());
}
void ParticlesMaterial::set_color_ramp(Texture p_ramp){
	_wasgo_ParticlesMaterial_wrapper_set_color_ramp(wasgo_id, ((Variant) ramp).get_wasgo_id());
}
void ParticlesMaterial::set_direction(Vector3 p_degrees){
	_wasgo_ParticlesMaterial_wrapper_set_direction(wasgo_id, ((Variant) degrees).get_wasgo_id());
}
void ParticlesMaterial::set_emission_box_extents(Vector3 p_extents){
	_wasgo_ParticlesMaterial_wrapper_set_emission_box_extents(wasgo_id, ((Variant) extents).get_wasgo_id());
}
void ParticlesMaterial::set_emission_color_texture(Texture p_texture){
	_wasgo_ParticlesMaterial_wrapper_set_emission_color_texture(wasgo_id, ((Variant) texture).get_wasgo_id());
}
void ParticlesMaterial::set_emission_normal_texture(Texture p_texture){
	_wasgo_ParticlesMaterial_wrapper_set_emission_normal_texture(wasgo_id, ((Variant) texture).get_wasgo_id());
}
void ParticlesMaterial::set_emission_point_count(int p_point_count){
	_wasgo_ParticlesMaterial_wrapper_set_emission_point_count(wasgo_id, point_count);
}
void ParticlesMaterial::set_emission_point_texture(Texture p_texture){
	_wasgo_ParticlesMaterial_wrapper_set_emission_point_texture(wasgo_id, ((Variant) texture).get_wasgo_id());
}
void ParticlesMaterial::set_emission_shape(ParticlesMaterial::EmissionShape p_shape){
	_wasgo_ParticlesMaterial_wrapper_set_emission_shape(wasgo_id, ((Variant) shape).get_wasgo_id());
}
void ParticlesMaterial::set_emission_sphere_radius(float p_radius){
	_wasgo_ParticlesMaterial_wrapper_set_emission_sphere_radius(wasgo_id, radius);
}
void ParticlesMaterial::set_flag(ParticlesMaterial::Flags p_flag, bool p_enable){
	_wasgo_ParticlesMaterial_wrapper_set_flag(wasgo_id, ((Variant) flag).get_wasgo_id(), enable);
}
void ParticlesMaterial::set_flatness(float p_amount){
	_wasgo_ParticlesMaterial_wrapper_set_flatness(wasgo_id, amount);
}
void ParticlesMaterial::set_gravity(Vector3 p_accel_vec){
	_wasgo_ParticlesMaterial_wrapper_set_gravity(wasgo_id, ((Variant) accel_vec).get_wasgo_id());
}
void ParticlesMaterial::set_lifetime_randomness(float p_randomness){
	_wasgo_ParticlesMaterial_wrapper_set_lifetime_randomness(wasgo_id, randomness);
}
void ParticlesMaterial::set_param(ParticlesMaterial::Parameter p_param, float p_value){
	_wasgo_ParticlesMaterial_wrapper_set_param(wasgo_id, ((Variant) param).get_wasgo_id(), value);
}
void ParticlesMaterial::set_param_randomness(ParticlesMaterial::Parameter p_param, float p_randomness){
	_wasgo_ParticlesMaterial_wrapper_set_param_randomness(wasgo_id, ((Variant) param).get_wasgo_id(), randomness);
}
void ParticlesMaterial::set_param_texture(ParticlesMaterial::Parameter p_param, Texture p_texture){
	_wasgo_ParticlesMaterial_wrapper_set_param_texture(wasgo_id, ((Variant) param).get_wasgo_id(), ((Variant) texture).get_wasgo_id());
}
void ParticlesMaterial::set_spread(float p_degrees){
	_wasgo_ParticlesMaterial_wrapper_set_spread(wasgo_id, degrees);
}
void ParticlesMaterial::set_trail_color_modifier(GradientTexture p_texture){
	_wasgo_ParticlesMaterial_wrapper_set_trail_color_modifier(wasgo_id, ((Variant) texture).get_wasgo_id());
}
void ParticlesMaterial::set_trail_divisor(int p_divisor){
	_wasgo_ParticlesMaterial_wrapper_set_trail_divisor(wasgo_id, divisor);
}
void ParticlesMaterial::set_trail_size_modifier(CurveTexture p_texture){
	_wasgo_ParticlesMaterial_wrapper_set_trail_size_modifier(wasgo_id, ((Variant) texture).get_wasgo_id());
}

ParticlesMaterial::ParticlesMaterial(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
