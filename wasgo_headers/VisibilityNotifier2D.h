...
//Wrapper Functions
extern "C"{
WasGo::WasGoId _wasgo_VisibilityNotifier2D_wrapper_get_rect(WasGoId wasgo_id);
int _wasgo_VisibilityNotifier2D_wrapper_is_on_screen(WasGoId wasgo_id);
void _wasgo_VisibilityNotifier2D_wrapper_set_rect(WasGoId wasgo_id, WasGo::WasGoId p_rect);
}
#endif