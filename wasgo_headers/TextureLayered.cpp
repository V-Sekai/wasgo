...
void TextureLayered::create(int p_width, int p_height, int p_depth, Image::Format p_format, int p_flags){
	_wasgo_TextureLayered_wrapper_create(wasgo_id, p_width, p_height, p_depth, p_format._get_wasgo_id(), p_flags);
}
...
void TextureLayered::set_data_partial(Image p_image, int p_x_offset, int p_y_offset, int p_layer, int p_mipmap){
	_wasgo_TextureLayered_wrapper_set_data_partial(wasgo_id, p_image._get_wasgo_id(), p_x_offset, p_y_offset, p_layer, p_mipmap);
}
