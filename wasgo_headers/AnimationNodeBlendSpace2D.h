...
//Wrapper Functions
extern "C"{
void _wasgo_AnimationNodeBlendSpace2D_wrapper_add_blend_point(WasGoID wasgo_id, WasGoID p_node, const uint8_t * p_pos, int wasgo_throwaway, int p_pos_wasgo_buffer_size, int p_at_index);
void _wasgo_AnimationNodeBlendSpace2D_wrapper_add_triangle(WasGoID wasgo_id, int p_x, int p_y, int wasgo_throwaway, int p_z, int p_at_index);
...
void _wasgo_AnimationNodeBlendSpace2D_wrapper_get_blend_point_position(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_point);
...
void _wasgo_AnimationNodeBlendSpace2D_wrapper_set_blend_point_position(WasGoID wasgo_id, int p_point, const uint8_t * p_pos, int wasgo_throwaway, int p_pos_wasgo_buffer_size);
