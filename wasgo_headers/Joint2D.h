...
WasGo::WasGoId _wasgo_Joint2D_wrapper_get_node_a(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_Joint2D_wrapper_get_node_b(WasGoId wasgo_id);
...
void _wasgo_Joint2D_wrapper_set_node_a(WasGoId wasgo_id, WasGo::WasGoId p_node);
void _wasgo_Joint2D_wrapper_set_node_b(WasGoId wasgo_id, WasGo::WasGoId p_node);
}
#endif