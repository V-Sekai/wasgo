...
void ARVRInterface::set_anchor_detection_is_enabled(bool p_enable){
	_wasgo_ARVRInterface_wrapper_set_anchor_detection_is_enabled(wasgo_id, enable);
}
void ARVRInterface::set_is_initialized(bool p_initialized){
	_wasgo_ARVRInterface_wrapper_set_is_initialized(wasgo_id, initialized);
}
void ARVRInterface::set_is_primary(bool p_enable){
	_wasgo_ARVRInterface_wrapper_set_is_primary(wasgo_id, enable);
}
