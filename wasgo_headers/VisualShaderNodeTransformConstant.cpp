...
void VisualShaderNodeTransformConstant::set_constant(Transform p_value){
	_wasgo_VisualShaderNodeTransformConstant_wrapper_set_constant(wasgo_id, ((Variant) value).get_wasgo_id());
}

VisualShaderNodeTransformConstant::VisualShaderNodeTransformConstant(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
