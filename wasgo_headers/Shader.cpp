...
Texture Shader::get_default_texture_param(String p_param){
	return Texture::from_wasgo_id(_wasgo_Shader_wrapper_get_default_texture_param(wasgo_id, ((Variant) param).get_wasgo_id()));
}
...
bool Shader::has_param(String p_name){
	return (bool) _wasgo_Shader_wrapper_has_param(wasgo_id, ((Variant) name).get_wasgo_id()));
}
void Shader::set_code(String p_code){
	_wasgo_Shader_wrapper_set_code(wasgo_id, ((Variant) code).get_wasgo_id());
}
void Shader::set_custom_defines(String p_custom_defines){
	_wasgo_Shader_wrapper_set_custom_defines(wasgo_id, ((Variant) custom_defines).get_wasgo_id());
}
void Shader::set_default_texture_param(String p_param, Texture p_texture){
	_wasgo_Shader_wrapper_set_default_texture_param(wasgo_id, ((Variant) param).get_wasgo_id(), ((Variant) texture).get_wasgo_id());
}

Shader::Shader(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Shader::~Shader(){
}