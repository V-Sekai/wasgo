...
void ConcavePolygonShape::set_faces(PoolVector3Array p_faces){
	_wasgo_ConcavePolygonShape_wrapper_set_faces(wasgo_id, ((Variant) faces).get_wasgo_id());
}

ConcavePolygonShape::ConcavePolygonShape(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
