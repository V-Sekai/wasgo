...
void PhysicsDirectBodyState::add_force(Vector3 p_force, Vector3 p_position){
	...
	_wasgo_PhysicsDirectBodyState_wrapper_add_force(wasgo_id, wasgo_buffer_force, wasgo_size_force, wasgo_buffer_position, wasgo_size_position);
}
...
void PhysicsDirectBodyState::apply_impulse(Vector3 p_position, Vector3 p_j){
	...
	_wasgo_PhysicsDirectBodyState_wrapper_apply_impulse(wasgo_id, wasgo_buffer_position, wasgo_size_position, wasgo_buffer_j, wasgo_size_j);
}
...
RID PhysicsDirectBodyState::get_contact_collider(int p_contact_idx){
    ...
    _wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_contact_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
...
Vector3 PhysicsDirectBodyState::get_contact_collider_position(int p_contact_idx){
    ...
    int wasgo_ret_buffer_size = 16;
    uint8_t wasgo_ret_buffer[16];
    _wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider_position(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_contact_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector3) wasgo_ret;
...
Vector3 PhysicsDirectBodyState::get_contact_collider_velocity_at_position(int p_contact_idx){
    ...
    int wasgo_ret_buffer_size = 16;
    uint8_t wasgo_ret_buffer[16];
    _wasgo_PhysicsDirectBodyState_wrapper_get_contact_collider_velocity_at_position(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_contact_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector3) wasgo_ret;
...
Vector3 PhysicsDirectBodyState::get_contact_local_normal(int p_contact_idx){
    ...
    int wasgo_ret_buffer_size = 16;
    uint8_t wasgo_ret_buffer[16];
    _wasgo_PhysicsDirectBodyState_wrapper_get_contact_local_normal(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_contact_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector3) wasgo_ret;
...
Vector3 PhysicsDirectBodyState::get_contact_local_position(int p_contact_idx){
    ...
    int wasgo_ret_buffer_size = 16;
    uint8_t wasgo_ret_buffer[16];
    _wasgo_PhysicsDirectBodyState_wrapper_get_contact_local_position(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, p_contact_idx);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return (Vector3) wasgo_ret;
