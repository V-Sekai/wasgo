...
void AudioStreamPlayer3D::play(float p_from_position = (float) 0){
	_wasgo_AudioStreamPlayer3D_wrapper_play(wasgo_id, from_position);
}
void AudioStreamPlayer3D::seek(float p_to_position){
	_wasgo_AudioStreamPlayer3D_wrapper_seek(wasgo_id, to_position);
}
void AudioStreamPlayer3D::set_autoplay(bool p_enable){
	_wasgo_AudioStreamPlayer3D_wrapper_set_autoplay(wasgo_id, enable);
}
void AudioStreamPlayer3D::set_bus(String p_bus){
	_wasgo_AudioStreamPlayer3D_wrapper_set_bus(wasgo_id, ((Variant) bus).get_wasgo_id());
}
void AudioStreamPlayer3D::set_max_db(float p_max_db){
	_wasgo_AudioStreamPlayer3D_wrapper_set_max_db(wasgo_id, max_db);
}
void AudioStreamPlayer3D::set_pitch_scale(float p_pitch_scale){
	_wasgo_AudioStreamPlayer3D_wrapper_set_pitch_scale(wasgo_id, pitch_scale);
}
void AudioStreamPlayer3D::set_stream(AudioStream p_stream){
	_wasgo_AudioStreamPlayer3D_wrapper_set_stream(wasgo_id, ((Variant) stream).get_wasgo_id());
}
void AudioStreamPlayer3D::set_unit_db(float p_unit_db){
	_wasgo_AudioStreamPlayer3D_wrapper_set_unit_db(wasgo_id, unit_db);
}
void AudioStreamPlayer3D::set_unit_size(float p_unit_size){
	_wasgo_AudioStreamPlayer3D_wrapper_set_unit_size(wasgo_id, unit_size);
}
void AudioStreamPlayer3D::stop(){
	_wasgo_AudioStreamPlayer3D_wrapper_stop(wasgo_id);
}

AudioStreamPlayer3D::AudioStreamPlayer3D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
