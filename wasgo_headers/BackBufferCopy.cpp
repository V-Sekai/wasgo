...
void BackBufferCopy::set_copy_mode(BackBufferCopy::CopyMode p_copy_mode){
	_wasgo_BackBufferCopy_wrapper_set_copy_mode(wasgo_id, ((Variant) p_copy_mode).get_wasgo_id());
}
void BackBufferCopy::set_rect(Rect2 p_rect){
	_wasgo_BackBufferCopy_wrapper_set_rect(wasgo_id, ((Variant) p_rect).get_wasgo_id());
}