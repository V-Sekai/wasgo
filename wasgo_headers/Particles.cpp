...
Mesh Particles::get_draw_pass_mesh(int p_pass){
	return Mesh::from_wasgo_id(_wasgo_Particles_wrapper_get_draw_pass_mesh(wasgo_id, p_pass));
}
...
void Particles::set_draw_order(Particles::DrawOrder p_order){
	_wasgo_Particles_wrapper_set_draw_order(wasgo_id, ((Variant) p_order).get_wasgo_id());
}
void Particles::set_draw_pass_mesh(int p_pass, Mesh p_mesh){
	_wasgo_Particles_wrapper_set_draw_pass_mesh(wasgo_id, p_pass, ((Variant) p_mesh).get_wasgo_id());
}
...
void Particles::set_process_material(Material p_material){
	_wasgo_Particles_wrapper_set_process_material(wasgo_id, ((Variant) p_material).get_wasgo_id());
}
...
void Particles::set_visibility_aabb(::AABB p_aabb){
	_wasgo_Particles_wrapper_set_visibility_aabb(wasgo_id, ((Variant) p_aabb).get_wasgo_id());
}