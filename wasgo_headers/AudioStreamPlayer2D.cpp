...
void AudioStreamPlayer2D::set_bus(String p_bus){
	_wasgo_AudioStreamPlayer2D_wrapper_set_bus(wasgo_id, ((Variant) p_bus).get_wasgo_id());
}
...
void AudioStreamPlayer2D::set_stream(AudioStream p_stream){
	_wasgo_AudioStreamPlayer2D_wrapper_set_stream(wasgo_id, ((Variant) p_stream).get_wasgo_id());
}
