...
void DynamicFontData::set_antialiased(bool p_antialiased){
	_wasgo_DynamicFontData_wrapper_set_antialiased(wasgo_id, antialiased);
}
void DynamicFontData::set_font_path(String p_path){
	_wasgo_DynamicFontData_wrapper_set_font_path(wasgo_id, ((Variant) path).get_wasgo_id());
}
void DynamicFontData::set_hinting(DynamicFontData::Hinting p_mode){
	_wasgo_DynamicFontData_wrapper_set_hinting(wasgo_id, ((Variant) mode).get_wasgo_id());
}

DynamicFontData::DynamicFontData(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
