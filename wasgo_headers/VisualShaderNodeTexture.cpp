...
void VisualShaderNodeTexture::set_source(VisualShaderNodeTexture::Source p_value){
	_wasgo_VisualShaderNodeTexture_wrapper_set_source(wasgo_id, ((Variant) p_value).get_wasgo_id());
}
void VisualShaderNodeTexture::set_texture(Texture p_value){
	_wasgo_VisualShaderNodeTexture_wrapper_set_texture(wasgo_id, ((Variant) p_value).get_wasgo_id());
}
void VisualShaderNodeTexture::set_texture_type(VisualShaderNodeTexture::TextureType p_value){
	_wasgo_VisualShaderNodeTexture_wrapper_set_texture_type(wasgo_id, ((Variant) p_value).get_wasgo_id());
}