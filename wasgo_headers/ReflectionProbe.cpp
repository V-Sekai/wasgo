...
void ReflectionProbe::set_as_interior(bool p_enable){
	_wasgo_ReflectionProbe_wrapper_set_as_interior(wasgo_id, enable);
}
void ReflectionProbe::set_cull_mask(int p_layers){
	_wasgo_ReflectionProbe_wrapper_set_cull_mask(wasgo_id, layers);
}
void ReflectionProbe::set_enable_box_projection(bool p_enable){
	_wasgo_ReflectionProbe_wrapper_set_enable_box_projection(wasgo_id, enable);
}
void ReflectionProbe::set_enable_shadows(bool p_enable){
	_wasgo_ReflectionProbe_wrapper_set_enable_shadows(wasgo_id, enable);
}
void ReflectionProbe::set_extents(Vector3 p_extents){
	_wasgo_ReflectionProbe_wrapper_set_extents(wasgo_id, ((Variant) extents).get_wasgo_id());
}
void ReflectionProbe::set_intensity(float p_intensity){
	_wasgo_ReflectionProbe_wrapper_set_intensity(wasgo_id, intensity);
}
void ReflectionProbe::set_interior_ambient(Color p_ambient){
	_wasgo_ReflectionProbe_wrapper_set_interior_ambient(wasgo_id, ((Variant) ambient).get_wasgo_id());
}
void ReflectionProbe::set_interior_ambient_energy(float p_ambient_energy){
	_wasgo_ReflectionProbe_wrapper_set_interior_ambient_energy(wasgo_id, ambient_energy);
}
void ReflectionProbe::set_interior_ambient_probe_contribution(float p_ambient_probe_contribution){
	_wasgo_ReflectionProbe_wrapper_set_interior_ambient_probe_contribution(wasgo_id, ambient_probe_contribution);
}
void ReflectionProbe::set_max_distance(float p_max_distance){
	_wasgo_ReflectionProbe_wrapper_set_max_distance(wasgo_id, max_distance);
}
void ReflectionProbe::set_origin_offset(Vector3 p_origin_offset){
	_wasgo_ReflectionProbe_wrapper_set_origin_offset(wasgo_id, ((Variant) origin_offset).get_wasgo_id());
}
void ReflectionProbe::set_update_mode(ReflectionProbe::UpdateMode p_mode){
	_wasgo_ReflectionProbe_wrapper_set_update_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}

ReflectionProbe::ReflectionProbe(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
