...
//Wrapper Functions
extern "C"{
WasGo::WasGoId _wasgo_VisualShaderNodeColorFunc_wrapper_get_function(WasGoId wasgo_id);
void _wasgo_VisualShaderNodeColorFunc_wrapper_set_function(WasGoId wasgo_id, WasGo::WasGoId p_func);
}
#endif