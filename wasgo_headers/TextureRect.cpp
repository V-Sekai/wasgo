...
void TextureRect::set_expand(bool p_enable){
	_wasgo_TextureRect_wrapper_set_expand(wasgo_id, enable);
}
void TextureRect::set_flip_h(bool p_enable){
	_wasgo_TextureRect_wrapper_set_flip_h(wasgo_id, enable);
}
void TextureRect::set_flip_v(bool p_enable){
	_wasgo_TextureRect_wrapper_set_flip_v(wasgo_id, enable);
}
void TextureRect::set_stretch_mode(TextureRect::StretchMode p_stretch_mode){
	_wasgo_TextureRect_wrapper_set_stretch_mode(wasgo_id, ((Variant) stretch_mode).get_wasgo_id());
}
void TextureRect::set_texture(Texture p_texture){
	_wasgo_TextureRect_wrapper_set_texture(wasgo_id, ((Variant) texture).get_wasgo_id());
}

TextureRect::TextureRect(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
