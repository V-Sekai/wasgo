...
void OccluderPolygon2D::set_closed(bool p_closed){
	_wasgo_OccluderPolygon2D_wrapper_set_closed(wasgo_id, closed);
}
void OccluderPolygon2D::set_cull_mode(OccluderPolygon2D::CullMode p_cull_mode){
	_wasgo_OccluderPolygon2D_wrapper_set_cull_mode(wasgo_id, ((Variant) cull_mode).get_wasgo_id());
}
void OccluderPolygon2D::set_polygon(PoolVector2Array p_polygon){
	_wasgo_OccluderPolygon2D_wrapper_set_polygon(wasgo_id, ((Variant) polygon).get_wasgo_id());
}

OccluderPolygon2D::OccluderPolygon2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
