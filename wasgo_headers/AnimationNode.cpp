...
void AnimationNode::blend_animation(String p_animation, float p_time, float p_delta, bool p_seeked, float p_blend){
	...
	_wasgo_AnimationNode_wrapper_blend_animation(wasgo_id, wasgo_buffer_animation, wasgo_size_animation, -69, p_time, p_delta, p_seeked, p_blend);
}
float AnimationNode::blend_input(int p_input_index, float p_time, bool p_seek, float p_blend, AnimationNode::FilterAction p_filter, bool p_optimize){
	return (float) _wasgo_AnimationNode_wrapper_blend_input(wasgo_id, p_input_index, p_time, -69, p_seek, p_blend, p_filter._get_wasgo_id(), p_optimize);
}
float AnimationNode::blend_node(String p_name, AnimationNode p_node, float p_time, bool p_seek, float p_blend, AnimationNode::FilterAction p_filter, bool p_optimize){
	...
	return (float) _wasgo_AnimationNode_wrapper_blend_node(wasgo_id, wasgo_buffer_name, wasgo_size_name, -69, p_node._get_wasgo_id(), p_time, p_seek, p_blend, p_filter._get_wasgo_id(), p_optimize);
}
...
String AnimationNode::get_input_name(int p_input){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_AnimationNode_wrapper_get_input_name(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_input);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant AnimationNode::get_parameter(String p_name){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_AnimationNode_wrapper_get_parameter(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_name, wasgo_size_name);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant AnimationNode::get_parameter_default_value(String p_name){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_AnimationNode_wrapper_get_parameter_default_value(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_name, wasgo_size_name);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void AnimationNode::set_filter_path(NodePath p_path, bool p_enable){
	...
	_wasgo_AnimationNode_wrapper_set_filter_path(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, p_enable);
}
void AnimationNode::set_parameter(String p_name, Variant p_value){
	...
	_wasgo_AnimationNode_wrapper_set_parameter(wasgo_id, wasgo_buffer_name, wasgo_size_name, -69, wasgo_buffer_value, wasgo_size_value);
}
