...
void NavigationPolygon::add_outline(PoolVector2Array p_outline){
	_wasgo_NavigationPolygon_wrapper_add_outline(wasgo_id, ((Variant) outline).get_wasgo_id());
}
void NavigationPolygon::add_outline_at_index(PoolVector2Array p_outline, int p_index){
	_wasgo_NavigationPolygon_wrapper_add_outline_at_index(wasgo_id, ((Variant) outline).get_wasgo_id(), index);
}
void NavigationPolygon::add_polygon(PoolIntArray p_polygon){
	_wasgo_NavigationPolygon_wrapper_add_polygon(wasgo_id, ((Variant) polygon).get_wasgo_id());
}
...
PoolVector2Array NavigationPolygon::get_outline(int p_idx){
	return PoolVector2Array::from_wasgo_id(_wasgo_NavigationPolygon_wrapper_get_outline(wasgo_id, idx));
}
...
PoolIntArray NavigationPolygon::get_polygon(int p_idx){
	return PoolIntArray::from_wasgo_id(_wasgo_NavigationPolygon_wrapper_get_polygon(wasgo_id, idx));
}
...
void NavigationPolygon::remove_outline(int p_idx){
	_wasgo_NavigationPolygon_wrapper_remove_outline(wasgo_id, idx);
}
void NavigationPolygon::set_outline(int p_idx, PoolVector2Array p_outline){
	_wasgo_NavigationPolygon_wrapper_set_outline(wasgo_id, idx, ((Variant) outline).get_wasgo_id());
}
void NavigationPolygon::set_vertices(PoolVector2Array p_vertices){
	_wasgo_NavigationPolygon_wrapper_set_vertices(wasgo_id, ((Variant) vertices).get_wasgo_id());
}

NavigationPolygon::NavigationPolygon(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
