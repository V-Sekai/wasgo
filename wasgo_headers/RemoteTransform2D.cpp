...
void RemoteTransform2D::set_remote_node(NodePath p_path){
	_wasgo_RemoteTransform2D_wrapper_set_remote_node(wasgo_id, ((Variant) path).get_wasgo_id());
}
void RemoteTransform2D::set_update_position(bool p_update_remote_position){
	_wasgo_RemoteTransform2D_wrapper_set_update_position(wasgo_id, update_remote_position);
}
void RemoteTransform2D::set_update_rotation(bool p_update_remote_rotation){
	_wasgo_RemoteTransform2D_wrapper_set_update_rotation(wasgo_id, update_remote_rotation);
}
void RemoteTransform2D::set_update_scale(bool p_update_remote_scale){
	_wasgo_RemoteTransform2D_wrapper_set_update_scale(wasgo_id, update_remote_scale);
}
void RemoteTransform2D::set_use_global_coordinates(bool p_use_global_coordinates){
	_wasgo_RemoteTransform2D_wrapper_set_use_global_coordinates(wasgo_id, use_global_coordinates);
}

RemoteTransform2D::RemoteTransform2D(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
