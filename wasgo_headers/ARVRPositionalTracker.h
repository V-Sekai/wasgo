...
void _wasgo_ARVRPositionalTracker_wrapper_get_transform(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, bool p_adjust_by_reference_frame);
