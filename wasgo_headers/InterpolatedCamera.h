...
WasGoId _wasgo_InterpolatedCamera_wrapper_get_target_path(WasGoId wasgo_id);
...
void _wasgo_InterpolatedCamera_wrapper_set_target_path(WasGoId wasgo_id, WasGoId p_target_path);
}
#endif