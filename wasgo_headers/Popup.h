...
void _wasgo_Popup_wrapper_popup(WasGoId wasgo_id, WasGoId p_bounds);
void _wasgo_Popup_wrapper_popup_centered(WasGoId wasgo_id, WasGoId p_size);
void _wasgo_Popup_wrapper_popup_centered_clamped(WasGoId wasgo_id, WasGoId p_size, float p_fallback_ratio);
void _wasgo_Popup_wrapper_popup_centered_minsize(WasGoId wasgo_id, WasGoId p_minsize);
