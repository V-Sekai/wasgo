...
protected:
public:
explicit Physics2DShapeQueryResult(WasGoID p_wasgo_id);
explicit Physics2DShapeQueryResult(Reference other);
Physics2DShapeQueryResult();
Physics2DShapeQueryResult new_instance();
...
void _wasgo_Physics2DShapeQueryResult_wrapper_get_result_rid(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
