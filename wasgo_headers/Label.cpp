...
void Label::set_align(Label::Align p_align){
	_wasgo_Label_wrapper_set_align(wasgo_id, ((Variant) align).get_wasgo_id());
}
void Label::set_autowrap(bool p_enable){
	_wasgo_Label_wrapper_set_autowrap(wasgo_id, enable);
}
void Label::set_clip_text(bool p_enable){
	_wasgo_Label_wrapper_set_clip_text(wasgo_id, enable);
}
void Label::set_lines_skipped(int p_lines_skipped){
	_wasgo_Label_wrapper_set_lines_skipped(wasgo_id, lines_skipped);
}
void Label::set_max_lines_visible(int p_lines_visible){
	_wasgo_Label_wrapper_set_max_lines_visible(wasgo_id, lines_visible);
}
void Label::set_percent_visible(float p_percent_visible){
	_wasgo_Label_wrapper_set_percent_visible(wasgo_id, percent_visible);
}
void Label::set_text(String p_text){
	_wasgo_Label_wrapper_set_text(wasgo_id, ((Variant) text).get_wasgo_id());
}
void Label::set_uppercase(bool p_enable){
	_wasgo_Label_wrapper_set_uppercase(wasgo_id, enable);
}
void Label::set_valign(Label::VAlign p_valign){
	_wasgo_Label_wrapper_set_valign(wasgo_id, ((Variant) valign).get_wasgo_id());
}
void Label::set_visible_characters(int p_amount){
	_wasgo_Label_wrapper_set_visible_characters(wasgo_id, amount);
}

Label::Label(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Label::~Label(){
}