...
void AudioEffectDelay::set_dry(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_dry(wasgo_id, amount);
}
void AudioEffectDelay::set_feedback_active(bool p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_feedback_active(wasgo_id, amount);
}
void AudioEffectDelay::set_feedback_delay_ms(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_feedback_delay_ms(wasgo_id, amount);
}
void AudioEffectDelay::set_feedback_level_db(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_feedback_level_db(wasgo_id, amount);
}
void AudioEffectDelay::set_feedback_lowpass(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_feedback_lowpass(wasgo_id, amount);
}
void AudioEffectDelay::set_tap1_active(bool p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap1_active(wasgo_id, amount);
}
void AudioEffectDelay::set_tap1_delay_ms(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap1_delay_ms(wasgo_id, amount);
}
void AudioEffectDelay::set_tap1_level_db(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap1_level_db(wasgo_id, amount);
}
void AudioEffectDelay::set_tap1_pan(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap1_pan(wasgo_id, amount);
}
void AudioEffectDelay::set_tap2_active(bool p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap2_active(wasgo_id, amount);
}
void AudioEffectDelay::set_tap2_delay_ms(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap2_delay_ms(wasgo_id, amount);
}
void AudioEffectDelay::set_tap2_level_db(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap2_level_db(wasgo_id, amount);
}
void AudioEffectDelay::set_tap2_pan(float p_amount){
	_wasgo_AudioEffectDelay_wrapper_set_tap2_pan(wasgo_id, amount);
}

AudioEffectDelay::AudioEffectDelay(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
