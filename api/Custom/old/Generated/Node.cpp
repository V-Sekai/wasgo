...
NodePath Node::get_path_to(Node p_node){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_Node_wrapper_get_path_to(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_node._get_wasgo_id());
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
// 	_wasgo_Node_wrapper_propagate_call(wasgo_id, wasgo_buffer_method, wasgo_size_method, -69, p_args._get_wasgo_id(), p_parent_first);
// }
...
Variant Node::rpc(String p_method){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_Node_wrapper_rpc(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_method, wasgo_size_method);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
// 	_wasgo_Node_wrapper_rpc_config(wasgo_id, wasgo_buffer_method, wasgo_size_method, -69, p_mode._get_wasgo_id());
// }
Variant Node::rpc_id(int p_peer_id, String p_method){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_Node_wrapper_rpc_id(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_peer_id, wasgo_buffer_method, wasgo_size_method);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant Node::rpc_unreliable(String p_method){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_Node_wrapper_rpc_unreliable(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_method, wasgo_size_method);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant Node::rpc_unreliable_id(int p_peer_id, String p_method){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_Node_wrapper_rpc_unreliable_id(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_peer_id, wasgo_buffer_method, wasgo_size_method);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
void Node::rset(String p_property, Variant p_value){
	...
	_wasgo_Node_wrapper_rset(wasgo_id, wasgo_buffer_property, wasgo_size_property, -69, wasgo_buffer_value, wasgo_size_value);
}
...
// 	_wasgo_Node_wrapper_rset_config(wasgo_id, wasgo_buffer_property, wasgo_size_property, -69, p_mode._get_wasgo_id());
// }
void Node::rset_id(int p_peer_id, String p_property, Variant p_value){
	...
	_wasgo_Node_wrapper_rset_id(wasgo_id, p_peer_id, wasgo_buffer_property, wasgo_size_property, wasgo_size_property, wasgo_buffer_value, wasgo_size_value);
}
void Node::rset_unreliable(String p_property, Variant p_value){
	...
	_wasgo_Node_wrapper_rset_unreliable(wasgo_id, wasgo_buffer_property, wasgo_size_property, -69, wasgo_buffer_value, wasgo_size_value);
}
void Node::rset_unreliable_id(int p_peer_id, String p_property, Variant p_value){
	...
	_wasgo_Node_wrapper_rset_unreliable_id(wasgo_id, p_peer_id, wasgo_buffer_property, wasgo_size_property, wasgo_size_property, wasgo_buffer_value, wasgo_size_value);
}
...
void Node::set_filename(String p_filename){
    ...
    int wasgo_size_filename = 10 + String(p_filename).size();
...
void Node::set_pause_mode(Node::PauseMode p_mode){
	_wasgo_Node_wrapper_set_pause_mode(wasgo_id, p_mode);
}
