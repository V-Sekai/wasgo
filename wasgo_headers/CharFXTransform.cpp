...
void CharFXTransform::set_absolute_index(int p_index){
	_wasgo_CharFXTransform_wrapper_set_absolute_index(wasgo_id, index);
}
void CharFXTransform::set_character(int p_character){
	_wasgo_CharFXTransform_wrapper_set_character(wasgo_id, character);
}
void CharFXTransform::set_color(Color p_color){
	_wasgo_CharFXTransform_wrapper_set_color(wasgo_id, ((Variant) color).get_wasgo_id());
}
void CharFXTransform::set_elapsed_time(float p_time){
	_wasgo_CharFXTransform_wrapper_set_elapsed_time(wasgo_id, time);
}
void CharFXTransform::set_environment(Dictionary p_environment){
	_wasgo_CharFXTransform_wrapper_set_environment(wasgo_id, ((Variant) environment).get_wasgo_id());
}
void CharFXTransform::set_offset(Vector2 p_offset){
	_wasgo_CharFXTransform_wrapper_set_offset(wasgo_id, ((Variant) offset).get_wasgo_id());
}
void CharFXTransform::set_relative_index(int p_index){
	_wasgo_CharFXTransform_wrapper_set_relative_index(wasgo_id, index);
}
void CharFXTransform::set_visibility(bool p_visibility){
	_wasgo_CharFXTransform_wrapper_set_visibility(wasgo_id, visibility);
}

CharFXTransform::CharFXTransform(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
