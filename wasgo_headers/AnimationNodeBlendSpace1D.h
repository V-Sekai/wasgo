...
//Wrapper Functions
extern "C"{
void _wasgo_AnimationNodeBlendSpace1D_wrapper_add_blend_point(WasGoId wasgo_id, WasGo::WasGoId p_node, float p_pos, int p_at_index);
int _wasgo_AnimationNodeBlendSpace1D_wrapper_get_blend_point_count(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_AnimationNodeBlendSpace1D_wrapper_get_blend_point_node(WasGoId wasgo_id, int p_point);
...
WasGo::WasGoId _wasgo_AnimationNodeBlendSpace1D_wrapper_get_value_label(WasGoId wasgo_id);
void _wasgo_AnimationNodeBlendSpace1D_wrapper_remove_blend_point(WasGoId wasgo_id, int p_point);
void _wasgo_AnimationNodeBlendSpace1D_wrapper_set_blend_point_node(WasGoId wasgo_id, int p_point, WasGo::WasGoId p_node);
...
void _wasgo_AnimationNodeBlendSpace1D_wrapper_set_value_label(WasGoId wasgo_id, WasGo::WasGoId p_text);
}
#endif