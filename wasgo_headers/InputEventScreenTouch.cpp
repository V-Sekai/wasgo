...
void InputEventScreenTouch::set_index(int p_index){
	_wasgo_InputEventScreenTouch_wrapper_set_index(wasgo_id, index);
}
void InputEventScreenTouch::set_position(Vector2 p_position){
	_wasgo_InputEventScreenTouch_wrapper_set_position(wasgo_id, ((Variant) position).get_wasgo_id());
}
void InputEventScreenTouch::set_pressed(bool p_pressed){
	_wasgo_InputEventScreenTouch_wrapper_set_pressed(wasgo_id, pressed);
}

InputEventScreenTouch::InputEventScreenTouch(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
