...
void Camera::clear_current(bool p_enable_next = (bool) True){
	_wasgo_Camera_wrapper_clear_current(wasgo_id, enable_next);
}
...
bool Camera::get_cull_mask_bit(int p_layer){
	return (bool) _wasgo_Camera_wrapper_get_cull_mask_bit(wasgo_id, layer));
}
...
bool Camera::is_position_behind(Vector3 p_world_point){
	return (bool) _wasgo_Camera_wrapper_is_position_behind(wasgo_id, ((Variant) world_point).get_wasgo_id()));
}
...
Vector3 Camera::project_local_ray_normal(Vector2 p_screen_point){
	return Vector3::from_wasgo_id(_wasgo_Camera_wrapper_project_local_ray_normal(wasgo_id, ((Variant) screen_point).get_wasgo_id()));
}
Vector3 Camera::project_position(Vector2 p_screen_point, float p_z_depth){
	return Vector3::from_wasgo_id(_wasgo_Camera_wrapper_project_position(wasgo_id, ((Variant) screen_point).get_wasgo_id(), z_depth));
}
Vector3 Camera::project_ray_normal(Vector2 p_screen_point){
	return Vector3::from_wasgo_id(_wasgo_Camera_wrapper_project_ray_normal(wasgo_id, ((Variant) screen_point).get_wasgo_id()));
}
Vector3 Camera::project_ray_origin(Vector2 p_screen_point){
	return Vector3::from_wasgo_id(_wasgo_Camera_wrapper_project_ray_origin(wasgo_id, ((Variant) screen_point).get_wasgo_id()));
}
void Camera::set_cull_mask(int p_mask){
	_wasgo_Camera_wrapper_set_cull_mask(wasgo_id, mask);
}
void Camera::set_cull_mask_bit(int p_layer, bool p_enable){
	_wasgo_Camera_wrapper_set_cull_mask_bit(wasgo_id, layer, enable);
}
void Camera::set_current(bool p_arg0){
	_wasgo_Camera_wrapper_set_current(wasgo_id, arg0);
}
void Camera::set_doppler_tracking(Camera::DopplerTracking p_mode){
	_wasgo_Camera_wrapper_set_doppler_tracking(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void Camera::set_environment(Environment p_env){
	_wasgo_Camera_wrapper_set_environment(wasgo_id, ((Variant) env).get_wasgo_id());
}
void Camera::set_fov(float p_arg0){
	_wasgo_Camera_wrapper_set_fov(wasgo_id, arg0);
}
void Camera::set_frustum(float p_size, Vector2 p_offset, float p_z_near, float p_z_far){
	_wasgo_Camera_wrapper_set_frustum(wasgo_id, size, ((Variant) offset).get_wasgo_id(), z_near, z_far);
}
void Camera::set_frustum_offset(Vector2 p_arg0){
	_wasgo_Camera_wrapper_set_frustum_offset(wasgo_id, ((Variant) arg0).get_wasgo_id());
}
void Camera::set_h_offset(float p_ofs){
	_wasgo_Camera_wrapper_set_h_offset(wasgo_id, ofs);
}
void Camera::set_keep_aspect_mode(Camera::KeepAspect p_mode){
	_wasgo_Camera_wrapper_set_keep_aspect_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void Camera::set_orthogonal(float p_size, float p_z_near, float p_z_far){
	_wasgo_Camera_wrapper_set_orthogonal(wasgo_id, size, z_near, z_far);
}
void Camera::set_perspective(float p_fov, float p_z_near, float p_z_far){
	_wasgo_Camera_wrapper_set_perspective(wasgo_id, fov, z_near, z_far);
}
void Camera::set_projection(Camera::Projection p_arg0){
	_wasgo_Camera_wrapper_set_projection(wasgo_id, ((Variant) arg0).get_wasgo_id());
}
void Camera::set_size(float p_arg0){
	_wasgo_Camera_wrapper_set_size(wasgo_id, arg0);
}
void Camera::set_v_offset(float p_ofs){
	_wasgo_Camera_wrapper_set_v_offset(wasgo_id, ofs);
}
void Camera::set_zfar(float p_arg0){
	_wasgo_Camera_wrapper_set_zfar(wasgo_id, arg0);
}
void Camera::set_znear(float p_arg0){
	_wasgo_Camera_wrapper_set_znear(wasgo_id, arg0);
}
Vector2 Camera::unproject_position(Vector3 p_world_point){
	return Vector2::from_wasgo_id(_wasgo_Camera_wrapper_unproject_position(wasgo_id, ((Variant) world_point).get_wasgo_id()));
}

Camera::Camera(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Camera::~Camera(){
}