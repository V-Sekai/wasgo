...
void AudioStreamPlayer::set_bus(String p_bus){
	_wasgo_AudioStreamPlayer_wrapper_set_bus(wasgo_id, ((Variant) p_bus).get_wasgo_id());
}
void AudioStreamPlayer::set_mix_target(AudioStreamPlayer::MixTarget p_mix_target){
	_wasgo_AudioStreamPlayer_wrapper_set_mix_target(wasgo_id, ((Variant) p_mix_target).get_wasgo_id());
}
...
void AudioStreamPlayer::set_stream(AudioStream p_stream){
	_wasgo_AudioStreamPlayer_wrapper_set_stream(wasgo_id, ((Variant) p_stream).get_wasgo_id());
}
