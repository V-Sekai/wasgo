...
void VehicleBody::set_brake(float p_brake){
	_wasgo_VehicleBody_wrapper_set_brake(wasgo_id, brake);
}
void VehicleBody::set_engine_force(float p_engine_force){
	_wasgo_VehicleBody_wrapper_set_engine_force(wasgo_id, engine_force);
}
void VehicleBody::set_steering(float p_steering){
	_wasgo_VehicleBody_wrapper_set_steering(wasgo_id, steering);
}

VehicleBody::VehicleBody(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
