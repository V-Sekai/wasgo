...
void SpatialVelocityTracker::reset(Vector3 p_position){
	_wasgo_SpatialVelocityTracker_wrapper_reset(wasgo_id, ((Variant) position).get_wasgo_id());
}
void SpatialVelocityTracker::set_track_physics_step(bool p_enable){
	_wasgo_SpatialVelocityTracker_wrapper_set_track_physics_step(wasgo_id, enable);
}
void SpatialVelocityTracker::update_position(Vector3 p_position){
	_wasgo_SpatialVelocityTracker_wrapper_update_position(wasgo_id, ((Variant) position).get_wasgo_id());
}

SpatialVelocityTracker::SpatialVelocityTracker(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
