...
void InputEventMouse::set_button_mask(int p_button_mask){
	_wasgo_InputEventMouse_wrapper_set_button_mask(wasgo_id, button_mask);
}
void InputEventMouse::set_global_position(Vector2 p_global_position){
	_wasgo_InputEventMouse_wrapper_set_global_position(wasgo_id, ((Variant) global_position).get_wasgo_id());
}
void InputEventMouse::set_position(Vector2 p_position){
	_wasgo_InputEventMouse_wrapper_set_position(wasgo_id, ((Variant) position).get_wasgo_id());
}