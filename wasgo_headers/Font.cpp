...
void Font::draw(RID p_canvas_item, Vector2 p_position, String p_string, Color p_modulate, int p_clip_w, Color p_outline_modulate){
	...
	_wasgo_Font_wrapper_draw(wasgo_id, wasgo_buffer_canvas_item, wasgo_size_canvas_item, -69, wasgo_buffer_position, wasgo_size_position, wasgo_buffer_string, wasgo_size_string, wasgo_buffer_modulate, wasgo_size_modulate, p_clip_w, wasgo_buffer_outline_modulate, wasgo_size_outline_modulate);
}
float Font::draw_char(RID p_canvas_item, Vector2 p_position, int p_char, int p_next, Color p_modulate, bool p_outline){
	...
	return (float) _wasgo_Font_wrapper_draw_char(wasgo_id, wasgo_buffer_canvas_item, wasgo_size_canvas_item, -69, wasgo_buffer_position, wasgo_size_position, p_char, p_next, wasgo_buffer_modulate, wasgo_size_modulate, p_outline);
}
...
Vector2 Font::get_char_size(int p_char, int p_next){
    ...
    _wasgo_Font_wrapper_get_char_size(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_char, p_next);
...
Vector2 Font::get_string_size(String p_string){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Font_wrapper_get_string_size(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_string, wasgo_size_string);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Vector2 Font::get_wordwrap_string_size(String p_string, float p_width){
    ...
    int wasgo_ret_buffer_size = 12;
    uint8_t wasgo_ret_buffer[12];
    _wasgo_Font_wrapper_get_wordwrap_string_size(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_string, wasgo_size_string, p_width);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
