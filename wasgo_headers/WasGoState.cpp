...
void WasGoState::set_properties(Dictionary p_p_properties){
	_wasgo_WasGoState_wrapper_set_properties(wasgo_id, ((Variant) p_p_properties).get_wasgo_id());
}
...
void WasGoState::set_wasm_script(WasmResource p_p_wasm_script){
	_wasgo_WasGoState_wrapper_set_wasm_script(wasgo_id, ((Variant) p_p_wasm_script).get_wasgo_id());
}