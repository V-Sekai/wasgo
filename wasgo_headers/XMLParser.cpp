...
String XMLParser::get_attribute_name(int p_idx){
	return String::from_wasgo_id(_wasgo_XMLParser_wrapper_get_attribute_name(wasgo_id, p_idx));
}
String XMLParser::get_attribute_value(int p_idx){
	return String::from_wasgo_id(_wasgo_XMLParser_wrapper_get_attribute_value(wasgo_id, p_idx));
}
...
String XMLParser::get_named_attribute_value(String p_name){
	return String::from_wasgo_id(_wasgo_XMLParser_wrapper_get_named_attribute_value(wasgo_id, ((Variant) p_name).get_wasgo_id()));
}
String XMLParser::get_named_attribute_value_safe(String p_name){
	return String::from_wasgo_id(_wasgo_XMLParser_wrapper_get_named_attribute_value_safe(wasgo_id, ((Variant) p_name).get_wasgo_id()));
}
...
bool XMLParser::has_attribute(String p_name){
	return (bool) _wasgo_XMLParser_wrapper_has_attribute(wasgo_id, ((Variant) p_name).get_wasgo_id());
}
bool XMLParser::is_empty(){
	return (bool) _wasgo_XMLParser_wrapper_is_empty(wasgo_id);
}
Error XMLParser::open(String p_file){
	return Error::from_wasgo_id(_wasgo_XMLParser_wrapper_open(wasgo_id, ((Variant) p_file).get_wasgo_id()));
}
Error XMLParser::open_buffer(PoolByteArray p_buffer){
	return Error::from_wasgo_id(_wasgo_XMLParser_wrapper_open_buffer(wasgo_id, ((Variant) p_buffer).get_wasgo_id()));
}
Error XMLParser::read(){
	return Error::from_wasgo_id(_wasgo_XMLParser_wrapper_read(wasgo_id));
}
Error XMLParser::seek(int p_position){
	return Error::from_wasgo_id(_wasgo_XMLParser_wrapper_seek(wasgo_id, p_position));
}
