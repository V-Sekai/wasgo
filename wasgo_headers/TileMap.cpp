...
void TileMap::set_cell_size(Vector2 p_size){
	_wasgo_TileMap_wrapper_set_cell_size(wasgo_id, ((Variant) p_size).get_wasgo_id());
}
void TileMap::set_custom_transform(Transform2D p_custom_transform){
	_wasgo_TileMap_wrapper_set_custom_transform(wasgo_id, ((Variant) p_custom_transform).get_wasgo_id());
}
void TileMap::set_half_offset(TileMap::HalfOffset p_half_offset){
	_wasgo_TileMap_wrapper_set_half_offset(wasgo_id, ((Variant) p_half_offset).get_wasgo_id());
}
void TileMap::set_mode(TileMap::Mode p_mode){
	_wasgo_TileMap_wrapper_set_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}
void TileMap::set_tileset(TileSet p_tileset){
	_wasgo_TileMap_wrapper_set_tileset(wasgo_id, ((Variant) p_tileset).get_wasgo_id());
}