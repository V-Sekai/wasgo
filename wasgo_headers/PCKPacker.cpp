...
Error PCKPacker::add_file(String p_pck_path, String p_source_path){
    ...
    int wasgo_size_pck_path = 10 + String(p_pck_path).size();
    ...
    int wasgo_size_source_path = 10 + String(p_source_path).size();
	...
	return Error(_wasgo_PCKPacker_wrapper_add_file(wasgo_id, wasgo_buffer_pck_path, wasgo_size_pck_path, -69, wasgo_buffer_source_path, wasgo_size_source_path));
}
...
Error PCKPacker::pck_start(String p_pck_name, int p_alignment){
    ...
    int wasgo_size_pck_name = 10 + String(p_pck_name).size();
	...
	return Error(_wasgo_PCKPacker_wrapper_pck_start(wasgo_id, wasgo_buffer_pck_name, wasgo_size_pck_name, -69, p_alignment));
}
