...
WasGo::WasGoId _wasgo_StyleBoxFlat_wrapper_get_bg_color(WasGoId wasgo_id);
int _wasgo_StyleBoxFlat_wrapper_get_border_blend(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_StyleBoxFlat_wrapper_get_border_color(WasGoId wasgo_id);
int _wasgo_StyleBoxFlat_wrapper_get_border_width(WasGoId wasgo_id, WasGo::WasGoId p_margin);
...
int _wasgo_StyleBoxFlat_wrapper_get_corner_radius(WasGoId wasgo_id, WasGo::WasGoId p_corner);
float _wasgo_StyleBoxFlat_wrapper_get_expand_margin(WasGoId wasgo_id, WasGo::WasGoId p_margin);
WasGo::WasGoId _wasgo_StyleBoxFlat_wrapper_get_shadow_color(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_StyleBoxFlat_wrapper_get_shadow_offset(WasGoId wasgo_id);
...
void _wasgo_StyleBoxFlat_wrapper_set_bg_color(WasGoId wasgo_id, WasGo::WasGoId p_color);
void _wasgo_StyleBoxFlat_wrapper_set_border_blend(WasGoId wasgo_id, bool p_blend);
void _wasgo_StyleBoxFlat_wrapper_set_border_color(WasGoId wasgo_id, WasGo::WasGoId p_color);
void _wasgo_StyleBoxFlat_wrapper_set_border_width(WasGoId wasgo_id, WasGo::WasGoId p_margin, int p_width);
...
void _wasgo_StyleBoxFlat_wrapper_set_corner_radius(WasGoId wasgo_id, WasGo::WasGoId p_corner, int p_radius);
...
void _wasgo_StyleBoxFlat_wrapper_set_expand_margin(WasGoId wasgo_id, WasGo::WasGoId p_margin, float p_size);
...
void _wasgo_StyleBoxFlat_wrapper_set_shadow_color(WasGoId wasgo_id, WasGo::WasGoId p_color);
void _wasgo_StyleBoxFlat_wrapper_set_shadow_offset(WasGoId wasgo_id, WasGo::WasGoId p_offset);
