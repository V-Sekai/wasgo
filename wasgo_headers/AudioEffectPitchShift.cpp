...
void AudioEffectPitchShift::set_fft_size(AudioEffectPitchShift::FFT_Size p_size){
	_wasgo_AudioEffectPitchShift_wrapper_set_fft_size(wasgo_id, ((Variant) size).get_wasgo_id());
}
void AudioEffectPitchShift::set_oversampling(int p_amount){
	_wasgo_AudioEffectPitchShift_wrapper_set_oversampling(wasgo_id, amount);
}
void AudioEffectPitchShift::set_pitch_scale(float p_rate){
	_wasgo_AudioEffectPitchShift_wrapper_set_pitch_scale(wasgo_id, rate);
}

AudioEffectPitchShift::AudioEffectPitchShift(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
