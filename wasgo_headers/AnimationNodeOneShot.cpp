...
void AnimationNodeOneShot::set_autorestart(bool p_enable){
	_wasgo_AnimationNodeOneShot_wrapper_set_autorestart(wasgo_id, enable);
}
void AnimationNodeOneShot::set_autorestart_delay(float p_enable){
	_wasgo_AnimationNodeOneShot_wrapper_set_autorestart_delay(wasgo_id, enable);
}
void AnimationNodeOneShot::set_autorestart_random_delay(float p_enable){
	_wasgo_AnimationNodeOneShot_wrapper_set_autorestart_random_delay(wasgo_id, enable);
}
void AnimationNodeOneShot::set_fadein_time(float p_time){
	_wasgo_AnimationNodeOneShot_wrapper_set_fadein_time(wasgo_id, time);
}
void AnimationNodeOneShot::set_fadeout_time(float p_time){
	_wasgo_AnimationNodeOneShot_wrapper_set_fadeout_time(wasgo_id, time);
}
void AnimationNodeOneShot::set_mix_mode(AnimationNodeOneShot::MixMode p_mode){
	_wasgo_AnimationNodeOneShot_wrapper_set_mix_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
void AnimationNodeOneShot::set_use_sync(bool p_enable){
	_wasgo_AnimationNodeOneShot_wrapper_set_use_sync(wasgo_id, enable);
}

AnimationNodeOneShot::AnimationNodeOneShot(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
