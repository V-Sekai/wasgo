...
//Wrapper Functions
extern "C"{
void _wasgo_PopupMenu_wrapper_add_check_item(WasGoID wasgo_id, const uint8_t * p_label, int p_label_wasgo_buffer_size, int wasgo_throwaway, int p_id, int p_accel);
void _wasgo_PopupMenu_wrapper_add_check_shortcut(WasGoID wasgo_id, WasGoID p_shortcut, int p_id, int wasgo_throwaway, bool p_global);
void _wasgo_PopupMenu_wrapper_add_icon_check_item(WasGoID wasgo_id, WasGoID p_texture, const uint8_t * p_label, int wasgo_throwaway, int p_label_wasgo_buffer_size, int p_id, int p_accel);
void _wasgo_PopupMenu_wrapper_add_icon_check_shortcut(WasGoID wasgo_id, WasGoID p_texture, WasGoID p_shortcut, int wasgo_throwaway, int p_id, bool p_global);
void _wasgo_PopupMenu_wrapper_add_icon_item(WasGoID wasgo_id, WasGoID p_texture, const uint8_t * p_label, int wasgo_throwaway, int p_label_wasgo_buffer_size, int p_id, int p_accel);
void _wasgo_PopupMenu_wrapper_add_icon_radio_check_item(WasGoID wasgo_id, WasGoID p_texture, const uint8_t * p_label, int wasgo_throwaway, int p_label_wasgo_buffer_size, int p_id, int p_accel);
void _wasgo_PopupMenu_wrapper_add_icon_radio_check_shortcut(WasGoID wasgo_id, WasGoID p_texture, WasGoID p_shortcut, int wasgo_throwaway, int p_id, bool p_global);
void _wasgo_PopupMenu_wrapper_add_icon_shortcut(WasGoID wasgo_id, WasGoID p_texture, WasGoID p_shortcut, int wasgo_throwaway, int p_id, bool p_global);
void _wasgo_PopupMenu_wrapper_add_item(WasGoID wasgo_id, const uint8_t * p_label, int p_label_wasgo_buffer_size, int wasgo_throwaway, int p_id, int p_accel);
void _wasgo_PopupMenu_wrapper_add_multistate_item(WasGoID wasgo_id, const uint8_t * p_label, int p_label_wasgo_buffer_size, int wasgo_throwaway, int p_max_states, int p_default_state, int p_id, int p_accel);
void _wasgo_PopupMenu_wrapper_add_radio_check_item(WasGoID wasgo_id, const uint8_t * p_label, int p_label_wasgo_buffer_size, int wasgo_throwaway, int p_id, int p_accel);
void _wasgo_PopupMenu_wrapper_add_radio_check_shortcut(WasGoID wasgo_id, WasGoID p_shortcut, int p_id, int wasgo_throwaway, bool p_global);
void _wasgo_PopupMenu_wrapper_add_separator(WasGoID wasgo_id, const uint8_t * p_label, int p_label_wasgo_buffer_size);
void _wasgo_PopupMenu_wrapper_add_shortcut(WasGoID wasgo_id, WasGoID p_shortcut, int p_id, int wasgo_throwaway, bool p_global);
void _wasgo_PopupMenu_wrapper_add_submenu_item(WasGoID wasgo_id, const uint8_t * p_label, int p_label_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_submenu, int p_submenu_wasgo_buffer_size, int p_id);
...
void _wasgo_PopupMenu_wrapper_get_item_metadata(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
WasGoID _wasgo_PopupMenu_wrapper_get_item_shortcut(WasGoID wasgo_id, int p_idx);
void _wasgo_PopupMenu_wrapper_get_item_submenu(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
void _wasgo_PopupMenu_wrapper_get_item_text(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
void _wasgo_PopupMenu_wrapper_get_item_tooltip(WasGoID wasgo_id, uint8_t * wasgo_ret, int wasgo_ret_size, int wasgo_throwaway, int p_idx);
...
void _wasgo_PopupMenu_wrapper_set_item_metadata(WasGoID wasgo_id, int p_idx, const uint8_t * p_metadata, int wasgo_throwaway, int p_metadata_wasgo_buffer_size);
void _wasgo_PopupMenu_wrapper_set_item_multistate(WasGoID wasgo_id, int p_idx, int p_state);
void _wasgo_PopupMenu_wrapper_set_item_shortcut(WasGoID wasgo_id, int p_idx, WasGoID p_shortcut, int wasgo_throwaway, bool p_global);
void _wasgo_PopupMenu_wrapper_set_item_shortcut_disabled(WasGoID wasgo_id, int p_idx, bool p_disabled);
void _wasgo_PopupMenu_wrapper_set_item_submenu(WasGoID wasgo_id, int p_idx, const uint8_t * p_submenu, int wasgo_throwaway, int p_submenu_wasgo_buffer_size);
void _wasgo_PopupMenu_wrapper_set_item_text(WasGoID wasgo_id, int p_idx, const uint8_t * p_text, int wasgo_throwaway, int p_text_wasgo_buffer_size);
void _wasgo_PopupMenu_wrapper_set_item_tooltip(WasGoID wasgo_id, int p_idx, const uint8_t * p_tooltip, int wasgo_throwaway, int p_tooltip_wasgo_buffer_size);
