...
void InputEventWithModifiers::set_alt(bool p_enable){
	_wasgo_InputEventWithModifiers_wrapper_set_alt(wasgo_id, enable);
}
void InputEventWithModifiers::set_command(bool p_enable){
	_wasgo_InputEventWithModifiers_wrapper_set_command(wasgo_id, enable);
}
void InputEventWithModifiers::set_control(bool p_enable){
	_wasgo_InputEventWithModifiers_wrapper_set_control(wasgo_id, enable);
}
void InputEventWithModifiers::set_metakey(bool p_enable){
	_wasgo_InputEventWithModifiers_wrapper_set_metakey(wasgo_id, enable);
}
void InputEventWithModifiers::set_shift(bool p_enable){
	_wasgo_InputEventWithModifiers_wrapper_set_shift(wasgo_id, enable);
}