...
void OmniLight::set_shadow_detail(OmniLight::ShadowDetail p_detail){
	_wasgo_OmniLight_wrapper_set_shadow_detail(wasgo_id, ((Variant) p_detail).get_wasgo_id());
}
void OmniLight::set_shadow_mode(OmniLight::ShadowMode p_mode){
	_wasgo_OmniLight_wrapper_set_shadow_mode(wasgo_id, ((Variant) p_mode).get_wasgo_id());
}