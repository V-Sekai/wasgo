...
PoolStringArray File::get_csv_line(String p_delim){
    ...
    int wasgo_size_delim = 10 + String(p_delim).size();
...
String File::get_md5(String p_path){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_File_wrapper_get_md5(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_path, wasgo_size_path);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
String File::get_sha256(String p_path){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_File_wrapper_get_sha256(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, wasgo_buffer_path, wasgo_size_path);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Variant File::get_var(bool p_allow_objects){
    ...
    int wasgo_ret_buffer_size = 256;
    uint8_t wasgo_ret_buffer[256];
    _wasgo_File_wrapper_get_var(wasgo_id, wasgo_ret_buffer, wasgo_ret_buffer_size, -69, p_allow_objects);
    decode_variant(wasgo_ret, wasgo_ret_buffer, wasgo_ret_buffer_size);
    return wasgo_ret;
...
Error File::open(String p_path, File::ModeFlags p_flags){
	...
	return Error(_wasgo_File_wrapper_open(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, p_flags._get_wasgo_id()));
}
Error File::open_compressed(String p_path, File::ModeFlags p_mode_flags, File::CompressionMode p_compression_mode){
	...
	return Error(_wasgo_File_wrapper_open_compressed(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, p_mode_flags._get_wasgo_id(), p_compression_mode._get_wasgo_id()));
}
Error File::open_encrypted(String p_path, File::ModeFlags p_mode_flags, PoolByteArray p_key){
	...
	return Error(_wasgo_File_wrapper_open_encrypted(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, p_mode_flags._get_wasgo_id(), p_key._get_wasgo_id()));
}
Error File::open_encrypted_with_pass(String p_path, File::ModeFlags p_mode_flags, String p_pass){
    ...
    int wasgo_size_pass = 10 + String(p_pass).size();
    uint8_t wasgo_buffer_pass[wasgo_size_pass];
    encode_variant(wasgo_var_pass, wasgo_buffer_pass, wasgo_size_pass);
    
	return Error(_wasgo_File_wrapper_open_encrypted_with_pass(wasgo_id, wasgo_buffer_path, wasgo_size_path, -69, p_mode_flags._get_wasgo_id(), wasgo_buffer_pass, wasgo_size_pass));
}
...
void File::store_csv_line(PoolStringArray p_values, String p_delim){
	...
	_wasgo_File_wrapper_store_csv_line(wasgo_id, p_values._get_wasgo_id(), wasgo_buffer_delim, wasgo_size_delim, wasgo_size_delim);
}
...
void File::store_line(String p_line){
    ...
    int wasgo_size_line = 10 + String(p_line).size();
...
void File::store_pascal_string(String p_string){
    ...
    int wasgo_size_string = 10 + String(p_string).size();
...
void File::store_var(Variant p_value, bool p_full_objects){
	...
	_wasgo_File_wrapper_store_var(wasgo_id, wasgo_buffer_value, wasgo_size_value, -69, p_full_objects);
}
