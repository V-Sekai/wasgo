...
bool Tween::remove(Object p_object, String p_key = (String) ){
	return (bool) _wasgo_Tween_wrapper_remove(wasgo_id, ((Variant) object).get_wasgo_id(), ((Variant) key).get_wasgo_id()));
}
bool Tween::reset(Object p_object, String p_key = (String) ){
	return (bool) _wasgo_Tween_wrapper_reset(wasgo_id, ((Variant) object).get_wasgo_id(), ((Variant) key).get_wasgo_id()));
}
...
bool Tween::resume(Object p_object, String p_key = (String) ){
	return (bool) _wasgo_Tween_wrapper_resume(wasgo_id, ((Variant) object).get_wasgo_id(), ((Variant) key).get_wasgo_id()));
}
bool Tween::resume_all(){
	return (bool) _wasgo_Tween_wrapper_resume_all(wasgo_id));
}
void Tween::set_active(bool p_active){
	_wasgo_Tween_wrapper_set_active(wasgo_id, active);
}
void Tween::set_repeat(bool p_repeat){
	_wasgo_Tween_wrapper_set_repeat(wasgo_id, repeat);
}
void Tween::set_speed_scale(float p_speed){
	_wasgo_Tween_wrapper_set_speed_scale(wasgo_id, speed);
}
void Tween::set_tween_process_mode(Tween::TweenProcessMode p_mode){
	_wasgo_Tween_wrapper_set_tween_process_mode(wasgo_id, ((Variant) mode).get_wasgo_id());
}
bool Tween::start(){
	return (bool) _wasgo_Tween_wrapper_start(wasgo_id));
}
bool Tween::stop(Object p_object, String p_key = (String) ){
	return (bool) _wasgo_Tween_wrapper_stop(wasgo_id, ((Variant) object).get_wasgo_id(), ((Variant) key).get_wasgo_id()));
}
bool Tween::stop_all(){
	return (bool) _wasgo_Tween_wrapper_stop_all(wasgo_id));
}

Tween::Tween(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
Tween::~Tween(){
}