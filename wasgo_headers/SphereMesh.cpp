...
void SphereMesh::set_height(float p_height){
	_wasgo_SphereMesh_wrapper_set_height(wasgo_id, height);
}
void SphereMesh::set_is_hemisphere(bool p_is_hemisphere){
	_wasgo_SphereMesh_wrapper_set_is_hemisphere(wasgo_id, is_hemisphere);
}
void SphereMesh::set_radial_segments(int p_radial_segments){
	_wasgo_SphereMesh_wrapper_set_radial_segments(wasgo_id, radial_segments);
}
void SphereMesh::set_radius(float p_radius){
	_wasgo_SphereMesh_wrapper_set_radius(wasgo_id, radius);
}
void SphereMesh::set_rings(int p_rings){
	_wasgo_SphereMesh_wrapper_set_rings(wasgo_id, rings);
}

SphereMesh::SphereMesh(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
