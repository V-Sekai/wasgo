...
void Object::add_user_signal(String p_signal, Array p_arguments = (Array) []){
    ...
    uint8_t wasgo_buffer_signal[256];
    int wasgo_size_signal = 256;
...
bool Object::is_class(String p_class){
    ...
    uint8_t wasgo_buffer_class[256];
    int wasgo_size_class = 256;
...
String Object::tr(String p_message){
    ...
    uint8_t wasgo_buffer_message[256];
    int wasgo_size_message = 256;
...
Object::~Object(){
    _wasgo_Object_destructor(wasgo_id);
}