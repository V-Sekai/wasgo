...
WasGo::WasGoId _wasgo_SkeletonIK_wrapper_get_magnet_position(WasGoId wasgo_id);
...
WasGo::WasGoId _wasgo_SkeletonIK_wrapper_get_parent_skeleton(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_SkeletonIK_wrapper_get_root_bone(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_SkeletonIK_wrapper_get_target_node(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_SkeletonIK_wrapper_get_target_transform(WasGoId wasgo_id);
WasGo::WasGoId _wasgo_SkeletonIK_wrapper_get_tip_bone(WasGoId wasgo_id);
...
void _wasgo_SkeletonIK_wrapper_set_magnet_position(WasGoId wasgo_id, WasGo::WasGoId p_local_position);
...
void _wasgo_SkeletonIK_wrapper_set_root_bone(WasGoId wasgo_id, WasGo::WasGoId p_root_bone);
void _wasgo_SkeletonIK_wrapper_set_target_node(WasGoId wasgo_id, WasGo::WasGoId p_node);
void _wasgo_SkeletonIK_wrapper_set_target_transform(WasGoId wasgo_id, WasGo::WasGoId p_target);
void _wasgo_SkeletonIK_wrapper_set_tip_bone(WasGoId wasgo_id, WasGo::WasGoId p_tip_bone);
