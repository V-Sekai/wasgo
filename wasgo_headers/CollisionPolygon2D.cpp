...
void CollisionPolygon2D::set_build_mode(CollisionPolygon2D::BuildMode p_build_mode){
	_wasgo_CollisionPolygon2D_wrapper_set_build_mode(wasgo_id, ((Variant) p_build_mode).get_wasgo_id());
}
...
void CollisionPolygon2D::set_polygon(PoolVector2Array p_polygon){
	_wasgo_CollisionPolygon2D_wrapper_set_polygon(wasgo_id, ((Variant) p_polygon).get_wasgo_id());
}