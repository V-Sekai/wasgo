...
WasGoID _wasgo_PacketPeerUDP_wrapper_connect_to_host(WasGoID wasgo_id, const uint8_t * p_host, int p_host_wasgo_buffer_size, int wasgo_throwaway, int p_port);
...
WasGoID _wasgo_PacketPeerUDP_wrapper_join_multicast_group(WasGoID wasgo_id, const uint8_t * p_multicast_address, int p_multicast_address_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_interface_name, int p_interface_name_wasgo_buffer_size);
WasGoID _wasgo_PacketPeerUDP_wrapper_leave_multicast_group(WasGoID wasgo_id, const uint8_t * p_multicast_address, int p_multicast_address_wasgo_buffer_size, int wasgo_throwaway, const uint8_t * p_interface_name, int p_interface_name_wasgo_buffer_size);
WasGoID _wasgo_PacketPeerUDP_wrapper_listen(WasGoID wasgo_id, int p_port, const uint8_t * p_bind_address, int wasgo_throwaway, int p_bind_address_wasgo_buffer_size, int p_recv_buf_size);
void _wasgo_PacketPeerUDP_wrapper_set_broadcast_enabled(WasGoID wasgo_id, bool p_enabled);
WasGoID _wasgo_PacketPeerUDP_wrapper_set_dest_address(WasGoID wasgo_id, const uint8_t * p_host, int p_host_wasgo_buffer_size, int wasgo_throwaway, int p_port);
