...
Variant Script::get_property_default_value(String p_property){
	return Variant::from_wasgo_id(_wasgo_Script_wrapper_get_property_default_value(wasgo_id, ((Variant) property).get_wasgo_id()));
}
...
bool Script::has_script_signal(String p_signal_name){
	return (bool) _wasgo_Script_wrapper_has_script_signal(wasgo_id, ((Variant) signal_name).get_wasgo_id()));
}
...
bool Script::instance_has(Object p_base_object){
	return (bool) _wasgo_Script_wrapper_instance_has(wasgo_id, ((Variant) base_object).get_wasgo_id()));
}
bool Script::is_tool(){
	return (bool) _wasgo_Script_wrapper_is_tool(wasgo_id));
}
Error Script::reload(bool p_keep_state = (bool) False){
	return Error::from_wasgo_id(_wasgo_Script_wrapper_reload(wasgo_id, keep_state));
}
void Script::set_source_code(String p_source){
	_wasgo_Script_wrapper_set_source_code(wasgo_id, ((Variant) source).get_wasgo_id());
}