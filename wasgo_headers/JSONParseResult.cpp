...
void JSONParseResult::set_error(Error p_error){
	_wasgo_JSONParseResult_wrapper_set_error(wasgo_id, ((Variant) p_error).get_wasgo_id());
}
...
void JSONParseResult::set_error_string(String p_error_string){
	_wasgo_JSONParseResult_wrapper_set_error_string(wasgo_id, ((Variant) p_error_string).get_wasgo_id());
}
void JSONParseResult::set_result(Variant p_result){
	_wasgo_JSONParseResult_wrapper_set_result(wasgo_id, ((Variant) p_result).get_wasgo_id());
}