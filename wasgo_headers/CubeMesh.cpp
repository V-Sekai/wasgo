...
void CubeMesh::set_size(Vector3 p_size){
	_wasgo_CubeMesh_wrapper_set_size(wasgo_id, ((Variant) size).get_wasgo_id());
}
void CubeMesh::set_subdivide_depth(int p_divisions){
	_wasgo_CubeMesh_wrapper_set_subdivide_depth(wasgo_id, divisions);
}
void CubeMesh::set_subdivide_height(int p_divisions){
	_wasgo_CubeMesh_wrapper_set_subdivide_height(wasgo_id, divisions);
}
void CubeMesh::set_subdivide_width(int p_subdivide){
	_wasgo_CubeMesh_wrapper_set_subdivide_width(wasgo_id, subdivide);
}

CubeMesh::CubeMesh(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
CubeMesh::~CubeMesh(){
}