...
void StyleBox::draw(RID p_canvas_item, Rect2 p_rect){
	...
	_wasgo_StyleBox_wrapper_draw(wasgo_id, wasgo_buffer_canvas_item, wasgo_size_canvas_item, -69, wasgo_buffer_rect, wasgo_size_rect);
}
...
bool StyleBox::test_mask(Vector2 p_point, Rect2 p_rect){
	...
	return (bool) _wasgo_StyleBox_wrapper_test_mask(wasgo_id, wasgo_buffer_point, wasgo_size_point, -69, wasgo_buffer_rect, wasgo_size_rect);
}
