...
Color MultiMesh::get_instance_color(int p_instance){
	return Color::from_wasgo_id(_wasgo_MultiMesh_wrapper_get_instance_color(wasgo_id, instance));
}
...
Color MultiMesh::get_instance_custom_data(int p_instance){
	return Color::from_wasgo_id(_wasgo_MultiMesh_wrapper_get_instance_custom_data(wasgo_id, instance));
}
Transform MultiMesh::get_instance_transform(int p_instance){
	return Transform::from_wasgo_id(_wasgo_MultiMesh_wrapper_get_instance_transform(wasgo_id, instance));
}
Transform2D MultiMesh::get_instance_transform_2d(int p_instance){
	return Transform2D::from_wasgo_id(_wasgo_MultiMesh_wrapper_get_instance_transform_2d(wasgo_id, instance));
}
...
void MultiMesh::set_as_bulk_array(PoolRealArray p_array){
	_wasgo_MultiMesh_wrapper_set_as_bulk_array(wasgo_id, ((Variant) array).get_wasgo_id());
}
void MultiMesh::set_color_format(MultiMesh::ColorFormat p_format){
	_wasgo_MultiMesh_wrapper_set_color_format(wasgo_id, ((Variant) format).get_wasgo_id());
}
void MultiMesh::set_custom_data_format(MultiMesh::CustomDataFormat p_format){
	_wasgo_MultiMesh_wrapper_set_custom_data_format(wasgo_id, ((Variant) format).get_wasgo_id());
}
void MultiMesh::set_instance_color(int p_instance, Color p_color){
	_wasgo_MultiMesh_wrapper_set_instance_color(wasgo_id, instance, ((Variant) color).get_wasgo_id());
}
void MultiMesh::set_instance_count(int p_count){
	_wasgo_MultiMesh_wrapper_set_instance_count(wasgo_id, count);
}
void MultiMesh::set_instance_custom_data(int p_instance, Color p_custom_data){
	_wasgo_MultiMesh_wrapper_set_instance_custom_data(wasgo_id, instance, ((Variant) custom_data).get_wasgo_id());
}
void MultiMesh::set_instance_transform(int p_instance, Transform p_transform){
	_wasgo_MultiMesh_wrapper_set_instance_transform(wasgo_id, instance, ((Variant) transform).get_wasgo_id());
}
void MultiMesh::set_instance_transform_2d(int p_instance, Transform2D p_transform){
	_wasgo_MultiMesh_wrapper_set_instance_transform_2d(wasgo_id, instance, ((Variant) transform).get_wasgo_id());
}
void MultiMesh::set_mesh(Mesh p_mesh){
	_wasgo_MultiMesh_wrapper_set_mesh(wasgo_id, ((Variant) mesh).get_wasgo_id());
}
void MultiMesh::set_transform_format(MultiMesh::TransformFormat p_format){
	_wasgo_MultiMesh_wrapper_set_transform_format(wasgo_id, ((Variant) format).get_wasgo_id());
}
void MultiMesh::set_visible_instance_count(int p_count){
	_wasgo_MultiMesh_wrapper_set_visible_instance_count(wasgo_id, count);
}

MultiMesh::MultiMesh(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
MultiMesh::~MultiMesh(){
}