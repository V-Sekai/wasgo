...
Error Thread::start(Object p_instance, String p_method, Variant p_userdata = (Variant) "", Thread::Priority p_priority = (Thread::Priority) 1){
	return Error::from_wasgo_id(_wasgo_Thread_wrapper_start(wasgo_id, ((Variant) p_instance).get_wasgo_id(), ((Variant) p_method).get_wasgo_id(), ((Variant) p_userdata).get_wasgo_id(), ((Variant) p_priority).get_wasgo_id()));
}
