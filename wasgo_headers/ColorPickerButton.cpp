...
void ColorPickerButton::set_edit_alpha(bool p_show){
	_wasgo_ColorPickerButton_wrapper_set_edit_alpha(wasgo_id, show);
}
void ColorPickerButton::set_pick_color(Color p_color){
	_wasgo_ColorPickerButton_wrapper_set_pick_color(wasgo_id, ((Variant) color).get_wasgo_id());
}

ColorPickerButton::ColorPickerButton(WasGoId p_wasgo_id) : Variant(p_wasgo_id){
}
