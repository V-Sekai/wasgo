...
bool InputEvent::accumulate(InputEvent p_with_event){
	return (bool) _wasgo_InputEvent_wrapper_accumulate(wasgo_id, ((Variant) p_with_event).get_wasgo_id());
}
...
float InputEvent::get_action_strength(String p_action){
	return (float) _wasgo_InputEvent_wrapper_get_action_strength(wasgo_id, ((Variant) p_action).get_wasgo_id());
}
...
bool InputEvent::is_action(String p_action){
	return (bool) _wasgo_InputEvent_wrapper_is_action(wasgo_id, ((Variant) p_action).get_wasgo_id());
}
bool InputEvent::is_action_pressed(String p_action, bool p_allow_echo = (bool) false){
	return (bool) _wasgo_InputEvent_wrapper_is_action_pressed(wasgo_id, ((Variant) p_action).get_wasgo_id(), p_allow_echo);
}
bool InputEvent::is_action_released(String p_action){
	return (bool) _wasgo_InputEvent_wrapper_is_action_released(wasgo_id, ((Variant) p_action).get_wasgo_id());
}
...
bool InputEvent::shortcut_match(InputEvent p_event){
	return (bool) _wasgo_InputEvent_wrapper_shortcut_match(wasgo_id, ((Variant) p_event).get_wasgo_id());
}
InputEvent InputEvent::xformed_by(Transform2D p_xform, Vector2 p_local_ofs = Vector2((0, 0))){
	return InputEvent::from_wasgo_id(_wasgo_InputEvent_wrapper_xformed_by(wasgo_id, ((Variant) p_xform).get_wasgo_id(), ((Variant) p_local_ofs).get_wasgo_id()));
}