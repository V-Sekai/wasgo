...
Variant WasGoState::get_property(String p_arg0){
    ...
    uint8_t wasgo_buffer_arg0[256];
    int wasgo_size_arg0 = 256;
...
void WasGoState::set_property(String p_p_property, Variant p_arg1){
    ...
    uint8_t wasgo_buffer_p_property[256];
    int wasgo_size_p_property = 256;
...
WasGoState::~WasGoState(){
    _wasgo_WasGoState_destructor(wasgo_id);
}